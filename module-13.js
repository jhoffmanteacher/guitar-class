        ...
        sections: [
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text_es: 'Prepara tu espacio antes de tocar una clavija:<ul><li>Un juego completo de cuerdas — revisa el paquete para saber cuál es cuál (Mi grave, La, Re, Sol, Si, mi agudo).</li><li>Manivela para cuerdas (acelera aflojar y enrollar — es lo que más tiempo ahorra).</li><li>Cortador o tijeras para recortar.</li><li>Un paño, y una superficie suave o soporte para el mástil, con la guitarra plana y segura.</li><li>El afinador del sitio (en la barra de herramientas) para los pasos de afinación.</li><li>Un bote de basura a la mano.</li></ul>Lo tienes cuando: todo está a tu alcance antes de quitar la primera cuerda.',
              ...
              },
              {
                ...
                text_es: 'Vas a cambiar el juego completo, y la forma segura de hacerlo es una cuerda a la vez:<ul><li>Quita una, pon su reemplazo, y pasa a la siguiente.</li><li>Nunca quites las seis de golpe — el mástil pierde toda su tensión al mismo tiempo.</li><li>Las cinco cuerdas que siguen puestas te sirven de referencia para afinar.</li></ul>Trabaja en un orden fijo (de la cuerda Mi grave hacia la cuerda mi agudo) para no perder el hilo. Lo tienes cuando: puedes seguir cualquier cuerda desde su agujero en el puente hasta su propio poste antes de girar nada.',
