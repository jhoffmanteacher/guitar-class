        ...
        sections: [
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text: 'Set up your workspace before you touch a peg:<ul><li>A full set of strings — <b>and check it matches your guitar</b>. Nylon guitar takes nylon strings; steel-string guitar takes steel. They are not interchangeable: steel pulls about twice as hard, and a classical guitar\'s top is not built for it — the bridge can lift right off. If the package doesn\'t say, ask before you open it. Then check which string is which (E, A, D, G, B, e).</li><li>String winder (speeds up loosening and winding — it is the single biggest time-saver).</li><li>Wire cutters or scissors for trimming.</li><li>A cloth, and a soft surface or neck support so the guitar lies flat and safe.</li><li>The site\'s tuner (in the toolbar) for the tuning steps.</li><li>A trash can within reach.</li></ul>You\'ve got it when: everything is within reach before the first string comes off.',
                text_es: 'Prepara tu espacio antes de tocar una clavija:<ul><li>Un juego completo de cuerdas — <b>y revisa que sean para tu guitarra</b>. La guitarra de nylon lleva cuerdas de nylon; la de acero lleva de acero. No son intercambiables: el acero jala como el doble, y la tapa de una guitarra clásica no está hecha para eso — el puente se puede despegar. Si el paquete no lo dice, pregunta antes de abrirlo. Luego revisa cuál cuerda es cuál (Mi grave, La, Re, Sol, Si, mi aguda).</li><li>Manivela para cuerdas (acelera aflojar y enrollar — es lo que más tiempo ahorra).</li><li>Cortador o tijeras para recortar.</li><li>Un paño, y una superficie suave o soporte para el mástil, con la guitarra plana y segura.</li><li>El afinador del sitio (en la barra de herramientas) para los pasos de afinación.</li><li>Un bote de basura a la mano.</li></ul>Lo tienes cuando: todo está a tu alcance antes de quitar la primera cuerda.',
            ...
            steps: [
              {
                ...
                text: 'This module ends with a graded, in-class restring: you change all six strings while your teacher checks your work. You\'re graded on the four skills in the checklist tab:<ol><li><b>Anchored</b> — every string secured at both ends, on its own post.</li><li><b>Wound</b> — neat wraps in one direction with the tail locked under the first one, no crossovers, excess trimmed.</li><li><b>In tune</b> — stretched and re-tuned at least twice, in tune at the final check.</li><li><b>Finished in time</b> — all six done and your station clear inside 40 minutes.</li></ol>Safety is not a fifth row — it is a stop: cutting or unhooking a string that is still under tension ends the attempt and you restart it. The first three are judged on the strings you actually installed, so an unfinished string only costs you once. Open the checklist to see exactly what each element looks like when it\'s done right.',
                text_es: 'Este módulo termina con un cambio de cuerdas calificado en clase: cambias las seis cuerdas mientras tu maestro revisa tu trabajo. Se te califica en las cuatro habilidades de la pestaña de la lista:<ol><li><b>Anclada</b> — cada cuerda sujeta en ambos extremos, en su propio poste.</li><li><b>Enrollada</b> — vueltas ordenadas en una sola dirección con la punta atrapada bajo la primera, sin cruces y con el sobrante recortado.</li><li><b>Afinada</b> — estirada y reafinada al menos dos veces, afinada en la revisión final.</li><li><b>Terminado a tiempo</b> — las seis listas y tu lugar recogido en menos de 40 minutos.</li></ol>La seguridad no es una quinta fila — es un alto: cortar o soltar una cuerda que sigue tensa termina el intento y lo vuelves a empezar. Las primeras tres se califican sobre las cuerdas que de verdad instalaste, así que una cuerda sin terminar solo te cuesta una vez. Abre la lista para ver exactamente cómo se ve cada elemento bien hecho.',
                skills: [1, 2, 3, 4]
              },
              {
