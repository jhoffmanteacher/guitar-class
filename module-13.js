    ...
    skills: [
      { id: 'm13w1-s1',
        ...
        practice: { type: 'mc',
          ...
          choices: ['Tie the traditional knot as well, for safety', 'Thread it through and let the ball seat flat', 'Trim the ball end off before threading it', 'Wrap it around the saddle twice to hold'],
          choices_es: ['Hacer también el nudo tradicional, por seguridad', 'Pasarla por el agujero y dejar que la bolita quede plana', 'Cortar la bolita antes de pasarla', 'Darle dos vueltas a la selleta para que aguante'],
          answer: 1,
      ...
      { id: 'm13w1-s2',
        ...
        practice: { type: 'mc',
          ...
          choices: ['Sit beside the last one, travelling along the roller', 'Sit below the last one, walking down the post', 'Cross over the wraps before it to lock them', 'Pile up on top of each other in one spot'],
          choices_es: ['Quedar al lado de la anterior, avanzando a lo largo del rodillo', 'Quedar debajo de la anterior, bajando por el poste', 'Cruzar por encima de las vueltas anteriores para trabarlas', 'Amontonarse una encima de otra en un solo punto'],
          answer: 0,
            ...
            steps: [
              {
                ...
                text: 'Strings wear out: they sound dull, feel rough, slip out of tune, and eventually break. Restringing a guitar is normal maintenance — every guitarist learns it. You\'ve got it when: you can name two signs a set of strings needs changing.',
                text_es: 'Las cuerdas se desgastan: suenan opacas, se sienten ásperas, se desafinan y al final se rompen. Cambiar las cuerdas es mantenimiento normal — todo guitarrista lo aprende. Lo tienes cuando: puedes nombrar dos señales de que un juego de cuerdas necesita cambio.',
                skills: [4]
              },
              {
