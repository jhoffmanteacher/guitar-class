            ...
            steps: [
              {
                ...
                text: 'Watch: <a href="https://www.youtube.com/watch?v=jGh2Erg-o8E&t=41" target="_blank">Encontrar los acordes en cualquier tonalidad – Guitarra con Maru (0:00–7:27)</a> (in Spanish — turn on English captions if you need them; the on-screen diagrams carry the lesson). Watch how she builds a chord on every note of the scale — that\'s the "chord family" you\'ll be naming with Roman numerals today.',
                text_es: 'Mira: <a href="https://www.youtube.com/watch?v=jGh2Erg-o8E&t=41" target="_blank">Encontrar los acordes en cualquier tonalidad – Guitarra con Maru (0:00–7:27)</a> (en español — activa los subtítulos en inglés si los necesitas; los diagramas en pantalla llevan la lección). Mira cómo ella construye un acorde en cada nota de la escala — esa es la "familia de acordes" que vas a nombrar con números romanos hoy.',
