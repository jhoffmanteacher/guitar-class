...
SETS.push(

  {
            ...
            steps: [
              {
                ...
                response: { type: 'mc', prompt: 'A triad is built by stacking:',
                  ...
                  answer: 1,
                  explain: 'Skip a note, skip a note: C, (skip D), E, (skip F), G — that is the C chord. Every chord you have strummed is one of these three-note stacks plus doubled notes. Notes that sit next to each other are a run of the scale, not a chord, and the same note in three octaves is still only one note.',
    ...
    skills: [
      { id: 'm11w1-s1', text: 'Build a triad from a scale (root–3rd–5th)',
        ...
        gotItWhen: 'you can stack root-3rd-5th on any scale note and name the three notes that come out.',
        gotItWhen_es: 'puedes apilar raíz-3ª-5ª sobre cualquier nota de una escala y nombrar las tres notas que resultan.',
      ...
      { id: 'm11w1-s3', text: 'Label "Let It Be"\'s C–G–Am–F as I–V–vi–IV',
        ...
        practice: { type: 'mc', prompt: '"Let It Be" runs C–G–Am–F in the key of C. Which numerals — and why is the "vi" lowercase?',
          ...
          choices: ['I–V–vi–IV — lowercase because Am is a minor chord', 'I–V–VI–IV — numerals are written in capitals', 'I–IV–V–vi — count the chords in play order 1, 4, 5, 6', 'vi–V–I–IV — Am is the key, so it gets I'],
          choices_es: ['I–V–vi–IV — minúscula porque Am es un acorde menor', 'I–V–VI–IV — los números romanos se escriben en mayúscula', 'I–IV–V–vi — cuenta los acordes en orden de aparición 1, 4, 5, 6', 'vi–V–I–IV — Am es la tonalidad, así que recibe el I'], answer: 0,
...

  {
    ...
    unit_es: 'Módulo 11 · Acordes, tonalidades y armonía',
    title: 'Set 2',
    subtitle: 'The chord inventory method · I–IV–V vs the famous four · Slash chords explained',
    subtitle_es: 'El método del inventario de acordes · I–IV–V vs. los famosos cuatro · Acordes con barra diagonal explicados',
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text: 'Given only a chord list (no song name), work out the key fast, before you do anything else.',
                text_es: 'Dada solo una lista de acordes (sin nombre de canción), deduce rápido la tonalidad antes de hacer cualquier otra cosa.',
                ...
                response: { type: 'mc', prompt: 'The fastest first move to find a song\'s key from a chord chart is:',
                  ...
                  answer: 1,
                  explain: 'Take an inventory of the chords, then find the one family that contains all of them — that narrows it to a single major key and its relative minor, and your ear picks between those two. First and last chords are clues, not rules: plenty of songs start away from home. Counting letters tells you nothing, because a key is about which chords fit together, not which one turns up most.',
                  explain_es: 'Haz un inventario de los acordes y luego encuentra la única familia que los contiene a todos — eso lo reduce a una sola tonalidad mayor y su relativa menor, y tu oído elige entre esas dos. El primer y el último acorde son pistas, no reglas: muchas canciones empiezan lejos de casa. Contar letras no dice nada, porque una tonalidad se trata de qué acordes encajan juntos, no de cuál aparece más.',
                  choices: ['Look at the first chord and name the key after it', 'Find the one chord family that holds every chord', 'Look at the last chord and name the key after it', 'Count the major chords and pick the commonest letter'],
                  choices_es: ['Mirar el primer acorde y nombrar la tonalidad por él', 'Encontrar la única familia que contiene todos los acordes', 'Mirar el último acorde y nombrar la tonalidad por él', 'Contar los acordes mayores y elegir la letra más común'] }
              }
            ]
          },
          {
    ...
    skills: [
      ...
      { id: 'm11w2-s3', text: 'Number "the cure"\'s progression in the key of C',
        ...
        gotItWhen: 'you can call out the numerals while playing "the cure"\'s Am–C–Dm–F, before checking them.',
        gotItWhen_es: 'puedes decir los números romanos mientras tocas el Am–C–Dm–F de "the cure", antes de revisarlos.',
        practice: { type: 'mc', prompt: '"the cure" moves Am–C–Dm–F in the key of C. Which numeral string is right?',
          ...
          choices: ['vi–I–ii–IV — number each chord by its degree in C', 'I–III–IV–VI — number them in the order they appear', 'vi–I–iv–IV — Dm is minor, so it\'s iv', 'i–III–iv–VI — the song starts on Am, so Am is i'],
          choices_es: ['vi–I–ii–IV — numera cada acorde por su grado en C', 'I–III–IV–VI — se numeran en el orden en que aparecen', 'vi–I–iv–IV — Dm es menor, así que es iv', 'i–III–iv–VI — la canción empieza en Am, así que Am es i'], answer: 0,
          explain: 'In C: Am=vi, C=I, Dm=ii, F=IV. Dm is lowercase ii (2nd scale degree, minor chord) — "iv" would mean a minor chord built on F. Fair warning on the i–III–iv–VI option: it really is a correct A-minor reading of this same loop, because C major and A minor share every note and both readings describe the same music. This question asked for the C reading. Its reasoning is still off, though — a song\'s first chord is not what picks the key; where the loop comes to rest is.',
          explain_es: 'En C: Am=vi, C=I, Dm=ii, F=IV. Dm es ii en minúscula (2º grado de la escala, acorde menor) — "iv" significaría un acorde menor construido sobre F. Una aclaración justa sobre la opción i–III–iv–VI: sí es una lectura correcta en A menor de este mismo loop, porque C mayor y A menor comparten todas sus notas y las dos lecturas describen la misma música. Esta pregunta pedía la lectura en C. Su razonamiento sigue estando mal, eso sí — el primer acorde de una canción no es lo que elige la tonalidad; lo que la elige es dónde el loop llega a descansar.' } },
...

  {
            ...
            steps: [
              ...
              },
              {
                ...
                response: { type: 'mc', prompt: 'The A-shape barre chord takes its NAME from:',
                  ...
                  answer: 0,
                  explain: 'The note under your barre on the A string names it — the same method as the E shape, just one string over.',
                  explain_es: 'La nota debajo de tu cejilla en la cuerda La lo nombra — el mismo método que la forma de E, solo una cuerda más allá.',
            ...
            steps: [
              {
                ...
                hint: 'Every chord has (at least) two barre homes — one for each shape. Module 9\'s fretboard naming is the key step here.',
                hint_es: 'Cada acorde tiene (al menos) dos hogares de cejilla — uno por cada forma. El nombrado del diapasón del Módulo 9 es el paso clave aquí.',
                stuck: 'Find the E-shape location first, get comfortable, then add the search for the A-shape position.',
    ...
    skills: [
      ...
      { id: 'm11w3-s6', text: 'Choose open vs barre voicing for a progression and say why',
        ...
        gotItWhen: 'you can say when you\'d reach for a barre versus an open chord, and give the reason, instead of picking one out of habit.',
        gotItWhen_es: 'puedes decir cuándo elegirías una cejilla frente a un acorde abierto, y dar la razón, en lugar de elegir uno por costumbre.',
