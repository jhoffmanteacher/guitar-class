            ...
            steps: [
              {
                ...
                response: { type: 'mc', prompt: '"the cure" uses Am–C–Dm–F–G/B. In the key of C, Am–C–Dm–F is:',
                  ...
                  explain_es: 'Am=vi, C=I, Dm=ii, F=IV — y el G/B es el acorde V con una B como su nota más grave, así que el bajo camina suavemente de vuelta a C.',
            ...
            steps: [
              {
                ...
                hint_es: 'Esto es exactamente lo que hace "the cure" para deslizarse del acorde de G de vuelta a la base en C — el acorde con bajo alterno es la pieza que conecta los dos acordes suavemente.',
            ...
            steps: [
              {
                ...
                levelUp_es: 'Cronométrate encontrando ambas ubicaciones e intenta superar tu mejor tiempo (compite con alguien si hay alguien cerca), o agrega una tercera ubicación de cejilla más arriba en el mástil.',
                skills: [1, 2]
              }
            ]
          },
            ...
            steps: [
              {
                ...
                text_es: 'Reto 2 — Constructor de I–IV–V: toca I–IV–V en G (G abierto o cejilla en el traste 3 · C · D), luego en A, y luego una tonalidad que saques al azar de tus papelitos de acordes. Lo tienes cuando: cambios limpios y a tiempo a 60 BPM, usando al menos una forma con cejilla.',
