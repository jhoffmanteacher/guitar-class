      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text_es: 'Reto 6 — Vuelta de Watchtower (tu pieza de evaluación): toca A5–G5–F5–G5, un compás (4 tiempos) por acorde, un rasgueo por tiempo a 60 BPM. Lo tienes cuando: cuatro veces seguidas, cambiando en el tiempo 1 cada vez, sin detenerte. <a href="tabs/all-along-the-watchtower.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 3 de 5</a>.',
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text_es: 'Reto — Estrofa de Sweet Child (ensayo de evaluación): toca la estrofa de Guns N\' Roses como acordes de potencia — D5 · C5 · G5, dos tiempos por acorde a 60 BPM. Esta es una de las canciones que puedes usar para la autoevaluación del módulo. Lo tienes cuando: cuatro vueltas limpias, cada cambio en el tiempo 1, silenciado ajustado. <a href="tabs/sweet-child-o-mine.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 3 de 5</a>.',
            ...
            hint_es: 'En este sitio tocamos Sweet Child en afinación estándar. (La grabación famosa está afinada medio tono más abajo, así que tu D5–C5–G5 suena un traste más alto que la grabación — eso es esperado; no reafines.) D5 y C5 son raíces de la cuerda La; G5 baja a la cuerda Mi grave.',
            stuck: 'Loop D5 → C5 (both A-string, 2 frets apart) until smooth, then add the jump to G5 on the low E string.',
            stuck_es: 'Repite D5 → C5 (ambas en la cuerda La, a 2 trastes de distancia) hasta que salga fluido, y luego agrega el salto a G5 en la cuerda Mi grave.',
            levelUp: 'Speed up in steps to 70, then 80 BPM, or add a straight-eighths strum.',
            levelUp_es: 'Acelera en pasos a 70, y luego a 80 BPM, o agrega un rasgueo de corcheas rectas.',
            skills: [3, 4],
            chords: [
              { name: 'D5', chord: [[6,'x'],[5,5,'1'],[4,7,'3'],[3,'x'],[2,'x'],[1,'x']], position: 5 },
              { name: 'C5', chord: [[6,'x'],[5,3,'1'],[4,5,'3'],[3,'x'],[2,'x'],[1,'x']], position: 3 },
