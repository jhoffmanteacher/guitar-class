      ...
      c: {
        ...
        sections: [
          ...
          },
          {
            ...
            text: '<ul><li>Play the full "All Along the Watchtower" loop as low-E power chords — A5 · G5 · F5 · G5 — two beats each at 60 BPM, looping.</li></ul>Four chord slots inside every two bars — this is exactly how the record cycles. You\'ve got it when: four clean laps, every change landing on the beat.',
            text_es: '<ul><li>Toca la vuelta completa de "All Along the Watchtower" como acordes de potencia en la cuerda Mi — A5 · G5 · F5 · G5 — dos tiempos cada uno a 60 BPM, repitiendo.</li></ul>Cuatro espacios de acorde dentro de cada dos compases — así es exactamente como cicla la grabación. Lo tienes cuando: cuatro vueltas limpias, cada cambio cayendo a tiempo.',
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text: 'This gentle acoustic song isn\'t usually played this way — that\'s the point. It\'s marked ◐, our flag for a song played against its natural style.<ul><li>Play the whole song as power chords — verse: A5 · C5, then F5 · C5; chorus: D5 · F5, then C5 · G5 — four beats per chord at 60 BPM, one strum per beat, quietly.</li></ul>You\'ve got it when: two laps clean AND soft — power chords don\'t have to be loud. No score — just try it. <a href="tabs/the-cure.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 3 of 5</a>.',
                text_es: 'Esta canción acústica y suave normalmente no se toca así — ese es el punto. Lleva la marca ◐, nuestra señal para una canción tocada en contra de su estilo natural.<ul><li>Toca la canción entera como acordes de potencia — estrofa: A5 · C5, y luego F5 · C5; coro: D5 · F5, y luego C5 · G5 — cuatro tiempos por acorde a 60 BPM, un rasgueo por tiempo, suavemente.</li></ul>Lo tienes cuando: dos vueltas limpias Y suaves — los acordes de potencia no tienen que ser fuertes. Sin puntaje — solo pruébalo. <a href="tabs/the-cure.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 3 de 5</a>.',
                hint: 'The verse roots — A, C, F — you already know from Module 2. D and G are new: they\'re this song\'s chorus. The challenge here is touch: light pick, both strings ringing, no harsh sound.',
                hint_es: 'Las raíces de la estrofa — A, C, F — ya las conoces del Módulo 2. D y G son nuevas: son el coro de esta canción. El reto aquí es el toque: púa ligera, ambas cuerdas sonando, sin sonido áspero.',
                ...
                levelUp: 'Play one lap loud and one lap soft and hear the difference. Then swap the last chord\'s root for the record\'s real bass note — B at fret 7 — instead of G5.',
                levelUp_es: 'Toca una vuelta fuerte y una vuelta suave y escucha la diferencia. Después cambia la raíz del último acorde por la nota de bajo real del disco — B en el traste 7 — en vez de G5.',
                tab: {
                  ...
                  notes: [
                    ...
                    { frets: [['A', 10], ['E', 8]], note: 'C5', midi: [55, 48] },
                    { frets: [['A', 10], ['E', 8]], note: 'C5', midi: [55, 48] },
                    { frets: [['A', 12], ['E', 10]], note: 'D5', midi: [57, 50] },
                    { frets: [['A', 12], ['E', 10]], note: 'D5', midi: [57, 50] },
                    { frets: [['A', 12], ['E', 10]], note: 'D5', midi: [57, 50] },
                    { frets: [['A', 12], ['E', 10]], note: 'D5', midi: [57, 50] },
                    { frets: [['A', 3], ['E', 1]], note: 'F5', midi: [48, 41] },
