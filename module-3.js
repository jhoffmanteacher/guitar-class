      ...
      c: {
        ...
        sections: [
          ...
          },
          {
            ...
            text: 'Now do the same up the A string:<ol><li>A5 (open).</li><li>B5 (2).</li><li>C5 (3).</li><li>D5 (5).</li><li>E5 (7).</li><li>F5 (8).</li><li>G5 (10).</li></ol>You\'ve got it when: name every root correctly up to G5 at the 10th fret, and notice the same note names land in different spots than they did on the E string. (The 12th-fret A5 octave is the level-up.)',
            text_es: 'Ahora haz lo mismo subiendo por la cuerda La:<ol><li>A5 (al aire).</li><li>B5 (2).</li><li>C5 (3).</li><li>D5 (5).</li><li>E5 (7).</li><li>F5 (8).</li><li>G5 (10).</li></ol>Lo tienes cuando: nombras cada raíz correctamente hasta el G5 en el traste 10, y notas que los mismos nombres de nota caen en lugares distintos a los de la cuerda Mi. (El A5 de la octava en el traste 12 es el nivel extra.)',
