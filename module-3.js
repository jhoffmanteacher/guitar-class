      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Walk the power chord UP the low E string, saying each root aloud as you land it:<ol><li>E5 (open).</li><li>F5 (1).</li><li>G5 (3).</li><li>A5 (5).</li><li>B5 (7).</li><li>C5 (8).</li><li>D5 (10).</li><li>E5 (12).</li></ol>You\'ve got it when: name every root correctly, without looking at the chart, all the way to the 12th fret.',
            text_es: 'Camina el acorde de potencia SUBIENDO por la cuerda Mi grave, diciendo cada raíz en voz alta al llegar a ella:<ol><li>E5 (al aire).</li><li>F5 (1).</li><li>G5 (3).</li><li>A5 (5).</li><li>B5 (7).</li><li>C5 (8).</li><li>D5 (10).</li><li>E5 (12).</li></ol>Lo tienes cuando: nombras cada raíz correctamente, sin mirar el diagrama, hasta el traste 12.',
          ...
          },
          {
            ...
            text: 'Now do the same up the A string:<ol><li>A5 (open).</li><li>B5 (2).</li><li>C5 (3).</li><li>D5 (5).</li><li>E5 (7).</li><li>F5 (8).</li><li>G5 (10).</li><li>A5 (12).</li></ol>You\'ve got it when: name every root correctly, and notice the same note names land in different spots than they did on the E string.',
            text_es: 'Ahora haz lo mismo subiendo por la cuerda La:<ol><li>A5 (al aire).</li><li>B5 (2).</li><li>C5 (3).</li><li>D5 (5).</li><li>E5 (7).</li><li>F5 (8).</li><li>G5 (10).</li><li>A5 (12).</li></ol>Lo tienes cuando: nombras cada raíz correctamente, y notas que los mismos nombres de nota caen en lugares distintos a los de la cuerda Mi.',
      ...
      c: {
        ...
        sections: [
          ...
          },
          {
            ...
            text: '<ul><li>Play three shapes now, still two beats each — G5 · C5 · D5, then back to G5, looping at 60 BPM.</li></ul>That\'s a I–IV–V in the key of G, the backbone of thousands of songs, moving at chorus speed. You\'ve got it when: two clean laps, every change on the beat.',
            text_es: '<ul><li>Toca ahora tres formas, todavía dos tiempos cada una — G5 · C5 · D5, y de vuelta a G5, repitiendo a 60 BPM.</li></ul>Eso es un I–IV–V en la tonalidad de G, la columna vertebral de miles de canciones, moviéndose a velocidad de coro. Lo tienes cuando: dos vueltas limpias, cada cambio a tiempo.',
            ...
            steps: [
          {
            ...
            text: 'Musicians number chords by counting up the musical alphabet from the key\'s home note (the note the music rests on and sounds finished). In the key of A: A is I, count up to D for IV, and E for V — so A5–D5–E5 is a I–IV–V.<ul><li>Play A5–D5–E5, two bars each, one strum per beat at 60 BPM.</li></ul>You\'ve got it when: you can play the loop reading only the chord symbols AND say which chord is the I, the IV, and the V. At the module self-check you\'ll read a three-chord (I–IV–V) progression from chord symbols with your named strum — this is that skill.',
            text_es: 'Los músicos numeran los acordes contando hacia arriba en el alfabeto musical desde la nota base de la tonalidad (la nota en la que descansa la música y que suena resuelta). En la tonalidad de A: A es I, cuenta hacia arriba hasta D para el IV, y E para el V — así que A5–D5–E5 es un I–IV–V.<ul><li>Toca A5–D5–E5, dos compases cada uno, un rasgueo por tiempo a 60 BPM.</li></ul>Lo tienes cuando: puedes tocar la vuelta leyendo solo los símbolos de acorde Y decir cuál acorde es el I, el IV y el V. En el autochequeo del módulo vas a leer una progresión de tres acordes (I–IV–V) a partir de símbolos de acorde con tu rasgueo nombrado — esa es esta destreza.',
          ...
          },
          {
            ...
            text: 'The other named strum for this progression. Split each pair of beats in two jobs:<ul><li>Beat 1: pick ONLY the root (your 1st-finger bass note).</li><li>Beat 2: strum the whole shape.</li></ul>Count "boom-chick, boom-chick": 1 = boom (root alone), 2 = chick (full chord), 3 = boom, 4 = chick. Play the A5–D5–E5 loop this way, two bars each at 60 BPM. You\'ve got it when: six bars where every boom is JUST the root string and every chick is the full shape — no accidental extra strings on the boom. Click "Hear the split strum" to hear one bar of A5 then one of D5.',
            text_es: 'El otro rasgueo nombrado para esta progresión. Divide cada par de tiempos en dos trabajos:<ul><li>Tiempo 1: pulsa SOLO la raíz (tu nota grave del dedo 1).</li><li>Tiempo 2: rasguea toda la forma.</li></ul>Cuenta "boom-chick, boom-chick": 1 = boom (solo la raíz), 2 = chick (acorde completo), 3 = boom, 4 = chick. Toca la vuelta A5–D5–E5 así, dos compases cada uno a 60 BPM. Lo tienes cuando: seis compases donde cada boom es SOLO la cuerda de la raíz y cada chick es la forma completa — sin cuerdas extra por accidente en el boom. Haz clic en "Escucha el rasgueo dividido" para oír un compás de A5 y luego uno de D5.',
            ...
            steps: [
          {
            ...
            text: '"Luna"\'s whole vamp (a vamp = a short chord pattern repeated over and over) is two power chords.<ol><li>Slide the same two-finger shape four frets between F5 (root F, low E string, fret 1) and A5 (root A, fret 5).</li><li>Strum one per big beat: "Luna" is in 6/8, so strum just the downbeats, two per bar, nothing syncopated (syncopated = accents landing off the main beat).</li></ol>You\'ve got it when: you can switch F5 ↔ A5 landing every downbeat clean, speeding up in steps: 60 → 70 → 80 BPM. <a href="tabs/luna.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 3 of 5</a>.',
            text_es: 'Todo el vamp de "Luna" (un vamp = un patrón de acordes corto que se repite una y otra vez) son dos acordes de potencia.<ol><li>Desliza la misma forma de dos dedos cuatro trastes entre F5 (raíz F, cuerda Mi grave, traste 1) y A5 (raíz A, traste 5).</li><li>Rasguea uno por tiempo fuerte: "Luna" está en 6/8, así que rasguea solo los tiempos fuertes, dos por compás, nada sincopado (sincopado = acentos que caen fuera del tiempo principal).</li></ol>Lo tienes cuando: puedes cambiar F5 ↔ A5 cayendo limpio en cada tiempo fuerte, acelerando en pasos: 60 → 70 → 80 BPM. <a href="tabs/luna.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 3 de 5</a>.',
            ...
            steps: [
          {
            ...
            text: '<ul><li>Play the Guns N\' Roses verse as power chords — D5 · C5 · G5, one note per bar at 60 BPM — the same patient, one-per-bar spacing as your Module 2 bass roots, just power chords now.</li></ul>This is one of the songs you can use for the module self-assessment. You\'ve got it when: two clean laps, every change on beat 1, each chord ringing the full bar, muting tight. <a href="tabs/sweet-child-o-mine.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 3 of 5</a>.',
            text_es: '<ul><li>Toca la estrofa de Guns N\' Roses como acordes de potencia — D5 · C5 · G5, una nota por compás a 60 BPM — el mismo espaciado paciente, una nota por compás, que tus raíces de bajo del Módulo 2, ahora con acordes de potencia.</li></ul>Esta es una de las canciones que puedes usar para la autoevaluación del módulo. Lo tienes cuando: dos vueltas limpias, cada cambio en el tiempo 1, cada acorde sonando el compás completo, silenciado ajustado. <a href="tabs/sweet-child-o-mine.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 3 de 5</a>.',
