    ...
    skills: [
      ...
      { id: 'm3w2-s4', text: 'Apply power chords on both E and A string roots in the same song',
        ...
        practice: { type: 'mc', prompt: 'A song calls for G5 then C5. Where does your index finger go for each?',
          ...
          choices_es: ['Ambos en la cuerda Mi grave, trastes 3 y 8', 'Ambos en la cuerda La, trastes 3 y 10', 'G5 en Mi (traste 3), C5 en La (traste 3)', 'G5 en La (traste 10), C5 en Mi (traste 8)'], answer: 2,
