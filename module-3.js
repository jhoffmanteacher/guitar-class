      ...
      c: {
        ...
        sections: [
          ...
          },
          {
            ...
            steps: [
          {
            label: 'Challenge: clean E5', label_es: 'Reto: E5 limpio',
          ...
          {
            label: 'Challenge: mute check', label_es: 'Reto: revisión de silenciado',
          ...
          },
          {
            ...
            steps: [
          {
            label: 'Challenge: shape shifter', label_es: 'Reto: cambiaformas',
            text: 'Challenge 3 — Shape Shifter: slide the same shape to each of these, saying each name aloud:<ul><li>A5 (5th fret E).</li><li>G5 (3rd fret E).</li><li>D5 (5th fret A).</li><li>C5 (3rd fret A).</li></ul>You\'ve got it when: hit all four cleanly without losing the shape.',
            text_es: 'Reto 3 — Cambiaformas: desliza la misma forma a cada una de estas, diciendo cada nombre en voz alta:<ul><li>A5 (traste 5 de Mi).</li><li>G5 (traste 3 de Mi).</li><li>D5 (traste 5 de La).</li><li>C5 (traste 3 de La).</li></ul>Lo tienes cuando: tocas las cuatro limpias sin perder la forma.',
          ...
          },
          {
            ...
            steps: [
          {
            label: 'Challenge: name & climb (E string)', label_es: 'Reto: nombra y sube (cuerda Mi)',
            text: 'Challenge 4 — Name & Climb (E string): walk the power chord UP the low E string, saying each root aloud as you land it:<ol><li>E5 (open).</li><li>F5 (1).</li><li>G5 (3).</li><li>A5 (5).</li><li>B5 (7).</li><li>C5 (8).</li><li>D5 (10).</li><li>E5 (12).</li></ol>You\'ve got it when: name every root correctly, without looking at the chart, all the way to the 12th fret.',
            text_es: 'Reto 4 — Nombra y sube (cuerda Mi): camina el acorde de potencia SUBIENDO por la cuerda Mi grave, diciendo cada raíz en voz alta al llegar a ella:<ol><li>E5 (al aire).</li><li>F5 (1).</li><li>G5 (3).</li><li>A5 (5).</li><li>B5 (7).</li><li>C5 (8).</li><li>D5 (10).</li><li>E5 (12).</li></ol>Lo tienes cuando: nombras cada raíz correctamente, sin mirar el diagrama, hasta el traste 12.',
          ...
          {
            label: 'Challenge: name & climb (A string)', label_es: 'Reto: nombra y sube (cuerda La)',
            text: 'Challenge 5 — Name & Climb (A string): now do the same up the A string:<ol><li>A5 (open).</li><li>B5 (2).</li><li>C5 (3).</li><li>D5 (5).</li><li>E5 (7).</li><li>F5 (8).</li><li>G5 (10).</li><li>A5 (12).</li></ol>You\'ve got it when: name every root correctly, and notice the same note names land in different spots than they did on the E string.',
            text_es: 'Reto 5 — Nombra y sube (cuerda La): ahora haz lo mismo subiendo por la cuerda La:<ol><li>A5 (al aire).</li><li>B5 (2).</li><li>C5 (3).</li><li>D5 (5).</li><li>E5 (7).</li><li>F5 (8).</li><li>G5 (10).</li><li>A5 (12).</li></ol>Lo tienes cuando: nombras cada raíz correctamente, y notas que los mismos nombres de nota caen en lugares distintos a los de la cuerda Mi.',
        ...
        sections: [
          {
            ...
            steps: [
          {
            label: 'Challenge: loop in time', label_es: 'Reto: vuelta a tiempo',
          ...
          },
          {
            ...
            steps: [
          {
            label: 'Challenge: half-bar switches (2 chords)', label_es: 'Reto: medio compás (2 acordes)',
          ...
          },
          {
            ...
            steps: [
          {
            label: 'Challenge: octave add-on', label_es: 'Reto: octava extra',
