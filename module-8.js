    ...
    skills: [
      ...
      { id: 'm8w1-s2', text: 'Identify p, i, m, a finger letters and their string assignments',
        ...
        practice: { type: 'mc', prompt: 'In p-i-m-a notation, which finger handles the G string (string 3)?',
          ...
          explain: 'i (the index finger) lives on the G string — that\'s its home. p covers the bass strings, m takes B and a takes high e, so every finger has exactly one job.',
          explain_es: 'La i (el dedo índice) vive en la cuerda Sol — ese es su hogar. La p cubre las cuerdas graves, la m toma la Si y la a la mi aguda, así cada dedo tiene un solo trabajo.' } },
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: '<ol><li>Fret Em.</li><li>Play the 6-note pattern p-i-m-a-m-i at 60 BPM, one note per click, for 8 bars.</li></ol>You\'ve got it when: a steady, even pulse with every note ringing clean.',
            text_es: '<ol><li>Trastea Em.</li><li>Toca el patrón de 6 notas p-i-m-a-m-i a 60 BPM, una nota por clic, durante 8 compases.</li></ol>Lo tienes cuando: un pulso constante y parejo con cada nota sonando limpia.',
