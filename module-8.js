...
SETS.push(
  ...
  {
    id: 'm8w1',
    songThread: [{ name: '"the cure"', journey: 'tabs/the-cure.html', layer: 6, bonus: true, note: 'first touch — the fingerpicked verse begins' }],
    label: 'Set 1',
    locked: false,
      ...
      b: {
        ...
        sections: [
          ...
          },
          {
            ...
            hint: 'Justin\'s assignment: thumb handles the low E, A, and D strings (the bass) and i-m-a handle the G, B, and high e strings (treble). One finger per string is the goal.',
            hint_es: 'La asignación de Justin: el pulgar se encarga de las cuerdas Mi grave, La y Re (el bajo) y i-m-a se encargan de las cuerdas Sol, Si y mi aguda (las agudas). Un dedo por cuerda es la meta.',
            skills: [2, 3],
            response: { type: 'mc', prompt: 'Which finger normally plucks the B string?',
              prompt_es: '¿Cuál dedo pulsa normalmente la cuerda Si?',
              answer: 2,
              explain: 'Each finger gets a "home" string: i on the G string, m on the B string, a on the high e. So the B string is m (middle).',
              explain_es: 'Cada dedo tiene una cuerda "de base": i en la cuerda Sol, m en la cuerda Si, a en la mi aguda. Así que la cuerda Si es m (medio).',
              choices: [
              'p (thumb)',
              'i (index)',
              'm (middle)',
      ...
      c: {
        ...
        sections: [
          ...
          },
          {
            ...
            steps: [
          {
            label: 'Challenge 2 — p-i-m-a Plucks (assessment preparation)', label_es: 'Reto 2 — Pulsaciones p-i-m-a (preparación para la evaluación)',
            text: '<ul><li>Pluck once with each finger in order — p (low E), i (G), m (B), a (high e) — saying each letter aloud, 8 times at 60 BPM.</li></ul>You\'ve got it when: the same volume from every finger, even the weaker ring (a).',
            text_es: '<ul><li>Pulsa una vez con cada dedo en orden — p (Mi grave), i (Sol), m (Si), a (mi aguda) — diciendo cada letra en voz alta, 8 veces a 60 BPM.</li></ul>Lo tienes cuando: el mismo volumen en cada dedo, incluso en el anular (a), que es más débil.',
            ...
            steps: [
              {
                ...
                levelUp: 'Add F: the thumb travels to the D string for it — and now you have the song\'s whole verse loop (Am · C · Am · C, then F · C · F · C — eight bars).',
                levelUp_es: 'Agrega F: el pulgar viaja a la cuerda Re para tocarlo — y ahora tienes todo el loop de la estrofa de la canción (Am · C · Am · C, y luego F · C · F · C — ocho compases).',
                skills: [5, 6],
    ...
    skills: [
      ...
      { id: 'm8w1-s2', text: 'Name p, i, m, a finger letters and their string assignments',
        text_es: 'Nombrar las letras de dedos p, i, m, a y sus cuerdas asignadas',
        ...
        practice: { type: 'mc', prompt: 'In p-i-m-a notation, which finger handles the G string?',
          prompt_es: 'En la notación p-i-m-a, ¿cuál dedo se encarga de la cuerda Sol?',
  ...
  {
    id: 'm8w2',
    songThread: [{ name: '"the cure"', journey: 'tabs/the-cure.html', layer: 6, bonus: true, note: 'the fingerpicked verse, the full loop' }],
    label: 'Set 2',
    locked: false,
    module: 'Finger Picking',
    moduleNum: 8,
      ...
      b: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Listen to "Nothing Else Matters" by Metallica. The intro is entirely fingerpicked open chords. Tap along and count 1 to 6 for each bar.',
            text_es: 'Escucha "Nothing Else Matters" de Metallica. El intro son acordes al aire tocados enteramente con fingerpicking. Sigue el ritmo y cuenta del 1 al 6 en cada compás.',
            ...
            response: { type: 'mc', prompt: 'In a typical fingerpicked arpeggio, what role does the THUMB usually play?',
              ...
              answer: 0,
              explain: 'The thumb is the anchor — it stays on a bass string and plays the low bass notes while i, m, and a handle the higher, faster notes. It is the slowest-moving finger in the pattern, not the fastest, and it never doubles a treble string: the thumb owns the bass and the fingers own the top.',
              explain_es: 'El pulgar es el ancla — se queda en una cuerda grave y toca las notas graves mientras i, m y a se encargan de las notas más agudas y rápidas. Es el dedo que menos se mueve del patrón, no el que más, y nunca dobla una cuerda aguda: el pulgar es dueño de los graves y los dedos del agudo.',
              choices: [
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Six notes make one bar here — that is 6/8 time, the same pulse you\'ve felt in "Luna" since Module 2, now counted out note by note instead of felt in 2:<ol><li>Fret Em.</li><li>Play the 6-note pattern p-i-m-a-m-i at 60 BPM, one note per click, for 8 bars.</li><li>Count "1-2-3-4-5-6" out loud so the thumb always lands on count 1.</li></ol>You\'ve got it when: a steady, even pulse with every note ringing clean and p on every count 1.',
            text_es: 'Seis notas forman un compás aquí — eso es el compás de 6/8, el mismo pulso que has sentido en "Luna" desde el Módulo 2, ahora contado nota por nota en lugar de sentido en 2:<ol><li>Trastea Em.</li><li>Toca el patrón de 6 notas p-i-m-a-m-i a 60 BPM, una nota por clic, durante 8 compases.</li><li>Cuenta "1-2-3-4-5-6" en voz alta para que el pulgar siempre caiga en el conteo 1.</li></ol>Lo tienes cuando: un pulso constante y parejo con cada nota sonando limpia y la p en cada conteo 1.',
            hint: '"Nothing Else Matters", the song you listened to earlier in this set, is in 6/8 too — that is exactly why this six-note pattern fits it so neatly. Songs in 4/4 (four beats a bar) need a different count, and you will do that on the song card at the bottom of this station. Keep one note per click.',
            hint_es: '"Nothing Else Matters", la canción que escuchaste antes en esta unidad, también está en 6/8 — por eso justamente este patrón de seis notas le queda tan bien. Las canciones en 4/4 (cuatro tiempos por compás) necesitan otro conteo, y eso lo harás en la tarjeta de canción al final de esta estación. Toca una nota por clic.',
          ...
          },
          {
            ...
            steps: [
          {
            label: 'Challenge 3 — Em Pattern at 70+ BPM (assessment preparation)', label_es: 'Reto 3 — Patrón en Em a 70+ BPM (preparación para la evaluación)',
            text: '<ol><li>Play the Em pattern at 70 BPM.</li><li>Try 80.</li></ol>You\'ve got it when: clean at 70+ with the "a" finger landing right on its beat — drop back to 60 if it falls apart.',
            text_es: '<ol><li>Toca el patrón de Em a 70 BPM.</li><li>Intenta 80.</li></ol>Lo tienes cuando: limpio a 70+ con el dedo "a" cayendo justo en su tiempo — baja a 60 si se desarma.',
            ...
            stuck: 'Go back to 60 BPM and stay there until it\'s effortless.',
            stuck_es: 'Regresa a 60 BPM y quédate ahí hasta que salga sin esfuerzo.',
            ...
            steps: [
              {
                ...
                skills: [4, 6],
                tab: {
                  caption: '"the cure" — fingerstyle bass roots · Am · C · Am · C, then F · C · F · C · one bar each · 60 BPM',
                  caption_es: '"the cure" — raíces graves de fingerstyle · Am · C · Am · C, y luego F · C · F · C · un compás cada uno · 60 BPM',
                  notes: [
                    { string: 'A', fret: 0, note: 'A', midi: 45 },
                    { string: 'A', fret: 0, note: 'A', midi: 45 },
                    { string: 'A', fret: 0, note: 'A', midi: 45 },
  ...
  {
    id: 'm8w3',
    songThread: [{ name: '"Let It Be"', journey: 'tabs/let-it-be.html', layer: 6, bonus: true, note: 'the fingerpicked arrangement' }],
    label: 'Set 3',
    locked: false,
    module: 'Finger Picking',
    moduleNum: 8,
      ...
      b: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            hint: 'Travis picking uses an ALTERNATING thumb: bass note on beat 1, a different bass note on beat 3. The fingers fill in between. You hear it in country, folk and pop.',
            ...
            steps: [
          {
            ...
            hint: 'In professional recordings the pattern almost never breaks at a chord change. That is the standard to listen for — no pause, no stutter, right through the change.',
            hint_es: 'En las grabaciones profesionales el patrón casi nunca se rompe en un cambio de acorde. Ese es el estándar que debes escuchar — sin pausa, sin tropiezo, justo en el cambio.',
            skills: [4, 5],
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Before you fingerpick the progression:<ol><li>Strum each chord once (Am, C, D, F).</li><li>Check every string you\'re supposed to play rings clean — some strings stay muted on purpose on these shapes, same as in Module 5.</li></ol>You\'ve got it when: all four shapes clean on a strum before you pick a single note through them.',
            text_es: 'Antes de tocar la progresión con fingerpicking:<ol><li>Rasguea cada acorde una vez (Am, C, D, F).</li><li>Revisa que suenen limpias todas las cuerdas que debes tocar — algunas cuerdas quedan silenciadas a propósito en estas formas, igual que en el Módulo 5.</li></ol>Lo tienes cuando: las cuatro formas suenan limpias con un rasgueo antes de puntear una sola nota a través de ellas.',
            ...
            steps: [
          {
            ...
            hint: 'Pinches lead into Travis picking — thumb and finger move toward each other and meet. Listen for ONE sound, not a flam (two close hits).',
            hint_es: 'Los pellizcos llevan al Travis picking — el pulgar y el dedo se mueven uno hacia el otro y se encuentran. Escucha UN solo sonido, no un "flam" (dos golpes muy cercanos).',
            ...
            steps: [
          {
            ...
            text: '<ol><li>Change your C shape first: add your PINKY on the low E string, fret 3. The open C from Module 5 mutes the low E, so there is no bass note down there to alternate to — this four-finger version is called the "Travis C".</li><li>Warm up Travis picking on it — thumb alternating the A string, root C (beats 1 & 3) and the low E string, fret 3 = G, the 5th (beats 2 & 4), thumb-only at 60 BPM.</li></ol>That\'s the "root and the 5th" alternating bass from the intro video — both bass strings, no fingers yet. You\'ve got it when: a steady, even alternating thumb — then add an i-pluck on the B string on each "+".',
            text_es: '<ol><li>Primero cambia tu forma de C: agrega tu MEÑIQUE en la cuerda Mi grave, traste 3. El C al aire del Módulo 5 silencia la Mi grave, así que ahí abajo no hay ninguna nota grave con la cual alternar — esta versión de cuatro dedos se llama el "C de Travis".</li><li>Calienta el Travis picking sobre ella — pulgar alternando entre la cuerda La, raíz C (tiempos 1 y 3) y la cuerda Mi grave, traste 3 = G, la 5ª (tiempos 2 y 4), solo el pulgar a 60 BPM.</li></ol>Ese es el bajo alternante de "raíz y la 5ª" del video introductorio — ambas cuerdas graves, todavía sin dedos. Lo tienes cuando: un pulgar alternante constante y parejo — y luego agrega una pulsación de i en la cuerda Si en cada "+".',
            hint: 'The pinky and the ring finger end up on the same fret, one string apart — the low E and A strings, both at fret 3. Then play only the thumb. Once that\'s steady, add an i-pluck on the B string on the "+" of each beat. Travis picking adds fingers ON TOP of an already-grooving thumb.',
            hint_es: 'El meñique y el anular terminan en el mismo traste, a una cuerda de distancia — la cuerda Mi grave y la cuerda La, las dos en el traste 3. Después toca solo el pulgar. Una vez que esté estable, agrega una pulsación de i en la cuerda Si en el "+" de cada tiempo. El Travis picking agrega dedos ENCIMA de un pulgar que ya tiene groove.',
            stuck: 'If the pinky won\'t reach the low E string yet, keep the plain open C and alternate the A string (root C) with the D string (fret 2, the note E) instead — a lighter bass, but the same alternating motion. Thumb only, no fingers, as slow as you need — get the alternating bass rock-steady before adding anything on top.',
            stuck_es: 'Si el meñique todavía no alcanza la cuerda Mi grave, quédate con el C al aire normal y alterna la cuerda La (raíz C) con la cuerda Re (traste 2, la nota E) — un bajo más ligero, pero el mismo movimiento alternante. Solo el pulgar, sin dedos, tan despacio como necesites — logra que el bajo alternante sea firme como una roca antes de agregar algo encima.',
            ...
            steps: [
              {
                ...
                hint: 'Eight notes still too many? Play Set 1\'s four-note p-i-m-a, one note per beat — four notes fill a 4/4 bar exactly. Either size, anticipate like the second lesson video showed you: the fretting hand starts moving on the pattern\'s last note, so beat 1 always lands ready. (One bar per chord is a slow teaching count — the record actually feels each chord in two beats, about twice as fast.)',
          ...
          },
          {
            ...
            steps: [
          {
            label: 'Challenge 5 — Fingerpick a Full Song (assessment preparation)', label_es: 'Reto 5 — Toca una canción completa (preparación para la evaluación)',
            text: '<ol><li>Pick one song — "the cure", "Hallelujah" (from Module 5\'s song list), "Let It Be" (verse), or a choice-list song.</li><li>Play it through 3 times without stopping, even with mistakes.</li></ol>If you miss a note, keep playing.',
            text_es: '<ol><li>Elige una canción — "the cure", "Hallelujah" (de la lista de canciones del Módulo 5), "Let It Be" (estrofa), o una canción de la lista de elección.</li><li>Tócala completa 3 veces sin detenerte, incluso con errores.</li></ol>Si te equivocas en una nota, sigue tocando.',
            hint: 'No one to play for? Record yourself on your phone or device and watch it back — the playback shows you exactly where the pattern broke.',
            hint_es: '¿No tienes a nadie para quien tocar? Grábate en tu teléfono o dispositivo y vuelve a verlo — la grabación te muestra exactamente dónde se rompió el patrón.',
            stuck: 'Pick the shortest, slowest song you know (Hallelujah is forgiving) and play just the verse.',
            stuck_es: 'Elige la canción más corta y lenta que conozcas (Hallelujah es indulgente) y toca solo la estrofa.',
    ...
    skills: [
      { id: 'm8w3-s1', text: 'Fingerpick a 4-chord progression with the pattern unbroken',
        ...
        practice: { type: 'playSeq', label: 'Am · C · D · F bass roots', label_es: 'Raíces graves Am · C · D · F', bpm: 60,
          notes: [45, 48, 50, 53] } },
      { id: 'm8w3-s2', text: 'Play Travis picking — thumb alternates between two bass strings',
        text_es: 'Tocar el Travis picking — el pulgar alterna entre dos cuerdas graves',
      ...
      { id: 'm8w3-s6', text: 'Perform a fingerpicked song for an audience (family, a friend, or a recording you share)',
        ...
        practice: { type: 'mc', prompt: 'Mid-performance you flub a note. What do experienced players do?',
          ...
          explain: 'Keep the beat going — a dropped note vanishes if the rhythm survives, and most listeners never notice it. Stopping or announcing the mistake is what audiences actually remember.',
          explain_es: 'Mantén el pulso — una nota perdida desaparece si el ritmo sobrevive, y la mayoría de los oyentes ni la nota. Detenerse o anunciar el error es lo que el público de verdad recuerda.' } }
    ]
  }
...
MODULE_SONGS[8] = [
      ...
      { name: '"Blackbird" — The Beatles', meta: 'Advanced fingerpicking · hardest song on the list', meta_es: 'Fingerpicking avanzado · la canción más difícil de la lista', type: 'Choice', core: false, level: 3,
...
MODULE_REVIEWS[8] = {
  ...
  skills: [
    ...
    { id: 'mr8-s6', text: 'I can play Travis picking — thumb alternating between two bass strings — steadily for at least 4 bars', text_es: 'Puedo tocar el Travis picking — el pulgar alternando entre dos cuerdas graves — de forma constante durante al menos 4 compases', set: 'm8w3' },
  ...
  forward: 'You finished the first half. Module 9 teaches the notes on all six strings and how to write your own TAB.',
  forward_es: 'Terminaste la primera mitad. El Módulo 9 enseña las notas en las seis cuerdas y cómo escribir tu propio TAB.',
