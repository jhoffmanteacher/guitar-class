            ...
            steps: [
              {
                ...
                text: '<ol><li>Listen to the recording — the riff you\'ve played since Module 1, but always as one even note per beat, until now.</li><li>Find the riff\'s TAB with rhythm stems — the stem marks sit above the numbers.</li><li>Play it the way the record actually goes — long notes held, quick notes tucked between beats.</li></ol>You\'ve got it when: you can play along with the record and stay locked with it. <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Song Journey: the riff that started it all</a>.',
                text_es: '<ol><li>Escucha la grabación — el riff que has tocado desde el Módulo 1, pero siempre con una nota pareja por tiempo, hasta ahora.</li><li>Encuentra el TAB del riff con plicas de ritmo — las marcas de plica van arriba de los números.</li><li>Tócalo como suena de verdad en la grabación — notas largas sostenidas, notas rápidas metidas entre los tiempos.</li></ol>Lo tienes cuando: puedes tocar junto con la grabación y mantenerte sincronizado con ella. <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Recorrido de la canción: el riff que lo empezó todo</a>.',
