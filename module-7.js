...
SETS.push(
...

  {
    ...
    songs: [
      ...
      { name: 'Core Song 2 — TBD', meta: 'Use barre chords in the chorus (instead of simplified shapes)', type: 'Core', core: true },
...

  {
    ...
    songs: [
      ...
      { name: 'Core Song 2 — TBD', meta: 'Barre-chord shapes (TBD once the song is picked)', type: 'Core', core: true },
      { name: '"Sweet Child O\' Mine" — Guns N\' Roses', meta: 'Barre the D–C–G verse', type: 'Core', core: true,
        originalUrl: 'https://www.youtube.com/watch?v=1w7OgIMMRc4',
        tutorialUrl: 'https://www.youtube.com/watch?v=0ASVeXINKYM' },
      { name: '"Tu Boda" — Oscar Maydon × Fuerza Regida', meta: 'Barre-chord sierreño progression', type: 'Core', core: true,
