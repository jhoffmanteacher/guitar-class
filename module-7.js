    ...
    skills: [
      { id: 'm7w1-s1', text: 'Read stacked TAB numbers as a chord (play simultaneously)',
        ...
        practice: { type: 'mc', prompt: 'TAB shows "3" on the A string and "3" on the D string, stacked vertically. How should you play it?',
          ...
          explain: 'Stacked numbers line up in time, so they sound together — one motion across both strings. Numbers spread out left to right are the ones you play one after another.',
          explain_es: 'Los números apilados se alinean en el tiempo, así que suenan juntos — un solo movimiento a través de ambas cuerdas. Los números repartidos de izquierda a derecha son los que tocas uno tras otro.' } },
      ...
      { id: 'm7w1-s3', text: 'Recognize hammer-on (h), pull-off (p), and slide (/ or \\) markings',
        ...
        practice: { type: 'mc', prompt: 'In TAB, "5h7" tells you to:',
          ...
          explain: 'The "h" means hammer-on: pick the first note only, then press a finger down firmly on the higher fret so the second note sounds by itself. Picking both would lose the point — the smooth, connected sound comes from the fretting hand alone.',
    ...
    skills: [
      ...
      { id: 'm7w2-s2', text: 'Position my thumb correctly behind the neck for barre chords',
        ...
        practice: { type: 'mc', prompt: 'For maximum squeezing power on a barre chord, your thumb should be:',
          ...
          explain: 'Thumb flat on the back of the neck, roughly behind your index finger, turns your hand into a clamp — thumb and barre squeeze toward each other. Wrapping the thumb over the top is fine for open chords, but it takes that leverage away.',
          explain_es: 'El pulgar plano en la parte trasera del mástil, más o menos detrás de tu dedo índice, convierte tu mano en una prensa — el pulgar y la cejilla aprietan uno contra el otro. Envolver el pulgar por encima está bien para los acordes al aire, pero te quita esa palanca.' } },
