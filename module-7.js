            ...
            steps: [
              {
                ...
                hint: 'You\'ve slid both barre shapes all over the neck — these two are the lowest, and the last two shapes left in this module. Same two shapes you already own, just parked down low where the strings fight hardest. F#: the E-shape bar on fret 2 — two frets above the open E chord. Bb: the A-shape bar on fret 1 — the index bars from the A string down with its tip leaning over the low E string just enough to deaden it, and your middle, ring and pinky take the D, G, and B strings at fret 3 (one finger per string, the same way you built B, C and D) — one fret above the open A chord. Read the roots: the low E string fret 2 = F#, the A string fret 1 = Bb. Tap ▶ to hear each chord.',
