            ...
            steps: [
              {
                ...
                hint: 'The frets haven\'t changed since Module 1 — only the rhythm reading is new. That\'s the reason for this set: same notes, real music. (Module 4 has a &#x25B6; button pair — straight count vs. the record — if you want to hear the two side by side again.)',
                hint_es: 'Los trastes no han cambiado desde el Módulo 1 — solo la lectura del ritmo es nueva. Esa es la razón de esta unidad: mismas notas, música real. (El Módulo 4 tiene un par de botones &#x25B6; — conteo recto vs. la grabación — si quieres volver a escuchar los dos lado a lado.)',
