...

  {
      ...
      b: {
        ...
        sections: [
          ...
          },
          {
            ...
            text: 'Watch: <a href="https://youtu.be/tCQ0r7vqkFQ?t=58" target="_blank">Smoke On The Water Guitar Lesson – Marty Music</a> (0:58–4:00). This is the riff you\'ll learn further down this set.',
            text_es: 'Mira: <a href="https://youtu.be/tCQ0r7vqkFQ?t=58" target="_blank">Smoke On The Water Guitar Lesson – Marty Music</a> (0:58–4:00). Este es el riff que vas a aprender más adelante en esta unidad.',
      ...
      c: {
        ...
        sections: [
          ...
          },
          {
            ...
            steps: [
          {
            label: 'Challenge 2 — Alternate-picking workout', label_es: 'Reto 2 — Ejercicio de púa alternada',
            text: '<ul><li>Read the rhythm first: notes 2 and 3 are a beamed pair of 8th notes (two squeezed into one beat), notes 1 and 4–7 are quarter notes (one beat each), and the last note is a half note (held two full beats).</li><li>Then play the riff on the low E and A strings with strict alternate picking — one stroke per note, alternating down-up.</li></ul>You\'ve got it when: clean and even at 60 BPM before you speed it up, with the 8th-note pair and the held last note clearly different from the quarters.',
            text_es: '<ul><li>Lee el ritmo primero: las notas 2 y 3 son un par de corcheas unidas por barra (dos metidas en un solo tiempo), las notas 1 y 4–7 son negras (un tiempo cada una), y la última nota es una blanca (sostenida dos tiempos completos).</li><li>Luego toca el riff en las cuerdas Mi grave y La con púa alternada estricta — un golpe de púa por nota, alternando abajo-arriba.</li></ul>Lo tienes cuando: sale limpio y parejo a 60 BPM antes de acelerarlo, con el par de corcheas y la última nota sostenida claramente distintas de las negras.',
            hint: 'Use alternate picking (down-up-down-up). Tap ▶ on the TAB to hear the rhythm — the two 8th notes go by twice as fast as the quarters, and the last note rings for two beats. Start at 60 BPM and only speed up when it\'s clean. Set the ⏱ Timer for 2 minutes and loop it.',
            hint_es: 'Usa púa alternada (abajo-arriba-abajo-arriba). Toca ▶ en el TAB para escuchar el ritmo — las dos corcheas pasan al doble de velocidad que las negras, y la última nota suena dos tiempos. Empieza a 60 BPM y solo acelera cuando salga limpio. Pon el ⏱ Temporizador en 2 minutos y repítelo.',
            stuck: 'Drop to 50 BPM and keep strict down-up-down-up picking. Loop just the first 4 notes until they\'re automatic.',
            stuck_es: 'Baja a 50 BPM y mantén la púa estricta abajo-arriba-abajo-arriba. Repite solo las primeras 4 notas hasta que salgan automáticas.',
            ...
            skills: [2],
            tab: {
              caption: 'Alternate-picking workout riff · low E and A strings · 2 bars: quarter, two 8ths, quarter, quarter | quarter, quarter, half',
              caption_es: 'Riff de ejercicio de púa alternada · cuerdas Mi grave y La · 2 compases: negra, dos corcheas, negra, negra | negra, negra, blanca',
              notes: [
                { string: 'A', fret: 7, note: 'E',  midi: 52, beats: 1 },
                { string: 'E', fret: 7, note: 'B',  midi: 47, beats: 0.5 },
                { string: 'A', fret: 5, note: 'D',  midi: 50, beats: 0.5 },
                { string: 'E', fret: 5, note: 'A',  midi: 45, beats: 1 },
                { string: 'A', fret: 3, note: 'C',  midi: 48, beats: 1 },
                { string: 'E', fret: 3, note: 'G',  midi: 43, beats: 1 },
                { string: 'A', fret: 2, note: 'B',  midi: 47, beats: 1 },
                { string: 'E', fret: 0, note: 'E',  midi: 40, beats: 2 }
              ]
            }
          }
            ]
            ...
            steps: [
              {
                ...
                text: '<ol><li>Listen to the recording — the riff you\'ve played since Module 2, but always as one even note per beat, until now.</li><li>Find the riff\'s TAB with rhythm stems — the stem marks sit above the numbers.</li><li>Play it the way the record actually goes — long notes held, quick notes tucked between beats.</li></ol>You\'ve got it when: you can play along with the record and stay locked with it. <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Song Journey: the riff that started it all</a>.',
                text_es: '<ol><li>Escucha la grabación — el riff que has tocado desde el Módulo 2, pero siempre con una nota pareja por tiempo, hasta ahora.</li><li>Encuentra el TAB del riff con plicas de ritmo — las marcas de plica van arriba de los números.</li><li>Tócalo como suena de verdad en la grabación — notas largas sostenidas, notas rápidas metidas entre los tiempos.</li></ol>Lo tienes cuando: puedes tocar junto con la grabación y mantenerte sincronizado con ella. <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Recorrido de la canción: el riff que lo empezó todo</a>.',
                hint: 'The frets haven\'t changed since Module 2 — only the rhythm reading is new. That\'s the reason for this set: same notes, real music. (Module 4 has a &#x25B6; button pair — straight count vs. the record — if you want to hear the two side by side again.)',
                hint_es: 'Los trastes no han cambiado desde el Módulo 2 — solo la lectura del ritmo es nueva. Esa es la razón de esta unidad: mismas notas, música real. (El Módulo 4 tiene un par de botones &#x25B6; — conteo recto vs. la grabación — si quieres volver a escuchar los dos lado a lado.)',
            ...
            steps: [
              {
                ...
                text: '<ol><li>Play this short lick (a brief solo phrase) on the G string.</li><li>Pick ONLY where the TAB shows a plain fret number.</li><li>Everywhere you see an h, p, or /, make the note with your fretting hand alone — no new pick (these are slurs: notes joined smoothly without picking each one).</li></ol>You\'ve got it when: the hammered, pulled, and slid notes ring out just as loud as the ones you actually pick.',
                text_es: '<ol><li>Toca este lick corto (una frase breve de solo) en la cuerda Sol.</li><li>Pulsa SOLO donde el TAB muestre un número de traste normal.</li><li>En todos los lugares donde veas una h, una p, o una /, haz la nota solo con tu mano de trastear — sin pulsar de nuevo (estas son ligaduras: notas unidas suavemente sin pulsar cada una).</li></ol>Lo tienes cuando: las notas de hammer-on, pull-off y deslizamiento suenan tan fuerte como las que sí pulsas.',
                hint: 'Hammer-on (h7): pick the 5, then bring your ring finger down firmly onto the 7 — the string keeps ringing, no pick. Pull-off (p5): from the 7, flick that same finger off sideways so the already-fretted 5 sounds. Slide (/9): pick the 7 and slide the finger up to the 9 without lifting off. Tap ▶ on the TAB to hear the target.',
                hint_es: 'Hammer-on (h7): pulsa el 5, y luego baja tu dedo anular con firmeza sobre el 7 — la cuerda sigue sonando, sin pulsar. Pull-off (p5): desde el 7, saca ese mismo dedo hacia el costado de un tirón para que suene el 5 que ya estaba trasteado. Deslizamiento (/9): pulsa el 7 y desliza el dedo hasta el 9 sin levantarlo. Toca ▶ en el TAB para escuchar el objetivo.',
    ...
    skills: [
      { id: 'm7w1-s1', text: 'Read stacked TAB numbers as a chord (play simultaneously)',
        ...
        practice: { type: 'mc', prompt: 'A riff has six TAB columns: two hold a single number, and four hold two numbers stacked. How many pick strokes does the riff need?',
          prompt_es: 'Un riff tiene seis columnas de TAB: dos tienen un solo número y cuatro tienen dos números apilados. ¿Cuántos golpes de púa necesita el riff?',
          choices: ['Ten — one for every number on the page', 'Two — only the single numbers get picked', 'Six — one stroke for each column', 'Four — only the stacked columns get picked'],
          choices_es: ['Diez — uno por cada número de la página', 'Dos — solo se pulsan los números que van solos', 'Seis — un golpe por cada columna', 'Cuatro — solo se pulsan las columnas apiladas'], answer: 2,
          explain: 'Stacked numbers share one moment in time, so a single stroke across both strings covers the whole column. Counting ten — one stroke for every number on the page — is the common slip: there are ten numbers, but only six moments.',
          explain_es: 'Los números apilados comparten un solo momento, así que un golpe a través de las dos cuerdas cubre toda la columna. Contar diez — un golpe por cada número de la página — es el error común: hay diez números, pero solo seis momentos.' } },
      { id: 'm7w1-s2', text: 'Tell quarter, 8th and half notes apart in TAB rhythm symbols',
        text_es: 'Distinguir negras, corcheas y blancas en los símbolos de ritmo del TAB',
        ...
        practice: { type: 'mc', prompt: 'Two TAB notes with their stems JOINED by a single beam (like ♫) are what kind of notes?',
          ...
          explain: 'A beam — the bar joining two stems — cuts the note value in half, so a beamed pair is 8th notes: two per beat. A stem with no beam is a quarter note, one per beat.',
          explain_es: 'Una barra — la línea que une dos plicas — parte a la mitad el valor de la nota, así que un par unido por barra son corcheas: dos por tiempo. Una plica sin barra es una negra, una por tiempo.' } },
      { id: 'm7w1-s3', text: 'Recognize hammer-on (h), pull-off (p), and slide (/ or \\) markings',
        ...
        practice: { type: 'mc', prompt: 'In TAB, "5h7" tells you to:',
          ...
          choices: ['Pick fret 5, then sound fret 7 without picking again', 'Pick fret 5 and fret 7 separately, one after the other', 'Hold fret 5 for seven beats', 'Slide from fret 5 up to fret 7'],
          choices_es: ['Pulses el traste 5 y luego suenes el traste 7 sin volver a pulsar', 'Pulses el traste 5 y el traste 7 por separado, uno tras otro', 'Sostengas el traste 5 durante siete tiempos', 'Deslices del traste 5 hasta el traste 7'], answer: 0,
          explain: 'The "h" is a hammer-on: pick the first note only, then bring a finger down hard on the higher fret so the second note sounds on its own. Picking the two notes separately gives you both notes but loses the smooth join, and "5/7" — a slide — is the marking that moves your finger along the string instead.',
          explain_es: 'La "h" es un hammer-on: pulsa solo la primera nota y luego deja caer con fuerza un dedo en el traste más alto para que la segunda nota suene sola. Pulsar las dos notas por separado te da las dos notas pero pierde la unión suave, y "5/7" — un slide — es la marca que en cambio desliza el dedo por la cuerda.' } },
      { id: 'm7w1-s4', text: 'Play the "Smoke on the Water" main riff in time',
        ...
        gotItWhen: 'you can play the full riff at 70 BPM with both notes ringing together cleanly — no buzzing, no missed double-stops. (This is a straight-quarter-note teaching count — the record\'s actual rhythm has stronger accents and more space than that.)',
        gotItWhen_es: 'puedes tocar el riff completo a 70 BPM con ambas notas sonando limpias juntas — sin zumbido, sin dobles notas falladas. (Este es un conteo de enseñanza en negras parejas — el ritmo real de la grabación tiene acentos más marcados y más espacio que eso.)',
      ...
      { id: 'm7w1-s5', text: 'Play a double-stop riff from TAB',
        ...
        gotItWhen_es: 'puedes leer a primera vista un riff de principiante hecho de dobles cuerdas de 2 notas y tocarlo limpio la primera vez, a media velocidad.',
        practice: { type: 'mc', prompt: 'You strum a double-stop but only ONE of the two strings sounds. Most likely cause?',
          ...
          choices: ['Your pick stroke is too small to cross both strings', 'A double-stop is meant to sound one string at a time', 'You need to press both frets twice as hard', 'The pick is too thin to move two strings at once'],
          choices_es: ['Tu golpe de púa es muy pequeño para cruzar las dos cuerdas', 'Una doble nota debe sonar una cuerda a la vez', 'Necesitas presionar los dos trastes el doble de fuerte', 'La púa es muy delgada para mover dos cuerdas a la vez'], answer: 0,
          explain: 'A double-stop needs one stroke that travels through both strings, so widen the motion a little. The name says what it is: two notes sounded together — playing them one at a time is a different thing. Pick thickness is not the problem either; a thin pick crosses two strings fine if the stroke is big enough.',
          explain_es: 'Una doble nota necesita un solo golpe que atraviese las dos cuerdas, así que amplía un poco el movimiento. El nombre dice lo que es: dos notas sonando juntas — tocarlas una a la vez es otra cosa. El grosor de la púa tampoco es el problema; una púa delgada cruza dos cuerdas sin dificultad si el golpe es lo bastante amplio.' } },
      { id: 'm7w1-s6', text: 'Find a TAB online for a new song and play through it',
        ...
        practice: { type: 'mc', prompt: 'You find three different TABs of the same song online. How do you decide which one to trust?',
          ...
          choices: ['Play the first riff of each against the record', 'Trust the one with the highest star rating', 'The longest, most detailed one', 'The first search result'],
          choices_es: ['Toca el primer riff de cada uno contra la grabación', 'Confía en el que tenga la calificación más alta', 'El más largo y detallado', 'El primer resultado de búsqueda'], answer: 0,
          explain: 'Ratings and search rank are a reasonable first filter, but fan TABs are often wrong and a popular one can be wrong too — your ear against the recording is the real referee. Length is no help either: a long TAB is just a long guess if nobody checked it.',
          explain_es: 'Las calificaciones y el orden de búsqueda sirven como primer filtro, pero los TABs de fans suelen estar mal y uno popular también puede estarlo — tu oído contra la grabación es el árbitro de verdad. La extensión tampoco ayuda: un TAB largo es solo una suposición larga si nadie lo revisó.' } }
    ]
  },
      ...
      b: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            hint: 'The F barre — one finger pressed flat across several strings — is famously hard. It\'s the lowest barre, where the strings are tightest, so it\'s the toughest spot — G and A higher up are easier. Watch what her fretting hand does behind the neck, not just in front of it, and copy the whole shape.',
            hint_es: 'La cejilla de F — un dedo presionado plano sobre varias cuerdas — es famosa por ser difícil. Es la cejilla más baja, donde las cuerdas están más tensas, así que es el punto más duro — G y A más arriba son más fáciles. Fíjate en lo que hace su mano de trastear detrás del mástil, no solo delante, y copia la forma completa.',
            skills: [1, 2],
            response: { type: 'mc', prompt: 'Your barre buzzes no matter how hard you squeeze, and your thumb is wrapped over the top of the neck. What should you change first?',
              prompt_es: 'Tu cejilla zumba por más que aprietes, y tu pulgar está envuelto por encima del mástil. ¿Qué deberías cambiar primero?',
              answer: 0,
              explain: 'A barre works like a clamp: the thumb pushes from behind while the index finger presses the strings down at the front, and the pressure comes from those two working against each other. With the thumb over the top there is nothing to squeeze against, so extra effort only tires the hand. Moving the bar nearer the fret and changing which part of the finger you use are both real cures for a buzzing barre, but neither one gives you the leverage back.',
              explain_es: 'Una cejilla funciona como una prensa: el pulgar empuja desde atrás mientras el índice presiona las cuerdas por delante, y la presión sale de esos dos trabajando uno contra el otro. Con el pulgar por encima no hay nada contra qué apretar, así que el esfuerzo extra solo cansa la mano. Acercar la cejilla al traste y cambiar qué parte del dedo usas son dos remedios reales para una cejilla que zumba, pero ninguno te devuelve la palanca.',
              choices: [
              'Move the thumb behind the neck so it can squeeze against the bar',
              'Squeeze harder with the whole hand and keep the same grip',
              'Move the bar closer to the middle of the fret',
              'Press with the flat front pad of the index finger'
            ],
              choices_es: [
              'Mover el pulgar detrás del mástil para que apriete contra la cejilla',
              'Apretar más fuerte con toda la mano y mantener el mismo agarre',
              'Acercar la cejilla al centro del traste',
              'Presionar con la almohadilla plana del dedo índice'
            ] }
          },
          {
            label: 'Watch: the E-shape barre', label_es: 'Mira: la cejilla en forma de E',
            text: 'Watch: <a href="https://youtu.be/MpMhueVEz2g?t=30" target="_blank">Basic Barre Chords #1 — the E shape (CH-006) – JustinGuitar</a> (0:30–4:00). While you watch: watch how his index finger becomes the nut for the sliding shape. You\'ve got it when: you can say what your index finger does in place of the nut.',
            text_es: 'Mira: <a href="https://youtu.be/MpMhueVEz2g?t=30" target="_blank">Basic Barre Chords #1 — the E shape (CH-006) – JustinGuitar</a> (0:30–4:00). Mientras miras: mira cómo su dedo índice se convierte en la cejuela para la forma que se desliza. Lo tienes cuando: puedes decir qué hace tu dedo índice en lugar de la cejuela.',
        ...
        sections: [
          {
            ...
            steps: [
          {
            label: 'Challenge 1 — Just the Bar', label_es: 'Reto 1 — Solo la cejilla',
            text: '<ol><li>Lay your index finger flat across all 6 strings at the 5th fret — bar only, no other fingers.</li><li>Strum.</li></ol>You\'ve got it when: all 6 strings ring, rolling the index slightly onto its bonier edge.',
            text_es: '<ol><li>Coloca tu dedo índice plano sobre las 6 cuerdas en el traste 5 — solo la cejilla, sin otros dedos.</li><li>Rasguea.</li></ol>Lo tienes cuando: las 6 cuerdas suenan, rodando el índice ligeramente hacia su borde más óseo.',
            ...
            stuck: 'Line the bar up right behind the fret. If the B string buzzes, it\'s usually sitting in a knuckle crease — shift the finger slightly up or down. Get just the top 3 strings ringing first, then add the rest.',
            stuck_es: 'Alinea la cejilla justo detrás del traste. Si la cuerda Si zumba, suele estar cayendo en un pliegue del nudillo — mueve el dedo un poquito hacia arriba o hacia abajo. Logra que suenen solo las 3 cuerdas más agudas primero, y luego agrega el resto.',
            ...
            steps: [
          {
            ...
            text: '<ol><li>Add the E-shape on top of the bar at the 5th fret for A major (ring finger on the A string, fret 7 · pinky on the D string, fret 7 · middle finger on the G string, fret 6).</li><li>Strum all 6.</li></ol>You\'ve got it when: a full, clean A major barre — get it clean here before you try F.<span class="step-figure"><img src="img/m7-barre-hand-front.jpg" alt="Pencil sketch of a fretting hand seen from the front: the index finger lies flat across all six strings to form the bar, while the middle, ring and pinky fingers press the E shape on the frets above it." width="700" height="700"></span>',
            text_es: '<ol><li>Agrega la forma de E encima de la cejilla en el traste 5 para A mayor (dedo anular en la cuerda La, traste 7 · meñique en la cuerda Re, traste 7 · dedo medio en la cuerda Sol, traste 6).</li><li>Rasguea las 6 cuerdas.</li></ol>Lo tienes cuando: una cejilla de A mayor completa y limpia — lógrala limpia aquí antes de intentar F.<span class="step-figure"><img src="img/m7-barre-hand-front.jpg" alt="Dibujo a lápiz de una mano trasteando vista de frente: el dedo índice está plano sobre las seis cuerdas formando la cejilla, mientras los dedos medio, anular y meñique pisan la forma de E en los trastes de arriba." width="700" height="700"></span>',
            ...
            steps: [
          {
            ...
            text: '<ol><li>Form your F major barre (the one you\'re about to build in the next challenge) — it has the F5 power chord you learned in Module 3 hiding inside it.</li><li>Look at just the low E and A strings — low E (fret 1) + A (fret 3). That\'s F5. The barre just stacks the rest of the chord on top.</li></ol>You\'ve got it when: play F5 alone, then add the barre fingers to make full F — and hear the power chord living inside it.',
            text_es: '<ol><li>Forma tu cejilla de F mayor (la que estás por construir en el siguiente reto) — tiene escondido dentro el acorde de potencia F5 que aprendiste en el Módulo 3.</li><li>Mira solo las cuerdas Mi grave y La — Mi grave (traste 1) + La (traste 3). Eso es F5. La cejilla solo apila el resto del acorde encima.</li></ol>Lo tienes cuando: toca F5 solo, y luego agrega los dedos de la cejilla para formar el F completo — y escucha el acorde de potencia viviendo dentro de él.',
            hint: 'A barre is a power chord plus a few more notes. Name it by its root on the low E string.',
            hint_es: 'Una cejilla es un acorde de potencia más algunas notas. Nómbrala por su raíz en la cuerda Mi grave.',
          ...
          },
          {
            ...
            steps: [
          {
            label: 'Challenge 3 — F, G, A Slide (assessment preparation)', label_es: 'Reto 3 — Deslizamiento F, G, A (preparación para la evaluación)',
            text: 'Slide the same shape through three chords:<ul><li>Fret 1 (F).</li><li>Fret 3 (G).</li><li>Fret 5 (A).</li></ul>You\'ve got it when: G and A ringing clean, then F — the hardest — without buzzing.',
            ...
            steps: [
              {
                ...
                text: 'Play the verse\'s D · C · G with your E-shape barre — it\'s ONE shape sliding. One clean strum per chord, then two bars each at 60 BPM:<ul><li>D at fret 10.</li><li>C at fret 8.</li><li>G at fret 3.</li></ul>You\'ve got it when: all three ring clean — and the high frets prove the point: barres get EASIER up the neck. <a href="tabs/sweet-child-o-mine.html" target="_blank">&#x1F9F5; Song Journey: this is the Module 7 finale</a>.',
    ...
    skills: [
      { id: 'm7w2-s1', text: 'Bar all 6 strings cleanly with my index finger',
        ...
        practice: { type: 'mc', prompt: 'Which side of your index finger is best for a clean barre?',
          ...
          choices: ['The fleshy front pad, laid perfectly flat', 'The bony outer edge, rolled slightly', 'The very tip, standing the finger up on end', 'The soft middle joint, right over the crease'],
          choices_es: ['La almohadilla carnosa de enfrente, bien plana', 'El borde óseo exterior, ligeramente rodado', 'La punta del dedo, apoyándolo derecho sobre ella', 'La articulación blanda del medio, justo sobre el pliegue'], answer: 1,
          explain: 'Roll the finger slightly onto its bony outer edge — that side is hard and flat, so it presses all six strings evenly. The soft front pad has creases at the joints and strings sink into them and buzz, and the middle joint is the deepest crease of all. Standing the finger on its tip leaves you almost no width to cover six strings with.',
          explain_es: 'Rueda el dedo un poco hacia su borde óseo exterior — ese lado es duro y plano, así que presiona las seis cuerdas de forma pareja. La almohadilla blanda de enfrente tiene pliegues en las articulaciones y las cuerdas se hunden ahí y zumban, y la articulación del medio es el pliegue más profundo de todos. Apoyar el dedo sobre la punta te deja casi sin ancho para cubrir seis cuerdas.' } },
      { id: 'm7w2-s2', text: 'Position my thumb correctly behind the neck for barre chords',
        ...
        practice: { type: 'mc', prompt: 'Why does the thumb\'s position matter so much on a barre chord?',
          prompt_es: '¿Por qué importa tanto la posición del pulgar en un acorde con cejilla?',
          choices: ['It stops the low E string from ringing', 'It gives the index finger something to push against', 'It keeps the wrist from bending too far', 'It holds the guitar steady while your other hand strums'],
          choices_es: ['Evita que la cuerda Mi grave suene', 'Le da al dedo índice algo contra qué empujar', 'Evita que la muñeca se doble demasiado', 'Sostiene la guitarra mientras la otra mano rasguea'], answer: 1,
          explain: 'A barre is a clamp. The thumb pushes from behind and the index finger presses from the front, and the two work against each other — that is where the pressure comes from, not from arm strength. Muting the low E string is the index finger\'s job on an A-shape barre, and the guitar should already be steady without help from the fretting hand.',
          explain_es: 'Una cejilla es una prensa. El pulgar empuja desde atrás y el índice presiona desde el frente, y los dos trabajan uno contra el otro — de ahí sale la presión, no de la fuerza del brazo. Silenciar la cuerda Mi grave es trabajo del índice en la cejilla en forma de A, y la guitarra ya debería estar estable sin ayuda de la mano que trastea.' } },
...

  {
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            hint: 'The A-shape is named by the root note on the A string. Use the A-string notes from Module 2: fret 3 of A = C, fret 5 of A = D, fret 7 of A = E.',
            hint_es: 'La forma de A se nombra por la nota raíz en la cuerda La. Usa las notas de la cuerda La del Módulo 2: traste 3 de La = C, traste 5 de La = D, traste 7 de La = E.',
            ...
            chords: [
              ...
              { name: 'D', chord: [[6,'x'],[5,5,'1'],[4,7,'2'],[3,7,'3'],[2,7,'4'],[1,5,'1']], position: 5 },
              { name: 'E', chord: [[6,'x'],[5,7,'1'],[4,9,'2'],[3,9,'3'],[2,9,'4'],[1,7,'1']], position: 7 }
            ]
          }
            ]
          },
            ...
            steps: [
          {
            ...
            text: 'Play F in two places on the neck — same note name, different position:<ol><li>Play F as an E-shape barre (index on the low E string, fret 1).</li><li>Play the SAME chord as an A-shape barre (index on the A string, fret 8).</li><li>Pluck both and listen — same chord, slightly different colour.</li></ol>You\'ve got it when: find and play both Fs, and say WHY they are both F (read the root: low E + 1 fret = F; A string + 8 frets = F).',
            text_es: 'Toca F en dos lugares del mástil — mismo nombre de nota, posición distinta:<ol><li>Toca F como cejilla en forma de E (índice en la cuerda Mi grave, traste 1).</li><li>Toca el MISMO acorde como cejilla en forma de A (índice en la cuerda La, traste 8).</li><li>Puntea ambos y escucha — mismo acorde, un color ligeramente distinto.</li></ol>Lo tienes cuando: encuentras y tocas ambos F, y dices POR QUÉ los dos son F (lee la raíz: Mi grave + traste 1 = F; cuerda La + traste 8 = F).',
            hint: 'The root note names the chord. Find F on the low E or the A string, and build the barre there.',
            hint_es: 'La nota raíz nombra el acorde. Encuentra F en la cuerda Mi grave o en la cuerda La, y construye la cejilla ahí.',
            ...
            steps: [
          {
            ...
            text: '<ul><li>Take a barre progression (F–C–G–D, or Am–G–F as barres) and play it with the D-DU-UDU pattern from Module 6 instead of one strum per bar.</li></ul>You\'ve got it when: the strum pattern stays steady and even while you switch barre shapes — the groove (the steady rhythmic feel) doesn\'t break at the chord change.',
            text_es: '<ul><li>Toma una progresión con cejillas (F–C–G–D, o Am–G–F como cejillas) y tócala con el patrón D-DU-UDU del Módulo 6 en lugar de un rasgueo por compás.</li></ul>Lo tienes cuando: el patrón de rasgueo se mantiene estable y parejo mientras cambias de forma de cejilla — el groove (la sensación rítmica constante) no se rompe en el cambio de acorde.',
            ...
            steps: [
              {
                ...
                text: 'Graduate the verse\'s small Bm to a full barre today:<ol><li>Index bars fret 2 (from the A string down).</li><li>Play Bm · A one bar each with your D-DU-UDU strum at 60 BPM.</li></ol>You\'ve got it when: four laps where the full Bm rings as clean as the A — the song\'s last beginner shortcut is gone.',
                text_es: 'Gradúa hoy el Bm pequeño de la estrofa a cejilla completa:<ol><li>El índice hace cejilla en el traste 2 (desde la cuerda La hacia abajo).</li><li>Toca Bm · A un compás cada uno con tu rasgueo D-DU-UDU a 60 BPM.</li></ol>Lo tienes cuando: cuatro vueltas donde el Bm completo suena tan limpio como el A — el último atajo de principiante de la canción se acabó.',
              ...
              },
              {
                ...
                text: 'Graduate the little F (xx3211) to a full barre today:<ol><li>Index bars fret 1 across all six strings — the toughest fret on the neck to barre.</li><li>Play F ↔ Am with two downbeat strums per bar at 60 BPM.</li></ol>You\'ve got it when: four laps where all six strings of the F ring as clean as the Am — "Luna"\'s last beginner shortcut is gone. <a href="tabs/luna.html" target="_blank">&#x1F9F5; Song Journey: beyond Layer 5 — the barre upgrade</a>.',
                text_es: 'Gradúa hoy el F pequeño (xx3211) a cejilla completa:<ol><li>El índice hace cejilla en el traste 1 a lo largo de las seis cuerdas — el traste más difícil del mástil para hacer cejilla.</li><li>Toca F ↔ Am con dos rasgueos en el tiempo fuerte por compás a 60 BPM.</li></ol>Lo tienes cuando: cuatro vueltas donde las seis cuerdas del F suenan tan limpias como el Am — el último atajo de principiante de "Luna" se acabó. <a href="tabs/luna.html" target="_blank">&#x1F9F5; Recorrido de la canción: más allá de la Capa 5 — la mejora de la cejilla</a>.',
                ...
                levelUp: 'Slide the same barre shape to fret 5 — that\'s A major, and that gives you every major chord on the neck.',
                levelUp_es: 'Desliza la misma forma de cejilla al traste 5 — eso es A mayor, y eso te da todos los acordes mayores del mástil.',
                skills: [6],
                chords: [
            ...
            steps: [
          {
            ...
            text: 'Learn the most famous riff in the course:<ol><li>Watch <a href="https://www.youtube.com/watch?v=EBNlYH4P5r8" target="_blank">Sweet Child O\' Mine Intro in Standard Tuning – Jbf Music &amp; Guitar</a> (played slow and full speed, with the TAB on screen).</li><li>Learn just the first bar.</li><li>Play it slowly.</li></ol>Optional. No score. Practice a little each day.',
            text_es: 'Aprende el riff más famoso del curso:<ol><li>Mira <a href="https://www.youtube.com/watch?v=EBNlYH4P5r8" target="_blank">Sweet Child O\' Mine Intro in Standard Tuning – Jbf Music &amp; Guitar</a> (tocado lento y a velocidad completa, con el TAB en pantalla).</li><li>Aprende solo el primer compás.</li><li>Tócalo despacio.</li></ol>Opcional. Sin puntaje. Practica un poco cada día.',
            ...
            steps: [
              {
                ...
                hint: 'You\'ve slid both barre shapes all over the neck — these two are the lowest, and the last two shapes left in this module. The same two shapes you already know, low on the neck where the strings are hardest to press. F#: the E-shape bar on fret 2 — two frets above the open E chord. Bb: the A-shape bar on fret 1 — the index bars from the A string down with its tip leaning over the low E string just enough to deaden it, and your middle, ring and pinky take the D, G, and B strings at fret 3 (one finger per string, the same way you built B, C and D) — one fret above the open A chord. Read the roots: the low E string fret 2 = F#, the A string fret 1 = Bb. Tap ▶ to hear each chord.',
                hint_es: 'Has deslizado ambas formas de cejilla por todo el mástil — estas dos son las más bajas, y las últimas dos formas que quedan en este módulo. Las mismas dos formas que ya conoces, abajo en el mástil donde las cuerdas son más difíciles de presionar. F#: la cejilla en forma de E en el traste 2 — dos trastes arriba del acorde abierto de E. Bb: la cejilla en forma de A en el traste 1 — el índice hace la cejilla desde la cuerda La hacia abajo con su punta recargada sobre la cuerda Mi grave lo justo para apagarla, y tu medio, tu anular y tu meñique toman las cuerdas Re, Sol y Si en el traste 3 (un dedo por cuerda, igual que como armaste B, C y D) — un traste arriba del acorde abierto de A. Lee las raíces: la cuerda Mi grave traste 2 = F#, la cuerda La traste 1 = Bb. Toca ▶ para escuchar cada acorde.',
    ...
    skills: [
      ...
      { id: 'm7w3-s6', text: 'Play a full song using only barre chords (no open chords)',
        ...
        gotItWhen: 'you can play "All Along the Watchtower" or another simple song from start to finish using ONLY barre chords.',
        gotItWhen_es: 'puedes tocar "All Along the Watchtower" u otra canción sencilla de principio a fin usando SOLO acordes con cejilla.',
...
MODULE_SONGS[7] = [
      { name: '"Smoke on the Water" — Deep Purple', meta: 'Iconic 2-note TAB riff · low E + A strings', meta_es: 'Riff icónico de TAB de 2 notas · cuerdas Mi grave + La', type: 'Focus', core: true,
        ...
        tutorialUrl: 'https://www.youtube.com/watch?v=tCQ0r7vqkFQ&start=58&end=265' },
      { name: '"Crazy Train" — Ozzy Osbourne', meta: 'Fast intro riff · alternate picking practice', meta_es: 'Riff de intro rápido · práctica de púa alternada', type: 'Focus', core: true,
        ...
        tutorialUrl: 'https://www.youtube.com/watch?v=61YCfNHZuHE&start=58&end=377' },
      ...
      { name: '"Hey Jude" — The Beatles', meta: 'F major in the chorus · uses the E-shape F barre', meta_es: 'F mayor en el coro · usa la cejilla de F en forma de E', type: 'Focus', core: true,
        originalUrl: 'https://www.youtube.com/watch?v=A_MjCqQoLLA',
        tutorialUrl: 'https://www.youtube.com/watch?v=VyleoeWxbIQ&start=80&end=203' },
...
MODULE_REVIEWS[7] = {
  ...
  forward: 'Module 8 shifts the focus to your <strong>picking hand</strong> — fingerpicking. You hold the chords you know and pluck one string at a time.',
  forward_es: 'El Módulo 8 cambia el enfoque a tu <strong>mano de pulsar</strong> — el fingerpicking. Sostienes los acordes que ya conoces y punteas una cuerda a la vez.',
