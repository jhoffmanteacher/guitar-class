            ...
            steps: [
              {
                ...
                text: '<ol><li>Play this 2-bar lick (a short solo phrase) on the G string.</li><li>Pick ONLY where the TAB shows a plain fret number.</li><li>Everywhere you see an h, p, or /, make the note with your fretting hand alone — no new pick (these are slurs: notes joined smoothly without picking each one).</li></ol>You\'ve got it when: the hammered, pulled, and slid notes ring out just as loud as the ones you actually pick.',
                text_es: '<ol><li>Toca este lick de 2 compases (una frase corta de solo) en la cuerda Sol.</li><li>Pulsa SOLO donde el TAB muestre un número de traste normal.</li><li>En todos los lugares donde veas una h, una p, o una /, haz la nota solo con tu mano de trastear — sin pulsar de nuevo (estas son ligaduras: notas unidas suavemente sin pulsar cada una).</li></ol>Lo tienes cuando: las notas de hammer-on, pull-off y deslizamiento suenan tan fuerte como las que sí pulsas.',
