            ...
            steps: [
              {
                ...
                text: '<ol><li>Play this 2-bar lick (a short solo phrase) on the G string.</li><li>Pick ONLY where the TAB shows a plain fret number — everywhere you see an h, p, or / , your fretting hand makes the note with no new pick (these are slurs: notes joined smoothly without picking each one).</li></ol>You\'ve got it when: the hammered, pulled, and slid notes ring out just as loud as the ones you actually pick.',
                text_es: '<ol><li>Toca este lick de 2 compases (una frase corta de solo) en la cuerda Sol.</li><li>Pulsa SOLO donde el TAB muestre un número de traste normal — en todos los lugares donde veas una h, una p, o una /, tu mano de trastear hace la nota sin pulsar de nuevo (estas son ligaduras: notas unidas suavemente sin pulsar cada una).</li></ol>Lo tienes cuando: las notas de hammer-on, pull-off y deslizamiento suenan tan fuerte como las que sí pulsas.',
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Add the E-shape on top of the bar at the 5th fret for A major:<ol><li>Ring finger on string 5, fret 7.</li><li>Pinky on string 4, fret 7.</li><li>Middle finger on string 3, fret 6.</li><li>Strum all 6.</li></ol>You\'ve got it when: a full, clean A major barre — master it here before tackling F.<span class="step-figure"><img src="img/m7-barre-hand-front.jpg" alt="Pencil sketch of a fretting hand seen from the front: the index finger lies flat across all six strings to form the bar, while the middle, ring and pinky fingers press the E shape on the frets above it."></span>',
            text_es: 'Agrega la forma de E encima de la cejilla en el traste 5 para A mayor:<ol><li>Dedo anular en la cuerda 5, traste 7.</li><li>Meñique en la cuerda 4, traste 7.</li><li>Dedo medio en la cuerda 3, traste 6.</li><li>Rasguea las 6 cuerdas.</li></ol>Lo tienes cuando: una cejilla de A mayor completa y limpia — domínala aquí antes de atacar F.<span class="step-figure"><img src="img/m7-barre-hand-front.jpg" alt="Dibujo a lápiz de una mano trasteando vista de frente: el dedo índice está plano sobre las seis cuerdas formando la cejilla, mientras los dedos medio, anular y meñique pisan la forma de E en los trastes de arriba."></span>',
            ...
            steps: [
          {
            ...
            text: '<ol><li>Form your F major barre.</li><li>Look at just strings 6 and 5 — low E (fret 1) + A (fret 3).</li></ol>That is exactly the F5 power chord you learned in Module 3. The barre just stacks the rest of the chord on top. You\'ve got it when: play F5 alone, then add the barre fingers to make full F — and hear the power chord living inside it.',
            text_es: '<ol><li>Forma tu cejilla de F mayor.</li><li>Mira solo las cuerdas 6 y 5 — Mi grave (traste 1) + La (traste 3).</li></ol>Eso es exactamente el acorde de potencia F5 que aprendiste en el Módulo 3. La cejilla solo apila el resto del acorde encima. Lo tienes cuando: toca F5 solo, y luego agrega los dedos de la cejilla para formar el F completo — y escucha el acorde de potencia viviendo dentro de él.',
            ...
            steps: [
          {
            ...
            text: 'Slide the same shape through three chords:<ul><li>Fret 1 (F).</li><li>Fret 3 (G).</li><li>Fret 5 (A).</li></ul>Same shape, three chords. You\'ve got it when: G and A ringing clean, then F — the hardest — without buzzing.',
            text_es: 'Desliza la misma forma por tres acordes:<ul><li>Traste 1 (F).</li><li>Traste 3 (G).</li><li>Traste 5 (A).</li></ul>Misma forma, tres acordes. Lo tienes cuando: G y A suenan limpio, y luego F — el más difícil — sin zumbido.',
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: '<ol><li>Index bars all 6 strings at fret 2.</li><li>Middle finger on string 4, ring finger on string 3, pinky on string 2 — all at fret 4, one finger per string.</li><li>Arch those three so they stay off string 1.</li><li>Strum strings 5–1 (let the index mute string 6).</li></ol>You\'ve got it when: a clean B major with the string-5 bass ringing, the high e ringing too, and no low E.',
            text_es: '<ol><li>El índice hace cejilla en las 6 cuerdas en el traste 2.</li><li>El dedo medio en la cuerda 4, el anular en la cuerda 3 y el meñique en la cuerda 2 — todos en el traste 4, un dedo por cuerda.</li><li>Arquea esos tres dedos para que no toquen la cuerda 1.</li><li>Rasguea las cuerdas 5–1 (deja que el índice silencie la cuerda 6).</li></ol>Lo tienes cuando: un B mayor limpio con el bajo de la cuerda 5 sonando, la mi aguda sonando también, y sin Mi grave.',
