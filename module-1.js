        ...
        sections: [
          ...
          },
          {
            ...
            response: { type: 'mc', prompt: 'Which of these does the video call out as a real danger to an acoustic guitar?',
              ...
              answer: 0,
              explain: 'Wood shrinks and can crack when the air gets too dry — that\'s why guitars are stored in cases and kept away from heaters. Lots of practice, picks, and standing up are all totally safe.',
              explain_es: 'La madera se encoge y se puede agrietar cuando el aire se pone muy seco — por eso las guitarras se guardan en estuches y lejos de calefactores. Practicar mucho, usar púa y tocar de pie son totalmente seguros.',
              choices: [
      ...
      b: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            hint: 'You\'ll play the whole riff at the practice station — this is just the preview. Heads up: this site teaches it as straight, even quarter notes — one per beat — to make it easy to count while you\'re learning it; the actual record swings it a bit looser than that, which you\'ll start to hear naturally once the shape feels solid. Listen first, then match it — one note at a time. To fret a note, set your fingertip just behind the fret and press firm; if it buzzes, move a little closer to the fret or press harder.',
            hint_es: 'Vas a tocar el riff completo en la estación de práctica — esto es solo el adelanto. Aviso: aquí se enseña con negras rectas y parejas — una nota por pulso — para que sea fácil de contar mientras lo aprendes; la grabación original lo toca con un poco más de swing (vaivén) que eso, algo que empezarás a notar de oído en cuanto domines bien la forma. Escucha primero y luego iguálalo — una nota a la vez. Para trastear una nota, coloca la punta del dedo justo detrás del traste y presiona firme; si zumba, acércate un poco más al traste o presiona más fuerte.',
    ...
    skills: [
      { id: 'w2-s1', text: 'Name 5+ parts of the guitar (body, neck, headstock, frets, strings, tuning pegs, nut, saddle, bridge)',
        ...
        practice: { type: 'mc', prompt: 'Which of these is NOT a part of the guitar?',
          ...
          explain: 'A hinge belongs on a door, not a guitar. The nut and saddle are the two small strips the strings rest on — the nut up at the headstock end, the saddle down on the bridge.',
          explain_es: 'Una bisagra va en una puerta, no en una guitarra. La cejuela y la selleta son las dos tiras pequeñas donde se apoyan las cuerdas — la cejuela arriba junto al clavijero, la selleta abajo en el puente.' } },
      ...
      { id: 'w2-s3', text: 'Hold the pick correctly — 3–4mm of tip showing',
        ...
        practice: { type: 'mc', prompt: 'How much pick tip should show past your thumb?',
          prompt_es: '¿Cuánta punta de la púa debe asomar más allá del pulgar?',
          choices: ['Just 1 mm', '3–4 mm', 'About a centimeter', 'The whole pick, gripped at the edge'],
          choices_es: ['Solo 1 mm', '3–4 mm', 'Cerca de un centímetro', 'La púa completa, agarrada por el borde'], answer: 1,
          explain: 'About 3–4 mm is enough tip to move the string cleanly without so much sticking out that it catches and drags. With only 1 mm showing the pick tends to twist and slip out of your fingers mid-strum.',
          explain_es: 'Unos 3–4 mm son punta suficiente para mover la cuerda con limpieza sin que asome tanta que se atore y se arrastre. Con solo 1 mm asomando, la púa tiende a girarse y resbalarse de los dedos a mitad del rasgueo.' } },
