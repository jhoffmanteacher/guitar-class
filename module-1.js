      ...
      b: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Watch: <a href="https://www.youtube.com/watch?v=bTvmDGDuUZ4&t=32" target="_blank">How to Tune a Guitar for Beginners with a Tuner – Lauren Bateman (0:32–4:30)</a> (this site also has a built-in tuner in the corner toolbar):<ol><li>Have your tuner ready.</li><li>Follow along on your own guitar, matching one string at a time as she goes.</li></ol>You\'ve got it when: you can tell whether a note is too high or too low before the tuner shows you.',
            text_es: 'Mira: <a href="https://www.youtube.com/watch?v=bTvmDGDuUZ4&t=32" target="_blank">How to Tune a Guitar for Beginners with a Tuner – Lauren Bateman (0:32–4:30)</a> (este sitio también tiene un afinador integrado en la barra de la esquina):<ol><li>Ten tu afinador listo.</li><li>Sigue el video en tu propia guitarra, afinando una cuerda a la vez a medida que ella avanza.</li></ol>Lo tienes cuando: puedes saber si una nota está muy alta o muy baja antes de que el afinador te lo muestre.',
      ...
      c: {
        ...
        sections: [
          ...
          },
          {
            ...
            text: 'Your first real song — the opening phrase, all on one string:<ol><li>Play the FIRST phrase of "Happy Birthday" on the low E string — "Hap-py birth-day to you" — frets 0 · 0 · 2 · 0 · 5 · 4.</li><li>Press ▶ to hear it, then match it one note at a time.</li><li>Practice with the Metronome (floating corner button) set to 60 BPM — beats per minute, one click a second — to keep steady.</li></ol>You\'ve got it when: those six notes start to finish, clean and on the beat. The rest of the melody climbs past fret 10, so you\'ll play the whole thing in Module 2.',
            text_es: 'Tu primera canción de verdad — la frase inicial, toda en una sola cuerda:<ol><li>Toca la PRIMERA frase de "Happy Birthday" en la cuerda Mi grave — "Hap-py birth-day to you" — trastes 0 · 0 · 2 · 0 · 5 · 4.</li><li>Presiona ▶ para escucharla, y luego iguálala una nota a la vez.</li><li>Practica con el Metrónomo (botón flotante de la esquina) puesto en 60 BPM — pulsos por minuto, un clic por segundo — para mantenerte constante.</li></ol>Lo tienes cuando: esas seis notas de principio a fin, limpias y a tiempo. El resto de la melodía sube más allá del traste 10, así que la vas a tocar completa en el Módulo 2.',
