        ...
        sections: [
            ...
            steps: [
          {
            ...
            response: { type: 'mc', prompt: 'On a chord diagram, an X above a string means:',
              ...
              explain_es: 'Una X significa que no toques esa cuerda para nada — sáltatela o silénciala para que quede en silencio. Una O (no X) significa tocarla al aire.',
              choices: [
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Challenge 1 — Clean Am:<ol><li>Fret Am (index finger on string 2, fret 1 · middle finger on string 4, fret 2 · ring finger on string 3, fret 2).</li><li>Strum strings 1–5 (not the low E).</li></ol>You\'ve got it when: every string rings cleanly — check each one by plucking it.',
            text_es: 'Reto 1 — Am limpio:<ol><li>Trastea Am (dedo índice en la cuerda 2, traste 1 · dedo medio en la cuerda 4, traste 2 · dedo anular en la cuerda 3, traste 2).</li><li>Rasguea las cuerdas 1–5 (no la Mi grave).</li></ol>Lo tienes cuando: cada cuerda suena limpia — revisa cada una pulsándola.',
            ...
            steps: [
          {
            ...
            text: 'Challenge 2 — Clean Em:<ol><li>Fret Em (middle finger on string 5, fret 2 · ring finger on string 4, fret 2).</li><li>Strum all 6 strings.</li></ol>You\'ve got it when: a full, open, buzz-free Em — this is your warm-up chord.',
            text_es: 'Reto 2 — Em limpio:<ol><li>Trastea Em (dedo medio en la cuerda 5, traste 2 · dedo anular en la cuerda 4, traste 2).</li><li>Rasguea las 6 cuerdas.</li></ol>Lo tienes cuando: un Em completo, abierto, sin zumbido — este es tu acorde de calentamiento.',
            ...
            steps: [
          {
            ...
            text: 'Challenge 3 — Am ↔ Em Switch: at 60 BPM, 4 down-strums per bar:<ol><li>Play 2 bars of Am.</li><li>Play 2 bars of Em, and repeat.</li></ol>You\'ve got it when: change chords right on beat 1 every time — keep strumming through any fumble.',
            text_es: 'Reto 3 — Cambio Am ↔ Em: a 60 BPM, 4 rasgueos hacia abajo por compás:<ol><li>Toca 2 compases de Am.</li><li>Toca 2 compases de Em, y repite.</li></ol>Lo tienes cuando: cambias de acorde justo en el tiempo 1 cada vez — sigue rasgueando aunque falles.',
            ...
            steps: [
              {
                ...
                text: 'Challenge 4 — One-Minute Changes (Am ↔ Em):<ol><li>Set the ⏱ Timer for 60 seconds.</li><li>Switch Am→Em→Am→Em as many times as you can. Every CLEAN change counts; a buzzy or missed one doesn\'t.</li></ol>You\'ve got it when: count your clean changes and type the number below — try for a higher number next time. (Over 20 is a good result for your first day on chords.)',
                text_es: 'Reto 4 — Cambios de un minuto (Am ↔ Em):<ol><li>Pon el ⏱ Temporizador en 60 segundos.</li><li>Cambia Am→Em→Am→Em tantas veces como puedas. Cada cambio LIMPIO cuenta; uno con zumbido o fallado no.</li></ol>Lo tienes cuando: cuentas tus cambios limpios y escribes el número abajo — intenta superarlo la próxima vez. (Más de 20 es un buen resultado para tu primer día con acordes.)',
            ...
            steps: [
              {
                ...
                text: 'Challenge — Mystery Chart: the two diagrams below have NO names. This is exactly the assessment task — naming chords on an unlabelled chart.<ol><li>Look at the FIRST (left) one only — which string is muted, which are open, and where do the fretted fingers sit?</li><li>Read it, then answer which chord it is.</li></ol>',
    ...
    skills: [
      { id: 'm5w1-s1', text: 'Read a chord diagram: identify X (mute), O (open), dots (finger placement), and numbers (which finger)',
        ...
        practice: { type: 'mc', prompt: 'On a chord diagram, what does an "X" above a string mean?',
          ...
          choices: ['Play that string open', 'Mute it — don\'t play that string', 'That\'s where finger 1 goes', 'Play that string twice'],
          choices_es: ['Toca esa cuerda al aire', 'Silénciala — no toques esa cuerda', 'Ahí va el dedo 1', 'Toca esa cuerda dos veces'], answer: 1 } },
...

  {
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Challenge — Name the Root: before you strum each chord, find and say its ROOT — the note the chord is named after, on the lowest string you strum:<ul><li>C = C (A string, 3rd fret).</li><li>G = G (low E, 3rd fret).</li><li>Am = A (A string, open).</li><li>F = F (D string, 3rd fret).</li></ul>You\'ve got it when: name all four roots correctly, then play the chord.',
            text_es: 'Reto — Nombra la raíz: antes de rasguear cada acorde, encuentra y di su RAÍZ — la nota que le da nombre al acorde, en la cuerda más grave que rasgueas:<ul><li>C = C (cuerda La, traste 3).</li><li>G = G (Mi grave, traste 3).</li><li>Am = A (cuerda La, al aire).</li><li>F = F (cuerda Re, traste 3).</li></ul>Lo tienes cuando: nombras correctamente las cuatro raíces, y luego tocas el acorde.',
            ...
            hint_es: 'Saber dónde vive la raíz de un acorde en el mástil es la misma destreza de nombrar notas del Módulo 2 — y es exactamente lo que hace fáciles los acordes con cejilla en el Módulo 7. La raíz te dice el nombre del acorde.',
            ...
            steps: [
          {
            ...
            levelUp_es: 'Encuentra el dedo compartido entre C y G y pivotea con ese también.',
            skills: [4, 6]
          }
            ]
          },
            ...
            steps: [
          {
            ...
            text: 'Challenge 2 — C–G–Am–F Loop: at 60 BPM:<ol><li>Play 2 bars of C.</li><li>Then 2 bars of G.</li><li>Then 2 bars of Am.</li><li>Then 2 bars of F, and repeat.</li></ol>You\'ve got it when: change on beat 1 every time — then speed up in steps — 60 → 65 → 70 — and hold 70 BPM clean (that\'s the assessment tempo).',
            text_es: 'Reto 2 — Vuelta C–G–Am–F: a 60 BPM:<ol><li>Toca 2 compases de C.</li><li>Luego 2 compases de G.</li><li>Luego 2 compases de Am.</li><li>Luego 2 compases de F, y repite.</li></ol>Lo tienes cuando: cambias en el tiempo 1 cada vez — y luego acelera en pasos — 60 → 65 → 70 — y sostén 70 BPM limpio (ese es el tempo de la evaluación).',
            ...
            steps: [
          {
            ...
            text: 'Challenge 3 — Down-Up Strum:<ol><li>Play the loop strumming down on 1 2 3 4 and up on each "+".</li><li>Count "1 + 2 + 3 + 4 +" aloud as you play.</li><li>Build the tempo up to 70 BPM.</li></ol>You\'ve got it when: a steady, relaxed pendulum at 70 BPM with lighter upstrokes and no stumbles.',
            text_es: 'Reto 3 — Rasgueo abajo-arriba:<ol><li>Toca la vuelta rasgueando hacia abajo en 1 2 3 4 y hacia arriba en cada "+".</li><li>Cuenta "1 + 2 + 3 + 4 +" en voz alta mientras tocas.</li><li>Sube el tempo hasta 70 BPM.</li></ol>Lo tienes cuando: un péndulo constante y relajado a 70 BPM con rasgueos hacia arriba más ligeros y sin tropiezos.',
            ...
            steps: [
              {
                ...
                text: 'Challenge 4 — One-Minute Changes (C ↔ G):<ol><li>Set the ⏱ Timer for 60 seconds.</li><li>Switch C→G→C→G as many times as you can — only CLEAN changes count.</li></ol>You\'ve got it when: type your count below and aim for a higher count than your Set 1 number.',
                text_es: 'Reto 4 — Cambios de un minuto (C ↔ G):<ol><li>Pon el ⏱ Temporizador en 60 segundos.</li><li>Cambia C→G→C→G tantas veces como puedas — solo cuentan los cambios LIMPIOS.</li></ol>Lo tienes cuando: escribes tu cuenta abajo y apuntas a superar el número de la Unidad 1.',
            ...
            steps: [
              {
                ...
                text: 'Challenge — Let It Be, verse (assessment rehearsal):<ol><li>Play C · G · Am · F with a down-strum, four beats per chord, building from 60 to 70 BPM — a full bar per chord, patient and unhurried, twice as long as your Module 2 bass roots (which moved every two beats).</li><li>This C–G–Am–F verse is the song you play from memory for the module assessment — record a run and check it against the chart.</li></ol>You\'ve got it when: one full verse loop at 70 BPM, every change landing on beat 1. The record actually moves at your Module 2 pace — two beats per chord — and the Half-Bar Changes ladder later in this set gets you there. <a href="tabs/let-it-be.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 5 of 5 — Open Chords</a>.',
                text_es: 'Reto — Let It Be, estrofa (ensayo de evaluación):<ol><li>Toca C · G · Am · F con un rasgueo hacia abajo, cuatro tiempos por acorde, subiendo de 60 a 70 BPM — un compás completo por acorde, paciente y sin apuro, el doble de duración que tus raíces de bajo del Módulo 2 (que se movían cada dos tiempos).</li><li>Esta estrofa C–G–Am–F es la canción que tocas de memoria para la evaluación del módulo — graba una toma y compárala con el diagrama.</li></ol>Lo tienes cuando: una vuelta completa de la estrofa a 70 BPM, cada cambio cayendo en el tiempo 1. La grabación en realidad se mueve al ritmo de tu Módulo 2 — dos tiempos por acorde — y la escalera de Cambios de Medio Compás más adelante en esta unidad te lleva ahí. <a href="tabs/let-it-be.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 5 de 5 — Acordes al aire</a>.',
              ...
              },
              {
                ...
                text: 'Challenge — "the cure" play-along:<ol><li>Loop Olivia\'s chords with a down-strum — Am · C · Dm · F, two beats each, then G to turn it around.</li><li>Speed up in steps: 60 → 65 → 70 BPM.</li></ol>The backing track\'s metronome reads 144, but it feels half that fast — so 70 BPM here already puts you close to the record\'s real pace. Open chords, no capo. Shapes are pre-loaded below. You\'ve got it when: two clean loops at 70 BPM, every change on beat 1, every string ringing clear.',
                text_es: 'Reto — "the cure" tocando junto:<ol><li>Repite los acordes de Olivia con un rasgueo hacia abajo — Am · C · Dm · F, dos tiempos cada uno, y luego G para dar la vuelta.</li><li>Acelera en pasos: 60 → 65 → 70 BPM.</li></ol>El metrónomo de la pista base marca 144, pero se siente a la mitad de esa velocidad — así que 70 BPM aquí ya te acerca bastante al ritmo real de la grabación. Acordes al aire, sin capo. Las formas están precargadas abajo. Lo tienes cuando: dos vueltas limpias a 70 BPM, cada cambio en el tiempo 1, cada cuerda sonando clara.',
            ...
            steps: [
          {
            ...
            text_es: 'Reto — Cambios de medio compás (2 acordes): hasta ahora has cambiado una vez por compás. Las canciones reales se mueven más rápido. Cambia Am ↔ C cada DOS tiempos, a 60 BPM:<ol><li>Dos rasgueos hacia abajo en Am.</li><li>Dos rasgueos hacia abajo en C, y repite.</li></ol>Eso es el doble de cambios que la vuelta que acabas de tocar. Lo tienes cuando: cuatro vueltas donde cada cambio cae justo en el tiempo 1 y 3, sin detenerte. Presiona &#x25B6; para escuchar el objetivo.',
            ...
            hint_es: 'Am y C comparten un ancla: tu dedo 1 se queda en la cuerda B (traste 1) y tu dedo 2 se queda en la cuerda Re (traste 2). Solo tu dedo 3 salta (a la cuerda La para C). Pivotea con los dos dedos que no se mueven.',
          ...
          },
          {
            ...
            hint_es: 'G → C mantiene tu dedo 2 cerca del mismo lugar; C → Am mantiene el dedo 1 plantado en la cuerda B. Busca el dedo que puede quedarse quieto en cada movimiento.',
            ...
            steps: [
              {
                ...
                text: 'Challenge — The Folk Strum: this is the classic singalong strum the down-up strum skill is really testing.<ol><li>Over one bar, strum down, down-up, up-down-up — written D · D U · U D U.</li><li>Count it out loud "1, 2-and, (3)-and, 4-and" — beat 3 in parentheses is the down you skip: you strum on 1, on 2 and its "and," then catch just the "and" of 3, then 4 and its "and." That skipped beat-3 down is the whole secret of the groove (the steady rhythmic feel).</li><li>Start on one chord (G is a great one).</li></ol>You\'ve got it when: it loops smoothly 4 times in a row on one chord without stopping.',
    ...
    skills: [
      { id: 'm5w2-s1', text: 'Fret C major with clean tone on the B string',
        text_es: 'Trastear C mayor con tono limpio en la cuerda B',
        ...
        gotItWhen_es: 'rasgueas C y la cuerda B (traste 1) suena clara — tu dedo índice no silencia la mi aguda ni zumba contra el traste.',
      ...
      { id: 'm5w2-s6', text: 'Switch between any two chords in Group 1 on beat 1 at 70 BPM',
        ...
        gotItWhen_es: 'eliges dos acordes cualesquiera de C, G, Am, F al azar (mezcla tarjetas caseras o apunta a ciegas al diagrama) y puedes cambiar entre ellos en el tiempo 1 a 70 BPM sin romper el rasgueo.',
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Challenge 1 — Clean D:<ol><li>Fret D major (triangle: string 1, fret 2 · string 2, fret 3 · string 3, fret 2).</li><li>Strum strings 1–4 only.</li></ol>You\'ve got it when: all four ring — especially string 1 (high E), which loves to get muted.',
            text_es: 'Reto 1 — D limpio:<ol><li>Trastea D mayor (triángulo: cuerda 1, traste 2 · cuerda 2, traste 3 · cuerda 3, traste 2).</li><li>Rasguea solo las cuerdas 1–4.</li></ol>Lo tienes cuando: las cuatro suenan — especialmente la cuerda 1 (mi aguda), que ama silenciarse.',
            ...
            steps: [
          {
            ...
            text: 'Challenge 2 — Clean Bm:<ol><li>Fret the partial-barre Bm shape (xx4432 — index on string 1, fret 2 · middle on string 2, fret 3 · ring on string 3, fret 4 · pinky on string 4, fret 4).</li><li>Strum strings 4–1 only.</li></ol>You\'ve got it when: all four fretted strings ring clearly — the pinky on string 4 is the one most likely to go quiet.',
            text_es: 'Reto 2 — Bm limpio:<ol><li>Trastea la forma de cejilla parcial de Bm (xx4432 — índice en la cuerda 1, traste 2 · medio en la cuerda 2, traste 3 · anular en la cuerda 3, traste 4 · meñique en la cuerda 4, traste 4).</li><li>Rasguea solo las cuerdas 4–1.</li></ol>Lo tienes cuando: las cuatro cuerdas trasteadas suenan claras — el meñique en la cuerda 4 es el que más se apaga.',
            ...
            steps: [
          {
            ...
            text: 'Challenge 3 — Cross-Group Changes: at 60 BPM, 2 bars each:<ol><li>Switch G→D, Am→Em, and C→A.</li><li>Then drill the two within-group pairs your assessment checks — D→A and Em→Bm.</li></ol>You\'ve got it when: each change lands on beat 1, using fingers that stay close as you switch.',
            text_es: 'Reto 3 — Cambios entre grupos: a 60 BPM, 2 compases cada uno:<ol><li>Cambia G→D, Am→Em, y C→A.</li><li>Y luego ejercita los dos pares dentro del mismo grupo que revisa tu evaluación — D→A y Em→Bm.</li></ol>Lo tienes cuando: cada cambio cae en el tiempo 1, usando dedos que se quedan cerca al cambiar.',
            ...
            steps: [
              {
                ...
                text: 'Challenge 4 — One-Minute Changes (G ↔ D):<ol><li>Set the ⏱ Timer for 60 seconds.</li><li>Switch G→D→G→D as many times as you can — only CLEAN changes count.</li></ol>This is a cross-group jump, so it\'s a real test. You\'ve got it when: type your count below and aim for a higher count than your Set 2 number.',
                text_es: 'Reto 4 — Cambios de un minuto (G ↔ D):<ol><li>Pon el ⏱ Temporizador en 60 segundos.</li><li>Cambia G→D→G→D tantas veces como puedas — solo cuentan los cambios LIMPIOS.</li></ol>Este es un salto entre grupos, así que es una prueba real. Lo tienes cuando: escribes tu cuenta abajo y apuntas a superar el número de la Unidad 2.',
            ...
            steps: [
              {
                ...
                text: 'Challenge — Waltz Strum: not every song is in 4. A waltz counts in THREE — "ONE-two-three, ONE-two-three." Use Em so the low strings ring full:<ol><li>Play a firm downstrum on beat 1 (strum harder into the low strings so the bass rings), then lighter downs on beats 2 and 3 (D · D · D).</li><li>Comfortable? Sneak an up after beat 3: D · D · D-U.</li></ol>Beat 1 is the strongest: it should clearly stand out from the other two. This "in-3" feel is the same strong-ONE pulse you hear driving songs like "The House of the Rising Sun." You\'ve got it when: you keep it steady for 8 bars and beat 1 is unmistakably the strongest pulse in every bar.',
                text_es: 'Reto — Rasgueo de vals: no todas las canciones están en 4. Un vals cuenta en TRES — "UNO-dos-tres, UNO-dos-tres." Usa Em para que las cuerdas graves suenen completas:<ol><li>Toca un rasgueo firme hacia abajo en el tiempo 1 (rasguea más fuerte hacia las cuerdas graves para que suene el bajo), y luego rasgueos más ligeros hacia abajo en los tiempos 2 y 3 (D · D · D).</li><li>¿Cómodo? Agrega un rasgueo hacia arriba después del tiempo 3: D · D · D-U.</li></ol>El tiempo 1 es el más fuerte: debe destacar claramente de los otros dos. Esta sensación "en 3" es el mismo pulso fuerte-UNO que escuchas impulsando canciones como "The House of the Rising Sun." Lo tienes cuando: lo mantienes constante por 8 compases y el tiempo 1 es inconfundiblemente el pulso más fuerte en cada compás.',
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Challenge 1 — Clean E:<ol><li>Fret E major (index finger on string 3, fret 1 · middle finger on string 5, fret 2 · ring finger on string 4, fret 2).</li><li>Strum all 6 strings.</li></ol>You\'ve got it when: a full, rich chord with every string ringing — watch your index on string 2.',
            text_es: 'Reto 1 — E limpio:<ol><li>Trastea E mayor (dedo índice en la cuerda 3, traste 1 · dedo medio en la cuerda 5, traste 2 · dedo anular en la cuerda 4, traste 2).</li><li>Rasguea las 6 cuerdas.</li></ol>Lo tienes cuando: un acorde completo y rico con cada cuerda sonando — cuidado con tu índice en la cuerda 2.',
            ...
            steps: [
          {
            ...
            text: 'Challenge 2 — Four-Finger B7:<ol><li>Fret B7 (index finger on string 4, fret 1 · middle finger on string 5, fret 2 · ring finger on string 3, fret 2 · pinky on string 1, fret 2).</li><li>Strum strings 1–5.</li></ol>You\'ve got it when: all four fingers down and every played string clean — then play E→B7→E and listen: the B7 sounds unfinished and "wants" to move back to E — that pull is called resolving.',
            text_es: 'Reto 2 — B7 con cuatro dedos:<ol><li>Trastea B7 (dedo índice en la cuerda 4, traste 1 · dedo medio en la cuerda 5, traste 2 · dedo anular en la cuerda 3, traste 2 · meñique en la cuerda 1, traste 2).</li><li>Rasguea las cuerdas 1–5.</li></ol>Lo tienes cuando: los cuatro dedos abajo y cada cuerda tocada suena limpia — y luego toca E→B7→E y escucha: el B7 suena inconcluso y "quiere" volver a E — ese tirón se llama resolución.',
            ...
            steps: [
              {
                ...
                text: 'Challenge 3 — One-Minute Changes (E ↔ B7):<ol><li>Set the ⏱ Timer for 60 seconds.</li><li>Switch E→B7→E→B7 as many times as you can — only CLEAN changes count (all four B7 fingers down, strings 1–5 ringing).</li></ol>You\'ve got it when: type your count below and aim for a higher count than your Set 3 number.',
                text_es: 'Reto 3 — Cambios de un minuto (E ↔ B7):<ol><li>Pon el ⏱ Temporizador en 60 segundos.</li><li>Cambia E→B7→E→B7 tantas veces como puedas — solo cuentan los cambios LIMPIOS (los cuatro dedos de B7 abajo, cuerdas 1–5 sonando).</li></ol>Lo tienes cuando: escribes tu cuenta abajo y apuntas a superar el número de la Unidad 3.',
