    ...
    skills: [
      ...
      { id: 'm5w4-s2', text: 'Fret B7 open chord cleanly — 4 fingers, top five strings',
        ...
        practice: { type: 'mc', prompt: 'B7 is called a "dominant 7th" chord. What does the "7" tell you it adds to the chord?',
          ...
          choices: ['Seven fingers', 'A 7th interval', 'Play on the 7th fret', 'Strum it seven times'],
          choices_es: ['Siete dedos', 'Un intervalo de 7ª', 'Tócalo en el traste 7', 'Rasguéalo siete veces'], answer: 1,
          explain: 'The 7 means one extra note — the seventh — is stacked on top of the basic three-note chord. That added note is what gives B7 its slightly tense, jazzy, bluesy pull toward the chord that follows.',
          explain_es: 'El 7 significa que se agrega una nota extra — la séptima — encima del acorde básico de tres notas. Esa nota añadida es la que le da a B7 ese tirón ligeramente tenso, jazzero y bluesero hacia el acorde que sigue.' } },
