    ...
    skills: [
      { id: 'm5w1-s1', text: 'Read a chord diagram: identify X (mute), O (open), dots (finger placement), and numbers (which finger)',
        ...
        practice: { type: 'mc', prompt: 'On a chord diagram, what does an "X" above a string mean?',
          ...
          explain: 'An X means skip that string entirely — it stays silent. An O means the opposite: play that string open, with no finger on it.',
          explain_es: 'Una X significa saltarse esa cuerda por completo — se queda en silencio. Una O significa lo contrario: toca esa cuerda al aire, sin ningún dedo encima.' } },
            ...
            steps: [
              {
                ...
                text: '<ol><li>Over one bar, strum down, down-up, up-down-up — written D · D U · U D U.</li><li>Count it out loud "1, 2-and, (3)-and, 4-and" — beat 3 in parentheses is the down you skip.</li><li>Start on one chord (G is a great one).</li></ol>You\'ve got it when: it loops smoothly 4 times in a row on one chord without stopping.',
                text_es: '<ol><li>En un compás, rasguea abajo, abajo-arriba, arriba-abajo-arriba — escrito D · D U · U D U.</li><li>Cuéntalo en voz alta "1, 2-y, (3)-y, 4-y" — el tiempo 3 entre paréntesis es el "abajo" que te saltas.</li><li>Empieza con un solo acorde (G es excelente).</li></ol>Lo tienes cuando: se repite suavemente 4 veces seguidas en un solo acorde sin detenerte.',
                hint: 'This is the classic singalong strum the down-up strum skill is really testing. Say the full count "1 2 and 3 and 4 and" while your hand swings nonstop. The six strums land on 1, 2, &(2), &(3), 4, &(4) — and beat 3\'s downstrum is the one you leave out: you strum on 1, on 2 and its "and," then catch just the "and" of 3, then 4 and its "and." That skipped beat-3 down is the whole secret of the groove (the steady rhythmic feel). Upstrokes stay lighter than downstrokes.',
                hint_es: 'Este es el clásico rasgueo para cantar en grupo que la destreza de rasgueo abajo-arriba realmente está probando. Di la cuenta completa "1 2 y 3 y 4 y" mientras tu mano se balancea sin parar. Los seis rasgueos caen en 1, 2, y(2), y(3), 4, y(4) — y el rasgueo hacia abajo del tiempo 3 es el que te saltas: rasgueas en 1, en 2 y su "y", y luego solo capturas el "y" del 3, y luego el 4 y su "y". Ese "abajo" saltado del tiempo 3 es todo el secreto del groove (la sensación rítmica constante). Los rasgueos hacia arriba se mantienen más ligeros que los de abajo.',
    ...
    skills: [
      ...
      { id: 'm5w3-s2', text: 'Fret A major cleanly — 3 fingers on 2nd fret',
        ...
        practice: { type: 'mc', prompt: 'In the open A major chord, all three fretting fingers go on which fret?',
          ...
          explain: 'All three fingers crowd into the 2nd fret, on strings 4, 3, and 2. That\'s why A feels cramped at first — the fix is bunching the fingers together, not spreading them across frets.',
          explain_es: 'Los tres dedos se apiñan en el traste 2, en las cuerdas Re, Sol y Si. Por eso A se siente apretado al principio — la solución es juntar los dedos, no repartirlos por varios trastes.' } },
