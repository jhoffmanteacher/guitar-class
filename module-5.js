    ...
    skills: [
      { id: 'm5w1-s1', text: 'Read a chord diagram: identify X (mute), O (open), dots (finger placement), and numbers (which finger)',
        ...
        practice: { type: 'mc', prompt: 'A chord chart written out reads "x32010". Which strings do you strum?',
          ...
          choices: ['All six strings', 'Strings 5 through 1', 'Only the three fretted strings', 'Strings 6 through 3'],
          choices_es: ['Las seis cuerdas', 'Las cuerdas 5 a 1', 'Solo las tres cuerdas trasteadas', 'Las cuerdas 6 a 3'], answer: 1,
          explain: 'Read the six characters from string 6 (low E) across to string 1 (high e). The leading "x" mutes the low E; a "0" means play that string open, so everything from string 5 down to string 1 rings — fretted or open. You\'ll see this shorthand again for the simplified F (xx3211) and Bm (xx4432) in the next two sets.',
          explain_es: 'Lee los seis caracteres desde la cuerda 6 (Mi grave) hasta la cuerda 1 (mi aguda). La "x" del principio silencia la Mi grave; un "0" significa tocar esa cuerda al aire, así que todo de la cuerda 5 a la 1 suena — trasteado o al aire. Verás esta forma de escribirlo otra vez con el F simplificado (xx3211) y el Bm (xx4432) en las dos unidades siguientes.' } },
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: '<ol><li>Fret your regular G shape — all three fingers, nothing moves (index on string 5, fret 2 · middle on string 6, fret 3 · ring on string 1, fret 3).</li><li>Strum only strings 5–1 — skip the low E (string 6) so the B note on string 5 becomes the bass instead of the low G.</li></ol>You\'ve got it when: the chord rings clean with a B in the bass — same G shape, just a different string to start the strum on.',
            text_es: '<ol><li>Trastea tu forma normal de G — los tres dedos, nada se mueve (índice en la cuerda 5, traste 2 · medio en la cuerda 6, traste 3 · anular en la cuerda 1, traste 3).</li><li>Rasguea solo las cuerdas 5–1 — sáltate la Mi grave (cuerda 6) para que la nota B en la cuerda 5 se convierta en el bajo en vez de la G grave.</li></ol>Lo tienes cuando: el acorde suena limpio con una B en el bajo — la misma forma de G, solo que empiezas el rasgueo en una cuerda distinta.',
    ...
    skills: [
      ...
      { id: 'm5w2-s2', text: 'Fret F major (simplified xx3211) with no buzzing',
        ...
        practice: { type: 'mc', prompt: 'For the simplified F chord (xx3211), which strings should you actually strum?',
          ...
          choices: ['All 6 strings', 'Strings 1–4 only (the top 4)', 'Strings 5–1', 'Strings 6 and 5 only (the bass pair)'],
          choices_es: ['Todas las 6 cuerdas', 'Solo las cuerdas 1–4 (las 4 agudas)', 'Las cuerdas de la 5 a la 1', 'Solo las cuerdas 6 y 5 (las dos graves)'], answer: 1,
          explain: 'The two x\'s at the front stand for strings 6 and 5 (low E and A) — they stay silent, so only the top four strings sound. Strumming all six drops an open low E underneath — a note that isn\'t in F at all — and the chord turns muddy.',
          explain_es: 'Las dos x del principio corresponden a las cuerdas 6 y 5 (Mi grave y La) — se quedan en silencio, así que solo suenan las cuatro cuerdas agudas. Rasguear las seis deja sonar la Mi grave al aire — una nota que ni siquiera está en F — y el acorde se enturbia.' } },
      ...
      { id: 'm5w2-s4', text: 'Use the common-finger pivot between Am and C',
        ...
        practice: { type: 'mc', prompt: 'When pivoting between Am and C, which finger STAYS planted on string 2 fret 1?',
          ...
          explain: 'Am and C both put the index finger on string 2, fret 1 — leave it planted and pivot the other fingers around it. Lifting it means rebuilding the whole shape and losing the beat.',
          explain_es: 'Am y C ponen los dos el dedo índice en la cuerda 2, traste 1 — déjalo plantado y pivotea los otros dedos a su alrededor. Levantarlo significa reconstruir toda la forma y perder el tiempo.' } },
      ...
      { id: 'm5w2-s8', text: 'Play the G/B bass turnaround (G shape, B in the bass)',
        ...
        practice: { type: 'mc', prompt: 'In the chord name "G/B", what does the "/B" tell you?',
          ...
          choices: ['Play a B chord instead of the G chord', 'B is the bass note under a G shape', 'Barre the B string with your index finger', 'Tune string 2 down to a B note'],
          choices_es: ['Toca un acorde B en vez del acorde G', 'B es la nota de bajo debajo de una forma de G', 'Haz cejilla en la cuerda Si con el dedo índice', 'Afina la cuerda 2 hacia abajo hasta un B'], answer: 1,
          explain: 'A slash chord names the chord first and the bass note second: play your normal G shape, but start the strum on string 5 so the B there is the lowest note. It isn\'t a different chord — just a different note underneath.',
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: '<ol><li>Fret the four-finger Bm shape (xx4432 — index on string 1, fret 2 · middle on string 2, fret 3 · ring on string 3, fret 4 · pinky on string 4, fret 4).</li><li>Strum strings 4–1 only.</li></ol>You\'ve got it when: all four fretted strings ring clearly — the pinky on string 4 is the one most likely to go quiet.',
            text_es: '<ol><li>Trastea la forma de Bm de cuatro dedos (xx4432 — índice en la cuerda 1, traste 2 · medio en la cuerda 2, traste 3 · anular en la cuerda 3, traste 4 · meñique en la cuerda 4, traste 4).</li><li>Rasguea solo las cuerdas 4–1.</li></ol>Lo tienes cuando: las cuatro cuerdas trasteadas suenan claras — el meñique en la cuerda 4 es el que más se apaga.',
            hint: 'No barre here at all — one finger per string, fingers 1 through 4 climbing like stairs across strings 1 through 4. Curl each one so it presses straight down on its own string, not brushing the neighbor. (Your first flat-finger mini-barre was the simplified F last set, where the index lies across strings 1 and 2. Full barres arrive in Module 7.)',
            hint_es: 'Aquí no hay ninguna cejilla — un dedo por cuerda, los dedos 1 al 4 subiendo como escalera por las cuerdas 1 a 4. Curva cada uno para que presione derecho hacia abajo en su propia cuerda, sin rozar al vecino. (Tu primera mini-cejilla con el dedo plano fue el F simplificado de la unidad pasada, donde el índice se apoya sobre las cuerdas 1 y 2. Las cejillas completas llegan en el Módulo 7.)',
    ...
    skills: [
      { id: 'm5w3-s1', text: 'Fret D major cleanly — triangular shape, strings 1–4',
        ...
        practice: { type: 'mc', prompt: 'When you strum the D major open chord, which strings should you play?',
          ...
          choices_es: ['Las 6 cuerdas', 'Las cuerdas 4–1 (las 4 agudas)', 'Las cuerdas de la 6 a la 3', 'Solo las cuerdas 1 y 2'], answer: 1,
          explain: 'D is built on the top four strings only — strings 6 and 5 (low E and A) stay out of the strum. Hitting them adds a low note that makes D sound muddy instead of bright.',
      ...
      { id: 'm5w3-s2', text: 'Fret A major cleanly — 3 fingers on 2nd fret',
        ...
        practice: { type: 'mc', prompt: 'You\'re fretting open A major. Your three fingers all sit at fret 2 — on which three strings?',
          ...
          choices: ['Strings 4, 3, and 2 (D, G, B)', 'Strings 5, 4, and 3 (A, D, G)', 'Strings 3, 2, and 1 (G, B, high e)', 'Strings 6, 5, and 4 (low E, A, D)'],
          choices_es: ['Las cuerdas 4, 3 y 2 (Re, Sol, Si)', 'Las cuerdas 5, 4 y 3 (La, Re, Sol)', 'Las cuerdas 3, 2 y 1 (Sol, Si, mi aguda)', 'Las cuerdas 6, 5 y 4 (Mi grave, La, Re)'], answer: 0,
      ...
      { id: 'm5w3-s3', text: 'Fret the four-finger Bm shape (xx4432) — one finger per string, no barre',
        ...
        practice: { type: 'mc', prompt: 'The Bm chord is written "xx4432". What do the two "x"s at the start mean?',
          ...
          choices: ['Strum extra hard', 'Mute strings 6 and 5', 'Use 2 fingers on string 1', 'Cross your fingers'],
          choices_es: ['Rasguea extra fuerte', 'Silencia las cuerdas 6 y 5', 'Usa 2 dedos en la cuerda 1', 'Cruza los dedos'], answer: 1,
          explain: 'A written-out chord like xx4432 reads from string 6 across to string 1, so those two x\'s cover the low E and A strings — keep them silent and strum only strings 4 through 1.',
          explain_es: 'Un acorde escrito como xx4432 se lee de la cuerda 6 hasta la cuerda 1, así que esas dos x corresponden a las cuerdas Mi grave y La — déjalas en silencio y rasguea solo de la cuerda 4 a la 1.' } },
