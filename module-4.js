      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Challenge 2 — Move the Box (a box = the block of frets where a scale pattern sits):<ol><li>Play Pattern 1 as A minor pentatonic (1st finger, 5th fret, string 6) up and down using the TAB map.</li><li>Then shift it to E minor pentatonic (open-string root).</li></ol>You\'ve got it when: both positions clean — same shape, two spots on the neck.',
            text_es: 'Reto 2 — Mueve la caja (una caja = el bloque de trastes donde se ubica un patrón de escala):<ol><li>Toca el Patrón 1 como A menor pentatónica (dedo índice, traste 5, cuerda 6) subiendo y bajando usando el mapa de TAB.</li><li>Luego cámbialo a E menor pentatónica (raíz en cuerda al aire).</li></ol>Lo tienes cuando: ambas posiciones limpias — misma forma, dos lugares en el mástil.',
            ...
            steps: [
              {
                ...
                text: 'Challenge — Solo over Seven Nation Army:<ol><li>Loop the SNA riff (a riff = a short musical phrase that repeats) in your head (or record yourself playing the riff and jam over the playback).</li><li>Improvise using ONLY these three notes — low E, G, and open A — for four bars.</li></ol>Rule of 3: short ideas, space between them. You\'ve got it when: four bars of intentional phrases — not a stream of notes — that land back on E. <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 4 of 5</a>.',
                text_es: 'Reto — Solo sobre Seven Nation Army:<ol><li>Repite el riff de SNA (un riff = una frase musical corta que se repite) en tu cabeza (o grábate tocando el riff y toca sobre la grabación).</li><li>Improvisa usando SOLO estas tres notas — Mi grave, G, y La al aire — durante cuatro compases.</li></ol>Regla de 3: ideas cortas, espacio entre ellas. Lo tienes cuando: cuatro compases de frases intencionadas — no un torrente de notas — que aterricen de vuelta en E. <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 4 de 5</a>.',
              ...
              },
              {
                ...
                text: 'Challenge — Watchtower, the real rhythm: you\'ve played this bass line since Module 2 — but always one even note per beat:<ol><li>Listen to the recording.</li><li>Find the riff\'s TAB with rhythm stems (Songsterr shows them clearly).</li><li>Play it the way the record actually goes — each root held a full two beats, not one.</li></ol>You\'ve got it when: you can loop A · G · F · G along with the record and stay locked with it. <a href="tabs/all-along-the-watchtower.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 2 of 5</a>.',
                text_es: 'Reto — Watchtower, el ritmo real: has tocado esta línea de bajo desde el Módulo 2 — pero siempre con una nota pareja por tiempo:<ol><li>Escucha la grabación.</li><li>Busca el TAB del riff con plicas de ritmo (Songsterr las muestra claramente).</li><li>Tócalo como realmente suena en el disco — cada raíz sostenida dos tiempos completos, no uno.</li></ol>Lo tienes cuando: puedes repetir A · G · F · G junto con la grabación y mantenerte sincronizado. <a href="tabs/all-along-the-watchtower.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 2 de 5</a>.',
              ...
              },
              {
                ...
                text: 'Challenge — Seven Nation Army, the real rhythm (by ear): you\'ve played this riff since Module 1 as straight, even quarter notes — but the record swings it looser than that:<ol><li>Press the two &#x25B6; buttons below to hear the difference before you clap it.</li><li>Listen to the recording on repeat.</li><li>Clap the riff\'s rhythm with no guitar — some notes clipped short, some held longer — until it\'s in your hands.</li><li>Add the frets back once the feel is there.</li></ol>You\'ve got it when: you can loop the riff along with the record and stay locked with its groove. (Module 7 revisits this riff to read its rhythm in notation — for now, trust your ear.) <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 2 of 5</a>.',
                text_es: 'Reto — Seven Nation Army, el ritmo real (de oído): has tocado este riff desde el Módulo 1 como negras parejas y rectas — pero la grabación lo balancea más suelto que eso:<ol><li>Presiona los dos botones &#x25B6; de abajo para escuchar la diferencia antes de aplaudirlo.</li><li>Escucha la grabación una y otra vez.</li><li>Aplaude el ritmo del riff sin guitarra — algunas notas cortas, algunas sostenidas más — hasta que esté en tus manos.</li><li>Vuelve a agregar los trastes una vez que tengas la sensación.</li></ol>Lo tienes cuando: puedes repetir el riff junto con la grabación y mantenerte sincronizado con su groove (el groove = la sensación rítmica que te hace mover el cuerpo). (El Módulo 7 vuelve a este riff para leer su ritmo en notación — por ahora, confía en tu oído.) <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 2 de 5</a>.',
              ...
              },
              {
                ...
                text: 'Challenge — Solo over Luna: Luna lives in F major, and F\'s relative minor is D — so D minor pentatonic Pattern 1 (root D, low E fret 10) is your box: the exact shape you\'ve been drilling, parked at the course\'s highest position. Jam over <a href="https://www.youtube.com/watch?v=wBxFnX_V9mQ" target="_blank">▶ &#x1F3B5; a slow Dm practice jam (Luna\'s solo key)</a>:<ol><li>Improvise four bars using only the three notes marked below.</li><li>Improvise four more, adding a fourth note from the box.</li></ol>You\'ve got it when: eight bars where every phrase starts or ends on D. <a href="tabs/luna.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 4 of 5</a>.',
                text_es: 'Reto — Solo sobre Luna: Luna vive en F mayor, y la relativa menor de F es D — así que el Patrón pentatónico 1 de D menor (raíz D, cuerda Mi grave traste 10) es tu caja: la misma forma que has estado ejercitando, ubicada en la posición más alta del curso. Toca sobre <a href="https://www.youtube.com/watch?v=wBxFnX_V9mQ" target="_blank">▶ &#x1F3B5; una pista de jam lenta en D menor (la tonalidad del solo de Luna)</a>:<ol><li>Improvisa cuatro compases usando solo las tres notas marcadas abajo.</li><li>Improvisa cuatro más, agregando una cuarta nota de la caja.</li></ol>Lo tienes cuando: ocho compases donde cada frase empieza o termina en D. <a href="tabs/luna.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 4 de 5</a>.',
      ...
      b: {
        ...
        sections: [
          ...
          },
          {
            ...
            text: 'Watch: <a href="https://youtu.be/7hDdZAjKBjY" target="_blank">Hammer-Ons & Pull-Offs Explained – JustinGuitar</a> (0:00–3:00). As you watch, try one hammer-on on your own guitar:<ol><li>Pick the open D string.</li><li>Then hammer your finger onto the 2nd fret without picking again.</li></ol>',
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Challenge 1 — The One-Note Solo:<ol><li>Choose one note in the Am pentatonic pattern.</li><li>Play only that note for 8 bars, varying rhythm, dynamics, and tone.</li></ol>You\'ve got it when: make one note stay interesting for all 8 bars — record it and listen back.',
            text_es: 'Reto 1 — El solo de una nota:<ol><li>Elige una nota del patrón pentatónico de Am.</li><li>Toca solo esa nota durante 8 compases, variando el ritmo, la dinámica y el tono.</li></ol>Lo tienes cuando: logras que una nota se mantenga interesante durante los 8 compases — grábalo y escúchalo después.',
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text: 'Challenge — Solo over "the cure": Olivia\'s song is soft — so your solo has to be too. Improvise eight bars in Am pentatonic Pattern 1 at a whisper:<ul><li>Light pick.</li><li>Slow phrases.</li><li>Lots of space.</li></ul>You\'ve got it when: eight bars where the quietest note is as clean as your loudest.',
                text_es: 'Reto — Solo sobre "the cure": la canción de Olivia es suave — así que tu solo también tiene que serlo. Improvisa ocho compases en el Patrón pentatónico 1 de Am en un susurro:<ul><li>Púa ligera.</li><li>Frases lentas.</li><li>Mucho espacio.</li></ul>Lo tienes cuando: ocho compases donde la nota más suave está tan limpia como la más fuerte.',
      ...
      b: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Re-watch the same video from Set 1 — <a href="https://youtu.be/m_IiyJu60-c?t=105" target="_blank">Major Pentatonic Scale – Marty Music</a> (the link skips the intro) — this time listening for the major/minor connection. Then prove it on your own neck:<ol><li>Play Pattern 1 and call the low E root "home" for major.</li><li>Then treat a different note as "home" and hear the same shape turn minor.</li></ol>Your hand stays parked in one place — only which note you call "home" changes.',
            text_es: 'Vuelve a mirar el mismo video de la Unidad 1 — <a href="https://youtu.be/m_IiyJu60-c?t=105" target="_blank">Major Pentatonic Scale – Marty Music</a> (el enlace se salta la intro) — esta vez escuchando la conexión mayor/menor. Luego compruébalo en tu propio mástil:<ol><li>Toca el Patrón 1 y llama "nota base" a la raíz de la Mi grave para mayor.</li><li>Luego trata una nota distinta como "nota base" y escucha cómo la misma forma se vuelve menor.</li></ol>Tu mano se queda quieta en un lugar — solo cambia qué nota llamas "nota base."',
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Challenge 1 — Relative Scales: type these into the box below:<ol><li>C major pentatonic (1 C, 2 D, 3 E, 5 G, 6 A).</li><li>Then A minor pentatonic (1 A, ♭3 C, 4 D, 5 E, ♭7 G).</li></ol>You\'ve got it when: you spot that they share the same five notes — only which note is "home" changes.',
            text_es: 'Reto 1 — Escalas relativas: escribe esto en el cuadro de abajo:<ol><li>C mayor pentatónica (1 C, 2 D, 3 E, 5 G, 6 A).</li><li>Y luego A menor pentatónica (1 A, ♭3 C, 4 D, 5 E, ♭7 G).</li></ol>Lo tienes cuando: notas que comparten las mismas cinco notas — solo cambia cuál nota es "nota base."',
            ...
            steps: [
          {
            ...
            text: 'Challenge 2 — Compose It:<ol><li>Write a 4-bar solo as scale-degree numbers (e.g. 1 3 5 3 | 6 5 3 1 | …).</li><li>Then play exactly what you wrote, varying the rhythms.</li></ol>You\'ve got it when: a deliberate 4-bar line you can play back the same way twice. Type your 4 bars into the box below so you have them next session.',
            text_es: 'Reto 2 — Compónlo:<ol><li>Escribe un solo de 4 compases como números de grado de escala (p. ej. 1 3 5 3 | 6 5 3 1 | …).</li><li>Luego toca exactamente lo que escribiste, variando los ritmos.</li></ol>Lo tienes cuando: una línea deliberada de 4 compases que puedes volver a tocar de la misma manera dos veces. Escribe tus 4 compases en el cuadro de abajo para tenerlos la próxima sesión.',
...
MODULE_SONGS[4] = [
      ...
      { name: '"Sweet Child O\' Mine" — Guns N\' Roses', meta: 'Full solo over D–C–G · G major / E minor pentatonic', meta_es: 'Solo completo sobre D–C–G · G mayor / E menor pentatónica', type: 'Core', core: true, journeyUrl: 'tabs/sweet-child-o-mine.html',
        ...
        backingUrl: 'audio/guns-n-roses-sweet-child-o-mine-backing-G-125bpm-440hz-rhythm-down.mp3',
        backingKey: 'Em/G' },
      { name: '"Seven Nation Army" — The White Stripes', meta: 'E minor pentatonic solo', meta_es: 'Solo en E menor pentatónica', type: 'Core', core: true, journeyUrl: 'tabs/seven-nation-army.html',
        ...
        backingUrl: 'audio/the-white-stripes-seven-nation-army-backing-Em-123bpm-440hz-rhythm-down.mp3',
        backingKey: 'Em' },
      { name: '"Luna" — Peso Pluma, Junior H', meta: 'Full solo using Dm pentatonic (root D, low E fret 10)', meta_es: 'Solo completo usando Dm pentatónica (raíz D, Mi grave traste 10)', type: 'Core', core: true, journeyUrl: 'tabs/luna.html',
        ...
        backingUrl: 'audio/peso-pluma-junior-h-luna-backing-Am-128bpm-440hz-rhythm-down.mp3',
        backingKey: 'Dm' },
