...
SETS.push(

  {
    ...
    songs: [
      ...
      { name: 'Core Song 2 — TBD', meta: 'Solo over the chorus using minor pentatonic (E & A)', type: 'Core', core: true },
...

  {
    ...
    songs: [
      ...
      { name: '"All Along the Watchtower" — Dylan / Hendrix', meta: 'Full solo using Am pentatonic across 4 strings', type: 'Core', core: true,
        originalUrl: 'https://www.youtube.com/watch?v=bT7Hj-ea0VE',
        tutorialUrl: 'https://www.youtube.com/watch?v=Tnm1jWVLaC8' },
      { name: 'Core Song 2 — TBD', meta: 'Melodic solo over the verse — minor pentatonic', type: 'Core', core: true },
...

  {
    ...
    songs: [
      { name: '"All Along the Watchtower" — Dylan / Hendrix', meta: 'Full solo over Am pentatonic — unit-end performance', type: 'Core', core: true,
        originalUrl: 'https://www.youtube.com/watch?v=bT7Hj-ea0VE',
        tutorialUrl: 'https://www.youtube.com/watch?v=Tnm1jWVLaC8' },
      { name: 'Core Song 2 — TBD', meta: 'Full solo — minor pentatonic', type: 'Core', core: true },
