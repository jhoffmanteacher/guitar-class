...
SETS.push(

  {
    ...
    songs: [
      { name: '"All Along the Watchtower" — Dylan / Hendrix', meta: 'Solo using Am pentatonic Pattern 1 over E & A strings', type: 'Core', core: true, journeyUrl: 'tabs/all-along-the-watchtower.html',
        originalUrl: 'https://www.youtube.com/watch?v=bT7Hj-ea0VE',
        tutorialUrl: 'https://www.youtube.com/watch?v=Tnm1jWVLaC8',
        backingUrl: 'https://www.youtube.com/watch?v=Vq8cApzOdy8',
        backingKey: 'Am' },
      { name: '"the cure" — Olivia Rodrigo', meta: 'Solo over the chorus · A minor pentatonic (capo 1 · Am–C–Dm–F–G/B)', type: 'Core', core: true, journeyUrl: 'tabs/the-cure.html',
        ...
        backingKey: 'Am' },
      { name: '"Sweet Child O\' Mine" — Guns N\' Roses', meta: 'Solo over D–C–G · G major / E minor pentatonic', type: 'Core', core: true, journeyUrl: 'tabs/sweet-child-o-mine.html',
        ...
        backingKey: 'Em/G' },
      { name: '"Seven Nation Army" — The White Stripes', meta: 'Solo using E minor pentatonic (E & A strings)', type: 'Core', core: true, journeyUrl: 'tabs/seven-nation-army.html',
      ...
      { name: '"La Grange" — ZZ Top', meta: 'E blues scale riff', type: 'Choice', core: false, level: 2,
        originalUrl: 'https://www.youtube.com/watch?v=rG6b8gjMEkw',
        tutorialUrl: 'https://www.youtube.com/watch?v=qkwjcsCVl_4' },
      { name: '"Mannish Boy" — Muddy Waters', meta: 'E string riff — feel the blues', type: 'Choice', core: false, level: 2,
...

  {
    ...
    songs: [
      ...
      { name: '"Still Got the Blues" — Gary Moore', meta: 'Slow blues — focus on tone and note shape', type: 'Choice', core: false, level: 3,
        originalUrl: 'https://www.youtube.com/watch?v=0h0fLUweizI',
        tutorialUrl: 'https://www.youtube.com/watch?v=aQQKb_KMxts' },
      { name: '"The Thrill Is Gone" — BB King', meta: 'B minor blues — dynamics and phrasing focus', type: 'Choice', core: false, level: 2,
        originalUrl: 'https://www.youtube.com/watch?v=kpC69qIe02E',
        tutorialUrl: 'https://www.youtube.com/watch?v=NrEu8tO0mnQ' },
      { name: '"Sweet Home Chicago" — Robert Johnson', meta: 'Blues pentatonic — 4-string range', type: 'Choice', core: false, level: 2,
        originalUrl: 'https://www.youtube.com/watch?v=Ug0ZRSbmCRM',
        tutorialUrl: 'https://www.youtube.com/watch?v=Ld2QKvErNxY' },
      { name: '"Wish You Were Here" — Pink Floyd', meta: 'Arpeggios and melodic phrasing', type: 'Choice', core: false, level: 2,
...

  {
    ...
    songs: [
      { name: '"All Along the Watchtower" — Dylan / Hendrix', meta: 'Full solo over Am pentatonic — unit-end performance', type: 'Core', core: true, journeyUrl: 'tabs/all-along-the-watchtower.html',
        originalUrl: 'https://www.youtube.com/watch?v=bT7Hj-ea0VE',
        tutorialUrl: 'https://www.youtube.com/watch?v=Tnm1jWVLaC8',
        backingUrl: 'https://www.youtube.com/watch?v=Vq8cApzOdy8',
        backingKey: 'Am' },
      ...
      { name: '"Johnny B. Goode" — Chuck Berry', meta: 'B pentatonic — classic rock phrasing', type: 'Choice', core: false, level: 3,
        originalUrl: 'https://www.youtube.com/watch?v=_SYl2wTNM-w',
        tutorialUrl: 'https://www.youtube.com/watch?v=H8prc_T7zhU' },
      { name: '"Folsom Prison Blues" — Johnny Cash', meta: 'E pentatonic — melodic and rhythmic', type: 'Choice', core: false, level: 2,
