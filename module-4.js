      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: '<ul><li>Play Pentatonic Pattern 1 ascending at 60 BPM, one note per beat, alternate picking (down-up-down-up).</li></ul>You\'ve got it when: every note rings clean with no missed picks. Click "Play all" to hear it.',
            text_es: '<ul><li>Toca el Patrón pentatónico 1 subiendo a 60 BPM, una nota por tiempo, con púa alterna (abajo-arriba-abajo-arriba).</li></ul>Lo tienes cuando: cada nota suena limpia sin púas falladas. Presiona "Tocar todo" para escucharlo.',
            ...
            steps: [
              {
                ...
                text: '<ol><li>Loop the "Seven Nation Army" riff (a riff = a short musical phrase that repeats) in your head (or record yourself playing the riff and jam over the playback).</li><li>Improvise using ONLY these three notes — low E, G, and open A — for four bars.</li></ol>You\'ve got it when: four bars of intentional phrases — not a stream of notes — that land back on E. <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 4 of 5</a>.',
                ...
                hint: 'Remember the Rule of 3: short ideas, with space between them. E is the note this song centers on. End every phrase on it and you\'ll always sound like you meant it.',
                hint_es: 'Recuerda la Regla de 3: ideas cortas, con espacio entre ellas. E es la nota en la que se centra esta canción. Termina cada frase en ella y siempre sonará como si lo hubieras hecho a propósito.',
              ...
              },
              {
                ...
                hint: 'Until now you\'ve always played this bass line one even note per beat. The frets haven\'t changed since Module 2 — only the rhythm reading is new. That\'s the whole point of this step: same notes, real music.',
                hint_es: 'Hasta ahora siempre has tocado esta línea de bajo con una nota pareja por tiempo. Los trastes no han cambiado desde el Módulo 2 — solo la lectura del ritmo es nueva. Ese es el punto de este paso: las mismas notas, música real.',
