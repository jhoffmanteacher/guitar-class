      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: '<ol><li>Improvise using ONLY 3 notes of Pattern 1 for 4 bars over the Am backing track — <a href="https://www.youtube.com/watch?v=Vq8cApzOdy8" target="_blank">▶ &#x1F3B5; Am jam track</a>.</li><li>Once those 3 feel comfortable, add a 4th note and play 4 more bars.</li></ol>You\'ve got it when: two 4-bar passes done — one on 3 notes, one on 4 — each with short, intentional ideas and space between them. No score — aim for that, not perfection.',
            text_es: '<ol><li>Improvisa usando SOLO 3 notas del Patrón 1 durante 4 compases sobre la pista de acompañamiento de Am — <a href="https://www.youtube.com/watch?v=Vq8cApzOdy8" target="_blank">▶ &#x1F3B5; pista de jam en Am</a>.</li><li>Una vez que esas 3 se sientan cómodas, agrega una 4ª nota y toca 4 compases más.</li></ol>Lo tienes cuando: dos pasadas de 4 compases hechas — una con 3 notas, una con 4 — cada una con ideas cortas e intencionadas y espacio entre ellas. Sin puntaje — apunta a eso, no a la perfección.',
      ...
      b: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text_es: 'Mira: <a href="https://www.youtube.com/watch?v=1mT5nUE0o7M&t=31" target="_blank">How to USE the Minor Pentatonic Scale – Lauren Bateman (0:31–4:00)</a> para repasar la forma. Agrega la expresión que el video no muestra:<ol><li>Elige una nota del patrón.</li><li>Tócala fuerte, y luego suave.</li></ol>Esa diferencia de volumen es la dinámica. Lo tienes cuando: ya tocaste la misma nota fuerte y luego suave cuatro veces seguidas, y escuchas la diferencia cada vez.',
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: '<ol><li>Write a 4-bar solo as scale-degree numbers (e.g. 1 ♭3 5 ♭3 | ♭7 5 ♭3 1 | …).</li><li>Then play exactly what you wrote, varying the rhythms.</li></ol>You\'ve got it when: a deliberate 4-bar line you can play back the same way twice. Type your 4 bars into the box below so you have them next session.<span class="step-figure"><img src="img/m4-pentatonic-degrees.svg" alt="A fretboard diagram of A minor pentatonic Pattern 1 across all six strings, frets 0 to 12, with scale-degree numbers marked: on the low E and high e strings, 1 at fret 5 and ♭3 at fret 8; on the A string, 4 at fret 5 and 5 at fret 7; on the D string, ♭7 at fret 5 and 1 at fret 7; on the G string, ♭3 at fret 5 and 4 at fret 7; on the B string, 5 at fret 5 and ♭7 at fret 8." width="640" height="244"></span>',
            ...
            hint: 'The ♭ just means a fret lower than the major scale\'s version of that degree — that\'s why ♭3 and ♭7 are the two flats in every minor pentatonic. Write first, then play! It\'s okay if it sounds simple. The goal is to make a deliberate musical decision, not to improvise randomly.',
            hint_es: 'El ♭ solo significa un traste más abajo que la versión de esa nota en la escala mayor — por eso ♭3 y ♭7 son los dos bemoles en toda pentatónica menor. ¡Escribe primero, y luego toca! Está bien si suena simple. El objetivo es tomar una decisión musical deliberada, no improvisar al azar.',
            ...
            steps: [
          {
            ...
            hint: 'At the module self-assessment you\'ll read a NEW 4-bar lick at first sight — this is Task 2. Read before you press Play. Bottom TAB line = low E, top line = high e; the number is the fret. Say it out loud — "G string, fret 5, that\'s C" — as you go, then hit Play all to check yourself.',
