      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'A box = the block of frets where a scale pattern sits.<ol><li>Play Pattern 1 as A minor pentatonic (1st finger, 5th fret, string 6) up and down using the TAB map.</li><li>Then shift it to E minor pentatonic (open-string root).</li></ol>You\'ve got it when: both positions clean — same shape, two spots on the neck.',
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text: 'You\'ve played this bass line since Module 2 — but always one even note per beat:<ol><li>Listen to the recording.</li><li>Find the riff\'s TAB with rhythm stems (Songsterr shows them clearly).</li><li>Play it the way the record actually goes — each root held a full two beats, not one.</li></ol>You\'ve got it when: you can loop A · G · F · G along with the record and stay locked with it. <a href="tabs/all-along-the-watchtower.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 2 of 5</a>.',
                text_es: 'Has tocado esta línea de bajo desde el Módulo 2 — pero siempre con una nota pareja por tiempo:<ol><li>Escucha la grabación.</li><li>Busca el TAB del riff con plicas de ritmo (Songsterr las muestra claramente).</li><li>Tócalo como realmente suena en el disco — cada raíz sostenida dos tiempos completos, no uno.</li></ol>Lo tienes cuando: puedes repetir A · G · F · G junto con la grabación y mantenerte sincronizado. <a href="tabs/all-along-the-watchtower.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 2 de 5</a>.',
      ...
      b: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text: 'Re-watch the same video from Set 1 — <a href="https://youtu.be/m_IiyJu60-c?t=105" target="_blank">Major Pentatonic Scale – Marty Music</a> (the link skips the intro) — this time listening for the major/minor connection. Then prove it on your own neck:<ol><li>Play Pattern 1 and call the low E root (1st finger) "home" for minor.</li><li>Then treat the note three frets higher (4th finger, same string) as "home" and hear the same shape turn major.</li></ol>Your hand stays parked in one place — only which note you call "home" changes.',
            text_es: 'Vuelve a mirar el mismo video de la Unidad 1 — <a href="https://youtu.be/m_IiyJu60-c?t=105" target="_blank">Major Pentatonic Scale – Marty Music</a> (el enlace se salta la intro) — esta vez escuchando la conexión mayor/menor. Luego compruébalo en tu propio mástil:<ol><li>Toca el Patrón 1 y llama "nota base" a la raíz de la Mi grave (dedo 1º) para menor.</li><li>Luego trata la nota tres trastes más arriba (dedo 4º, misma cuerda) como "nota base" y escucha cómo la misma forma se vuelve mayor.</li></ol>Tu mano se queda quieta en un lugar — solo cambia qué nota llamas "nota base."',
