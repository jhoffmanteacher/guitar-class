      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            hint: 'This is a warm-up drill — the module assessment is your own 4-bar solo (you\'ll compose it in Set 3), held to the backing track\'s pulse — but this climb is the benchmark lap (a lap = one full time through) for your Set 1 check-off. Go as slow as you need. Every note should ring cleanly. Instead of note names, say each note\'s SCALE DEGREE aloud as you climb — 1, ♭3 ("flat three"), 4, 5, ♭7 ("flat seven"), then 1 again an octave up, and around again. A degree is just the note\'s number inside the scale, and the ♭ marks the ones that sit a fret lower than you\'d expect — Set 3 digs into why. The degrees work on every string, including the ones whose note names you haven\'t met yet (D and G come later this module; the B and high e names wait for Module 9). Set the ⏱ Timer for 2 minutes and loop it.',
            hint_es: 'Este es un ejercicio de calentamiento — la evaluación del módulo es tu propio solo de 4 compases (lo compondrás en la Unidad 3), sostenido al pulso de la pista de acompañamiento — pero esta subida es la vuelta de referencia (una vuelta = un recorrido completo) para tu verificación de la Unidad 1. Ve tan despacio como necesites. Cada nota debe sonar limpia. En vez de los nombres de las notas, di en voz alta el GRADO de la escala de cada nota mientras subes — 1, ♭3 ("tres bemol"), 4, 5, ♭7 ("siete bemol"), y luego 1 otra vez una octava más arriba, y de nuevo. Un grado es simplemente el número de la nota dentro de la escala, y el ♭ marca las que quedan un traste más abajo de lo que esperarías — la Unidad 3 explica por qué. Los grados funcionan en todas las cuerdas, incluidas aquellas cuyos nombres de nota todavía no conoces (Re y Sol vienen más adelante en este módulo; los nombres de la Si y la mi aguda esperan al Módulo 9). Pon el ⏱ Temporizador en 2 minutos y repítelo.',
            ...
            steps: [
              {
                ...
                text: '<ol><li>Record yourself playing the "Seven Nation Army" riff (a riff = a short musical phrase that repeats) on the A string — E · E · G · E · D · C · B, the same one from Module 1 — and loop the recording.</li><li>Improvise over it using ONLY these three notes — open low E, G (low E, fret 3), and open A — for four bars.</li></ol>You\'ve got it when: four bars of intentional phrases — not a stream of notes — that land back on E. <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 4 of 5</a>.',
                text_es: '<ol><li>Grábate tocando el riff de "Seven Nation Army" (un riff = una frase musical corta que se repite) en la cuerda La — E · E · G · E · D · C · B, el mismo que tocas desde el Módulo 1 — y repite la grabación en bucle.</li><li>Improvisa sobre ella usando SOLO estas tres notas — Mi grave al aire, G (cuerda Mi grave, traste 3), y La al aire — durante cuatro compases.</li></ol>Lo tienes cuando: cuatro compases de frases intencionadas — no un torrente de notas — que aterricen de vuelta en E. <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 4 de 5</a>.',
