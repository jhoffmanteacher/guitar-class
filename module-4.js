      ...
      b: {
        ...
        sections: [
          ...
          },
          {
            ...
            text: 'Watch: <a href="https://youtu.be/7hDdZAjKBjY" target="_blank">Hammer-Ons & Pull-Offs Explained – JustinGuitar</a> (0:00–3:00). As you watch, try both on your own guitar:<ol><li>Pick the open D string.</li><li>Then hammer your finger onto the 2nd fret without picking again — that\'s the hammer-on.</li><li>Now the pull-off, the same move backwards: fret the D string at the 2nd fret and pick it, then flick that finger sideways off the string so the open D rings on its own — no second pick.</li></ol>',
            text_es: 'Mira: <a href="https://youtu.be/7hDdZAjKBjY" target="_blank">Hammer-Ons & Pull-Offs Explained – JustinGuitar</a> (0:00–3:00). Mientras miras, prueba los dos en tu propia guitarra:<ol><li>Pulsa la cuerda Re al aire.</li><li>Luego martilla tu dedo sobre el traste 2 sin pulsar de nuevo — eso es el hammer-on.</li><li>Ahora el pull-off, el mismo movimiento al revés: trastea la cuerda Re en el traste 2 y púlsala, y luego saca ese dedo de la cuerda de un tirón hacia el costado para que la Re al aire suene sola — sin un segundo golpe de púa.</li></ol>',
