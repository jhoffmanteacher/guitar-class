...
SETS.push(
...

  {
            ...
            steps: [
              {
                ...
                hint_es: 'Sigue la forma, no solo la escala — cuando el loop regresa a A, cae en una A y déjala sonar. Esa llegada es lo que significa "tocar los cambios."',
                skills: [7],
    ...
    assessment: {
      ...
      performance: 'Fast round: shuffle your five key flashcards and answer each relative minor in rhythm — no pauses, then flip to check. Then add the b5 to A minor pentatonic box 1 and play the blues scale ascending and descending at 60 BPM, matching the play button.',
    ...
    skills: [
      ...
      { id: 'm10w2-s6', text: 'Name relative pairs for our core songs\' keys (SNA Em↔G · Watchtower Am↔C · Sweet Child D↔Bm · Luna F↔Dm · Let It Be C↔Am)',
        text_es: 'Nombrar los pares relativos de las tonalidades de nuestras canciones principales (SNA Em↔G · Watchtower Am↔C · Sweet Child D↔Bm · Luna F↔Dm · Let It Be C↔Am)',
...

  {
            ...
            steps: [
              {
                ...
                levelUp_es: 'Extiende el eco a 4 o 5 notas, o repite un lick corto (un lick es una frase corta de solo) de un video tutorial que no hayas aprendido todavía — un patrón que de verdad nunca hayas escuchado. (Un compañero tocando patrones sorpresa también funciona.)',
                skills: [3, 5],
    ...
    assessment: {
      ...
      performance: 'Draw a key slip at random, slide box 1 to it, and play it. Then four echo rounds by ear — the play button for round 1, your own self-recorded random patterns for rounds 2–4 — singing each pattern back before you play it. Goal: 3 out of 4 matched correctly.',
    ...
    skills: [
      ...
      { id: 'm10w3-s3', text: 'Sing a short pattern, then find and play it on one string',
        ...
        practice: { type: 'mc', prompt: 'You sang a note and you\'re hunting for it on the B string. How do you know you\'ve found the right fret?',
          prompt_es: 'Cantaste una nota y la estás buscando en la cuerda B. ¿Cómo sabes que encontraste el traste correcto?',
      ...
      { id: 'm10w3-s4', text: 'Tell major from minor by ear',
        ...
        practice: { type: 'mc', prompt: 'A progression feels moody and dark. Its home chord is most likely:',
          ...
          choices_es: ['Mayor', 'Menor', 'Un acorde de potencia', 'Un acorde slash (con un bajo distinto)'], answer: 1 } },
