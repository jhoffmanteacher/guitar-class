...
SETS.push(
...

  {
    ...
    skills: [
      ...
      { id: 'm10w2-s6', text: 'Name relative pairs for our core songs\' keys ("Seven Nation Army" Em↔G · "Watchtower" Am↔C · "Luna" F↔Dm · "Let It Be" and "the cure" both C↔Am)',
        text_es: 'Nombrar los pares relativos de las tonalidades de nuestras canciones principales ("Seven Nation Army" Em↔G · "Watchtower" Am↔C · "Luna" F↔Dm · "Let It Be" y "the cure" ambas C↔Am)',
        gotItWhen: 'you can rattle off all four relative pairs that cover our core songs (Seven Nation Army Em↔G, Watchtower Am↔C, Luna F↔Dm, Let It Be and "the cure" both C↔Am) without looking any of them up.',
        gotItWhen_es: 'puedes recitar los cuatro pares relativos que cubren nuestras canciones principales (Seven Nation Army Em↔G, Watchtower Am↔C, Luna F↔Dm, Let It Be y "the cure" ambas C↔Am) sin consultar ninguno.',
