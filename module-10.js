...
SETS.push(
...

  {
    ...
    skills: [
      ...
      { id: 'm10w2-s6', text: 'Name relative pairs for our six core songs\' keys ("Seven Nation Army" Em↔G · "Watchtower" Am↔C · "Sweet Child" D↔Bm · "Luna" F↔Dm · "Let It Be" and "the cure" both C↔Am)',
        text_es: 'Nombrar los pares relativos de las tonalidades de nuestras seis canciones principales ("Seven Nation Army" Em↔G · "Watchtower" Am↔C · "Sweet Child" D↔Bm · "Luna" F↔Dm · "Let It Be" y "the cure" ambas C↔Am)',
        gotItWhen: 'you can rattle off all five relative pairs that cover our six core songs (Seven Nation Army Em↔G, Watchtower Am↔C, Sweet Child D↔Bm, Luna F↔Dm, Let It Be and "the cure" both C↔Am) without looking any of them up.',
        gotItWhen_es: 'puedes recitar los cinco pares relativos que cubren nuestras seis canciones principales (Seven Nation Army Em↔G, Watchtower Am↔C, Sweet Child D↔Bm, Luna F↔Dm, Let It Be y "the cure" ambas C↔Am) sin consultar ninguno.',
            ...
            steps: [
              {
                ...
                hint: 'You\'ve known these chord names since Module 5 (and G/B since Module 9) — today\'s challenge is trusting your ear to sort them into bright vs dark before you check.',
                hint_es: 'Conoces estos nombres de acordes desde el Módulo 5 (y G/B desde el Módulo 9) — el reto de hoy es confiar en tu oído para clasificarlos en brillante vs. oscuro antes de comprobarlo.',
