...
SETS.push(

  {
            ...
            steps: [
              {
                ...
                text: '<ul><li>Play the C major scale on the B string using the recipe, saying "whole, whole, half…" out loud as you go.</li></ul>',
                text_es: '<ul><li>Toca la escala de C mayor en la cuerda Si usando la receta, diciendo "tono, tono, semitono…" en voz alta mientras avanzas.</li></ul>',
                hint: 'Start on C (B string, fret 1) and let the recipe — not a chart — tell you where each next note lands. This is the string you just mapped in Module 9, so you can name every note you land on. The top C sits one fret past the fret-12 octave dot.',
                hint_es: 'Empieza en C (cuerda Si, traste 1) y deja que la receta — no un diagrama — te diga dónde cae cada siguiente nota. Esta es la cuerda que acabas de mapear en el Módulo 9, así que puedes nombrar cada nota donde caes. El C de arriba queda un traste después del punto de la octava en el traste 12.',
                ...
                skills: [1, 2],
                playSeq: { label: 'C major on the B string (recipe walk)', label_es: 'C mayor en la cuerda Si (caminata de la receta)', bpm: 60, notes: [60, 62, 64, 65, 67, 69, 71, 72] }
              },
              {
                label: 'Challenge 2 — G Major Walk', label_es: 'Reto 2 — Caminata de G Mayor',
                text: '<ol><li>Play the G major scale on the G string, open string to fret 12, using the same recipe.</li><li>Catch the one note that needs to be sharp.</li></ol>',
                text_es: '<ol><li>Toca la escala de G mayor en la cuerda Sol, de la cuerda al aire al traste 12, usando la misma receta.</li><li>Detecta la única nota que necesita ser sostenida.</li></ol>',
                hint: 'Everything is identical to the C major walk except one note — the recipe itself will tell you which. Start on the open G string and the whole scale fits inside the fretboard map from Module 9, landing on the fret-12 octave dot.',
                hint_es: 'Todo es idéntico a la caminata de C mayor excepto una nota — la receta misma te dirá cuál. Empieza en la cuerda Sol al aire y toda la escala cabe dentro del mapa del diapasón del Módulo 9, llegando al punto de la octava en el traste 12.',
                ...
                skills: [1, 3],
                playSeq: { label: 'G major on the G string', label_es: 'G mayor en la cuerda Sol', bpm: 60, notes: [55, 57, 59, 60, 62, 64, 66, 67] }
              }
            ]
          },
          {
    ...
    skills: [
      ...
      { id: 'm10w1-s2', text: 'Build a C major scale on one string using the recipe',
        ...
        gotItWhen: 'you can play all eight notes of the C major scale on the B string, starting at fret 1, saying "whole, whole, half…" out loud as you go, letting the recipe — not a chart — tell you where each note lands.',
        gotItWhen_es: 'puedes tocar las ocho notas de la escala de C mayor en la cuerda Si, empezando en el traste 1, diciendo "tono, tono, semitono…" en voz alta mientras avanzas, dejando que la receta — no un diagrama — te diga dónde cae cada nota.',
        practice: { type: 'playSeq', label: 'C major on the B string', label_es: 'C mayor en la cuerda Si', bpm: 60, notes: [60, 62, 64, 65, 67, 69, 71, 72] } },
      { id: 'm10w1-s3', text: 'Build a G major scale on one string and find the F#',
        ...
        gotItWhen: 'you can play the G major scale on the G string, open string up to fret 12, using the recipe and land on the one sharped note — F# — without being told which one it is.',
        gotItWhen_es: 'puedes tocar la escala de G mayor en la cuerda Sol, de la cuerda al aire hasta el traste 12, usando la receta y llegar a la única nota sostenida — F# — sin que te digan cuál es.',
...

  {
    ...
    unit_es: 'Módulo 10 · Escalas, tonalidades y entrenamiento auditivo',
    title: 'Set 2',
    subtitle: 'Every major key\'s minor twin · Relative vs parallel · Add the b5 = blues · Solo over a 12-bar blues',
    subtitle_es: 'La gemela menor de cada tonalidad mayor · Relativa vs. paralela · Agrega la b5 = blues · Improvisa sobre un blues de 12 compases',
    skillFocus: 'Relative minor = 3 frets down (the 6th degree) · Relative shares NOTES, parallel shares ROOT · Blues scale = minor pentatonic + b5 · The 12-bar blues form is where you use it',
    skillFocus_es: 'La relativa menor = 3 trastes abajo (el 6º grado) · La relativa comparte NOTAS, la paralela comparte RAÍZ · La escala de blues = pentatónica menor + b5 · La forma de blues de 12 compases es donde se usa',
    comingSoon: false,
            ...
            steps: [
              {
                ...
                response: { type: 'mc', prompt: 'Relative minor vs parallel minor — the difference is:',
                  ...
                  answer: 0,
                  explain: 'The key of A minor uses the exact same seven notes as C major — that is what relative means. The key of C minor shares only its root with C major and changes three of the notes — that is parallel. Swapping the two definitions is the easy slip, and they are not two names for one thing: relative and parallel point at different keys.',
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text: 'Work out which pentatonic scale "Luna"\'s solo lives in, even though the song is in F major, using what you just learned about relative keys. Count 3 frets down from F and name what you land on.',
                text_es: 'Descubre en qué escala pentatónica vive el solo de "Luna", aunque la canción esté en F mayor, usando lo que acabas de aprender sobre tonalidades relativas. Cuenta 3 trastes hacia abajo desde F y nombra dónde caes.',
            ...
            steps: [
              {
                ...
                hint_es: 'Fíjate en las notas del riff: G, Bb, C, y ese Db antes de volver a C. Son las primeras cuatro notas de la escala de blues de G — y el Db ES la b5, la nota que acabas de agregar. El riff no solo vive en el mismo mundo que esta escala; está hecho de ella.',
    ...
    skills: [
      ...
      { id: 'm10w2-s3', text: 'Name "Watchtower"\'s key from its chords, and give its relative major',
        text_es: 'Nombrar la tonalidad de "Watchtower" a partir de sus acordes, y dar su relativa mayor',
        gotItWhen: 'you can work out "Watchtower"\'s key from its chords, give its relative major, and explain how you got there — count 3 frets up from the minor root.',
        gotItWhen_es: 'puedes deducir la tonalidad de "Watchtower" a partir de sus acordes, dar su relativa mayor, y explicar cómo llegaste ahí — cuenta 3 trastes arriba desde la raíz menor.',
      ...
      { id: 'm10w2-s6', text: 'Name relative pairs for five of our six core songs\' keys ("Seven Nation Army" Em↔G · "Watchtower" Am↔C · "Luna" F↔Dm · "Let It Be" and "the cure" both C↔Am)',
        ...
        gotItWhen: 'you can rattle off all four relative pairs that cover five of our six core songs (Seven Nation Army Em↔G, Watchtower Am↔C, Luna F↔Dm, Let It Be and "the cure" both C↔Am) without looking any of them up.',
        gotItWhen_es: 'puedes recitar los cuatro pares relativos que cubren cinco de nuestras seis canciones principales (Seven Nation Army Em↔G, Watchtower Am↔C, Luna F↔Dm, Let It Be y "the cure" ambas C↔Am) sin consultar ninguno.',
      ...
      { id: 'm10w2-s7', text: 'Solo with the blues scale over a 12-bar blues loop, following the form',
        ...
        gotItWhen: 'you can hear the chord changes coming and land on a strong note when the loop returns to the home chord.',
        gotItWhen_es: 'puedes escuchar los cambios de acorde venir y caer en una nota fuerte cuando el loop regresa al acorde base.',
...

  {
            ...
            steps: [
              ...
              },
              {
                ...
                response: { type: 'mc', prompt: 'The best FIRST step to playing a melody by ear is:',
                  ...
                  answer: 1,
                  explain: 'If you can sing it, you already know it — your hands just have to find what your voice has solved. Reading the TAB works, but it is not playing by ear; hunting fret by fret from the bottom of the neck is slow and teaches you nothing about the tune; and working out the key is useful later, not as the first move.',
                  explain_es: 'Si puedes cantarla, ya te la sabes — tus manos solo tienen que encontrar lo que tu voz ya resolvió. Leer el TAB funciona, pero eso no es tocar de oído; buscar traste por traste desde abajo del mástil es lento y no te enseña nada de la melodía; y deducir la tonalidad sirve más adelante, no como primer movimiento.',
                  choices: ['Work out the key, then play the scale it comes from', 'Sing it, then hunt for it on one string', 'Look up the TAB and read it note by note', 'Start at the lowest fret and work upward'],
                  choices_es: ['Deducir la tonalidad y tocar la escala de la que viene', 'Cantarla, y luego buscarla en una sola cuerda', 'Buscar el TAB y leerlo nota por nota', 'Empezar en el traste más bajo e ir subiendo'] }
              },
              {
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                hint: 'Half steps are just frets. Work out how many frets two of them add up to, and which direction along the neck raises the pitch.',
                hint_es: 'Los semitonos son solo trastes. Descubre cuántos trastes suman dos de ellos, y qué dirección del mástil sube el tono.',
                skills: [2],
            ...
            steps: [
              {
                ...
                hint: 'You\'ve known these chord names since Module 5 — today\'s challenge is trusting your ear to sort them into bright vs dark before you check.',
                hint_es: 'Conoces estos nombres de acordes desde el Módulo 5 — el reto de hoy es confiar en tu oído para clasificarlos en brillante vs. oscuro antes de comprobarlo.',
    ...
    skills: [
      ...
      { id: 'm10w3-s2', text: 'Move a riff up or down the neck to a new key and play it',
        ...
        gotItWhen: 'you can move a riff to a new key and play it, with every fret distance inside the riff staying exactly as it was.',
      ...
      { id: 'm10w3-s3', text: 'Sing a short pattern, then find and play it on one string',
        ...
        gotItWhen: 'you sing a pattern first, then find its matching frets on one string by ear, and you can tell the moment the pitch is exactly right.',
        gotItWhen_es: 'cantas un patrón primero, y luego encuentras sus trastes correspondientes en una sola cuerda de oído, y sabes reconocer el momento en que el tono queda exacto.',
