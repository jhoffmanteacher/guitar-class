...

  {
            ...
            steps: [
              {
                ...
                text_es: 'Reto 3 — Ejercicio relámpago (tu pieza de evaluación): haz tarjetas — escribe cada nombre de nota natural (de A a G) en su propia tira de papel, barájalas boca abajo, y saca una a la vez. Encuentra cada nota sacada en la cuerda D o G en menos de 5 segundos, cambiando de cuerda cada 5 tarjetas. Lo tienes cuando: 8 de 10 correctas en menos de 5 segundos cada una, en ambas cuerdas. ¿Tienes a alguien cerca? Que te diga las notas en vez de sacar tarjetas.',
    ...
    skills: [
      { id: 'm9w1-s1', text: 'Name the natural notes on the D string, frets 0–12, in order',
        ...
        practice: { type: 'playSeq', label: 'D-string naturals, low to high', label_es: 'Notas naturales de la cuerda D, de grave a aguda', bpm: 60, notes: [50, 52, 53, 55, 57, 59, 60, 62] } },
      { id: 'm9w1-s2', text: 'Name the natural notes on the G string, frets 0–12, in order',
        ...
        practice: { type: 'playSeq', label: 'G-string naturals, low to high', label_es: 'Notas naturales de la cuerda G, de grave a aguda', bpm: 60, notes: [55, 57, 59, 60, 62, 64, 65, 67] } },
...

  {
    ...
    skills: [
      { id: 'm9w2-s1', text: 'Name the natural notes on the B string, frets 0–12, in order',
        ...
        practice: { type: 'playSeq', label: 'B-string naturals', label_es: 'Notas naturales de la cuerda B', bpm: 60, notes: [59, 60, 62, 64, 65, 67, 69, 71] } },
      { id: 'm9w2-s2', text: 'Name the natural notes on the high e string and explain why they match the low E',
        ...
        practice: { type: 'mc', prompt: 'Why do the two E strings share the same note names?',
          prompt_es: '¿Por qué las dos cuerdas E comparten los mismos nombres de nota?',
          choices: ['They\'re the two thickest strings', 'They\'re both tuned to E, two octaves apart', 'It\'s a coincidence', 'They don\'t — they\'re different'],
          choices_es: ['Son las dos cuerdas más gruesas', 'Ambas están afinadas en E, separadas por dos octavas', 'Es una coincidencia', 'No coinciden — son distintas'], answer: 1 } },
