            ...
            steps: [
              {
                ...
                hint: 'Punteo = the picked melody line, a Spanish guitar term. Layer 6 is the bonus requinto-intro layer — a requinto is a small, higher-pitched guitar that plays the lead melody. This roll uses the little-F shape you already know from Module 5 — today\'s new skill is being able to name every note in it.',
                hint_es: 'Punteo = la línea melódica punteada, un término de guitarra en español. La Capa 6 es la capa bonus de intro con requinto — un requinto es una guitarra pequeña y más aguda que toca la melodía principal. Este roll usa la forma de F pequeña que ya conoces del Módulo 5 — la destreza nueva de hoy es poder nombrar cada nota dentro de ella.',
