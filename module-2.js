            ...
            steps: [
              {
                ...
                text: 'Challenge 2 — A String Run (your Set 1 check-off):<ol><li>Same run on the A string, without looking at the chart — A · B · C · D · E · F · G · A.</li><li>Up to fret 12 and back, one note per beat.</li></ol>You\'ve got it when: a clean lap with the metronome and no stalls.<span class="step-figure"><img src="img/m2-a-naturals.svg" alt="A fretboard diagram of the A string, frets 0 to 12, with the natural notes marked: A open, B at fret 2, C at fret 3, D at fret 5, E at fret 7, F at fret 8, G at fret 10, and A again at fret 12."></span>',
                text_es: 'Reto 2 — Recorrido de la cuerda La (tu evaluación de la Unidad 1):<ol><li>El mismo recorrido en la cuerda La, sin mirar la tabla — A · B · C · D · E · F · G · A.</li><li>Hasta el traste 12 y de regreso, una nota por pulso.</li></ol>Lo tienes cuando: una vuelta limpia con el metrónomo y sin trabarte.<span class="step-figure"><img src="img/m2-a-naturals.svg" alt="Un diagrama del diapasón de la cuerda La, trastes 0 a 12, con las notas naturales marcadas: A al aire, B en el traste 2, C en el 3, D en el 5, E en el 7, F en el 8, G en el 10, y A de nuevo en el traste 12."></span>',
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text: 'Challenge — "Let It Be," bass line: play the roots of "Let It Be" (Beatles) on the low E & A strings — C · G · A · F, two beats each at 60 BPM. These four notes are the simple bass outline of the whole song, so learn where its roots live now. You\'ve got it when: two clean laps of C–G–A–F, every note ringing, each landing on the beat.',
