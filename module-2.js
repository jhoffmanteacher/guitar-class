...
SETS.push(
  ...
  {
    id: 'm2w1',
    songThread: [{ name: '"Seven Nation Army"', journey: 'tabs/seven-nation-army.html', layer: 2, note: 'the riff, note by note' }],
    label: 'Set 1',
    locked: false,
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                response: { type: 'short', placeholder: 'Which two notes sound the same? Name the frets.',
                  placeholder_es: '¿Qué dos notas suenan igual? Nombra los trastes.' }
              },
              {
                ...
                hint: 'The riff opens on fret 7 (E), reaches up to fret 10 (G), then walks down — 5, 3 and 2 are D, C and B. To fret a note, set your fingertip just behind the fret and press firm; if it buzzes, move a little closer to the fret or press harder.',
                hint_es: 'El riff abre en el traste 7 (E), estira hasta el traste 10 (G), y luego va bajando — el 5, el 3 y el 2 son D, C y B. Para trastear una nota, coloca la punta del dedo justo detrás del traste y presiona firme; si zumba, acércate un poco más al traste o presiona más fuerte.',
              ...
              },
              {
                ...
                hint: 'Say it out loud a few times a day.',
                hint_es: 'Dilo en voz alta varias veces al día.',
                skills: [1]
              }
            ]
          },
            ...
            steps: [
              {
                ...
                hint: 'Peek at the chart only if you\'re truly stuck. Set the ⏱ Timer (bottom of the screen) to 2 min and count how many clean laps you fit before it beeps — try for a higher number next session.',
                hint_es: 'Mira la tabla solo si de verdad estás atascado. Pon el ⏱ Temporizador (abajo en la pantalla) en 2 min y cuenta cuántas vueltas limpias logras antes de que suene — intenta superar el número la próxima sesión.',
                stuck: 'Learn frets 0–5 (E–A) without looking at the chart first, then add 7–12 once those are automatic.',
                stuck_es: 'Aprende primero los trastes 0–5 (E–A) sin mirar la tabla, y luego agrega 7–12 una vez que esos sean automáticos.',
              ...
              },
              {
                ...
                text: 'Name That Riff: pick out the "Smoke on the Water" main riff (a riff = a short musical phrase that repeats) by ear on the low E string. No score — just try it.',
                text_es: 'Adivina el riff: saca de oído el riff principal de "Smoke on the Water" (un riff = una frase musical corta que se repite) en la cuerda Mi grave. Sin puntaje — solo pruébalo.',
                hint: 'Use the low-E note map from the play-along step (frets 0 · 1 · 3 · 5 · 7 · 8 · 10 · 12).',
                hint_es: 'Usa el mapa de notas de la Mi grave del paso para tocar junto (trastes 0 · 1 · 3 · 5 · 7 · 8 · 10 · 12).',
            ...
            steps: [
              {
                ...
                text: '<ul><li>A beat is one click of the metronome.</li><li>Start the metronome at 60 and count the clicks out loud: 1 &middot; 2 &middot; 3 &middot; 4, then 1 again.</li><li>Four beats is one <strong>bar</strong> — that is what a bar means, four clicks counted 1 to 4.</li><li>Start playing on a "1", not in the middle of a count.</li><li>Now play the same run on the A string without looking at the chart — A · B · C · D · E · F · G · A — up to fret 12 and back, one note per beat.</li></ul>You\'ve got it when: a clean lap with the metronome and no stalls.<span class="step-figure"><img src="img/m2-a-naturals.svg" alt="A fretboard diagram of the A string, frets 0 to 12, with the natural notes marked: A open, B at fret 2, C at fret 3, D at fret 5, E at fret 7, F at fret 8, G at fret 10, and A again at fret 12." width="640" height="244"></span>',
                text_es: '<ul><li>Un pulso es un clic del metrónomo.</li><li>Pon el metrónomo en 60 y cuenta los clics en voz alta: 1 &middot; 2 &middot; 3 &middot; 4, y otra vez 1.</li><li>Cuatro pulsos son un <strong>compás</strong> — eso es lo que significa un compás, cuatro clics contados del 1 al 4.</li><li>Empieza a tocar en un "1", no a mitad de la cuenta.</li><li>Ahora toca el mismo recorrido en la cuerda La sin mirar la tabla — A · B · C · D · E · F · G · A — hasta el traste 12 y de regreso, una nota por pulso.</li></ul>Lo tienes cuando: una vuelta limpia con el metrónomo y sin trabarte.<span class="step-figure"><img src="img/m2-a-naturals.svg" alt="Un diagrama del diapasón de la cuerda La, trastes 0 a 12, con las notas naturales marcadas: A al aire, B en el traste 2, C en el 3, D en el 5, E en el 7, F en el 8, G en el 10, y A de nuevo en el traste 12." width="640" height="244"></span>',
              ...
              },
              {
                ...
                text: 'Shuffle self-quiz:<ol><li>The deck below deals you a random fret on the A string.</li><li>Say the note out loud, then press it, before the ring runs out — five seconds a card, ten rounds.</li><li>Miss one and it comes back later in the ten.</li></ol>You\'ve got it when: 9 of 10 — check the skill off right there.',
                text_es: 'Autoevaluación con cartas:<ol><li>La baraja de abajo te reparte un traste al azar en la cuerda La.</li><li>Di la nota en voz alta y luego presiónala, antes de que el círculo se acabe — cinco segundos por carta, diez rondas.</li><li>Si fallas una, vuelve a salir más adelante.</li></ol>Lo tienes cuando: 9 de 10 — marca la destreza ahí mismo.',
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text: '<ul><li>Play the riff on the A string — frets 7 → 7 → 10 → 7, then 5 → 3 → 2.</li><li>Say each note name out loud as you play it — E · E · G · E · D · C · B.</li></ul>You\'ve got it when: all seven notes in the right order, each one ringing clean, every name said correctly. Speed comes later. <a href="tabs/seven-nation-army.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 2 of 5</a>.',
    ...
    skills: [
      ...
      { id: 'm2w1-s5', text: 'Read a basic fretboard note-name chart',
        ...
        gotItWhen: 'you can use the chart to look up a note you don\'t know yet — you can say what each row and column stands for.',
        gotItWhen_es: 'puedes usar la tabla para buscar una nota que todavía no sabes — puedes decir qué representa cada fila y columna.',
  ...
  {
    id: 'm2w2',
    songThread: [{ name: '"All Along the Watchtower"', journey: 'tabs/all-along-the-watchtower.html', layer: 2, note: 'Assessment preparation: the low-E riff' }, { name: '"Seven Nation Army"', journey: 'tabs/seven-nation-army.html', layer: 2, note: 'Assessment preparation: the A-string riff' }, { name: '"Sweet Child O\' Mine"', journey: 'tabs/sweet-child-o-mine.html', layer: 2, note: 'the bass roots' }, { name: '"Luna"', journey: 'tabs/luna.html', layer: 2, note: 'the single-note line' }, { name: '"Let It Be"', journey: 'tabs/let-it-be.html', layer: 2, note: 'the C–G–A–F bass outline' }],
    label: 'Set 2',
    locked: false,
    module: 'Notes on the E & A Strings',
    moduleNum: 2,
            ...
            steps: [
              {
                ...
                hint: 'Try each exercise slowly on your guitar as she demonstrates.',
                hint_es: 'Prueba cada ejercicio despacio en tu guitarra mientras ella lo demuestra.',
                skills: [1, 2, 3],
                response: { type: 'short', placeholder: 'Which exercise was hardest? Which finger buzzed?',
                  placeholder_es: '¿Qué ejercicio fue más difícil? ¿Qué dedo zumbó?' }
              },
              {
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                hint: 'Most beginners press too hard.',
                hint_es: 'La mayoría de los principiantes presiona demasiado fuerte.',
                skills: [1, 2],
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            levelUp: 'Run the same 1-2-3-4 pattern starting at fret 5, where the stretches are smaller — which frets are easier to reach?',
            levelUp_es: 'Haz el mismo patrón 1-2-3-4 empezando en el traste 5, donde los estiramientos son más pequeños — ¿qué trastes son más fáciles de alcanzar?',
            skills: [1, 2, 3, 6]
          },
          {
          ...
          },
          {
            ...
            skills: [1, 2, 4, 5, 6],
            tab: {
              caption: '"All Along the Watchtower" — bass-note riff · Low E string · A A G G F F F G · loops · 60 BPM',
              caption_es: '"All Along the Watchtower" — riff de bajo · cuerda Mi grave · A A G G F F F G · en bucle · 60 BPM',
              notes: [
                { string: 'E', fret: 5, note: 'A', midi: 45 },
                { string: 'E', fret: 5, note: 'A', midi: 45 },
                { string: 'E', fret: 3, note: 'G', midi: 43 },
          ...
          },
          {
            ...
            hint: 'Bottom line = low E, the line above it = A, the next one up = D. Every fret here is 0–3 on the A and D strings. Say each note name before you pluck it, then use ▶ Play tab as your answer key — only after you\'ve played it yourself.',
            hint_es: 'Línea de abajo = Mi grave, la línea justo encima = La, la siguiente hacia arriba = Re. Cada traste aquí es 0–3 en las cuerdas La y Re. Di cada nombre de nota antes de pulsarla, y luego usa ▶ Tocar el tab como tu clave de respuestas — solo después de haberla tocado tú.',
            ...
            steps: [
              {
                ...
                text: '<ul><li>Play the "All Along the Watchtower" bass loop on the low E string — A twice, G twice, F three times, then the last G once — one note per beat at 60 BPM, four laps without stopping.</li></ul>You\'ve got it when: four laps, every note landing on the click. <a href="tabs/all-along-the-watchtower.html" target="_blank">&#x1F9F5; Song Journey: this is Layer 2 of 5</a>.',
                text_es: '<ul><li>Toca el bucle de bajo de "All Along the Watchtower" en la cuerda Mi grave — A dos veces, G dos veces, F tres veces y la última G una vez — una nota por pulso a 60 BPM, cuatro vueltas sin parar.</li></ul>Lo tienes cuando: cuatro vueltas, cada nota cayendo con el clic. <a href="tabs/all-along-the-watchtower.html" target="_blank">&#x1F9F5; Recorrido de la canción: esto es la Capa 2 de 5</a>.',
                ...
                skills: [1, 2, 4, 5, 6],
                tab: {
                  caption: '"All Along the Watchtower" — bass loop · Low E string · A A G G F F F G · 60 BPM',
                  caption_es: '"All Along the Watchtower" — bucle de bajo · cuerda Mi grave · A A G G F F F G · 60 BPM',
                  notes: [
                    { string: 'E', fret: 5, note: 'A', midi: 45 },
                    { string: 'E', fret: 5, note: 'A', midi: 45 },
                    { string: 'E', fret: 3, note: 'G', midi: 43 },
              ...
              },
              {
                ...
                hint: 'You know this riff from Set 1. The metronome now sets the timing: land each note right on the beat, and give the last note its full beat before the riff comes round again.',
                hint_es: 'Ya conoces este riff de la Unidad 1. Ahora el metrónomo marca el tiempo: cae en cada nota justo en el pulso, y dale a la última nota su pulso completo antes de que el riff vuelva a empezar.',
              ...
              },
              {
                ...
                tab: {
                  ...
                  phrases: [
                    ...
                    {
                      label: 'Chorus on two strings — D F C G, D F C G',
                      label_es: 'Coro en dos cuerdas — D F C G, D F C G',
                      notes: [
                        { string: 'A', fret: 5, note: 'D', midi: 50 },
                        { string: 'A', fret: 5, note: 'D', midi: 50 },
                        { string: 'A', fret: 5, note: 'D', midi: 50 },
    ...
    skills: [
      { id: 'm2w2-s1', text: 'Press notes cleanly — no buzzing — by pressing just behind the fret',
        ...
        gotItWhen: 'you play frets 1–4 on the E string, one finger per fret, and every note sustains cleanly — no buzzing, no muffling.',
        gotItWhen_es: 'tocas los trastes 1–4 en la cuerda Mi, un dedo por traste, y cada nota suena limpia y sostenida — sin zumbido, sin apagarse.',
      ...
      { id: 'm2w2-s4', text: 'Sight-read a basic 2-bar TAB line (strings, fret numbers, left-to-right order)',
        ...
        gotItWhen_es: 'puedes ver una línea corta de TAB que no has practicado, encontrar la cuerda y el traste de cada número, y tocarla — eso es lectura a primera vista.',
        practice: { type: 'mc',
...
MODULE_SONGS[2] = [
      { name: '"All Along the Watchtower" — Dylan / Hendrix', meta: 'Assessment preparation: the low-E riff, played from memory', meta_es: 'Preparación para la evaluación: el riff de Mi grave, de memoria', type: 'Core', core: true, journeyUrl: 'tabs/all-along-the-watchtower.html',
        originalUrl: 'https://www.youtube.com/watch?v=bT7Hj-ea0VE',
        tutorialUrl: 'https://www.youtube.com/watch?v=Tnm1jWVLaC8' },
      { name: '"Seven Nation Army" — The White Stripes', meta: 'Assessment preparation: the A-string riff, in time with the metronome', meta_es: 'Preparación para la evaluación: el riff de la cuerda La, a tiempo con el metrónomo', type: 'Core', core: true, journeyUrl: 'tabs/seven-nation-army.html',
...
MODULE_REVIEWS[2] = {
  ...
  forward: 'The E &amp; A notes you just learned become the <strong>roots of every power chord in Module 3</strong> — when you play an A5 or G5, you\'re landing on the exact frets you just memorized.',
  forward_es: 'Las notas de Mi y La que acabas de aprender se convierten en las <strong>raíces de todos los acordes de potencia del Módulo 3</strong> — cuando tocas un A5 o un G5, estás cayendo exactamente en los trastes que acabas de memorizar.',
