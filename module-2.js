        ...
        sections: [
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text: 'Watch: <a href="https://www.youtube.com/watch?v=qR0O0bUl5_A" target="_blank">How to Read Guitar TAB – Lauren Bateman (0:00–4:00)</a>.<span class="step-figure"><img src="img/m2-tab-orientation-en.svg" alt="A TAB staff with its six lines labeled: the top line is the thinnest string, high e, and the bottom line is the thickest string, low E."></span>',
                text_es: 'Mira: <a href="https://www.youtube.com/watch?v=qR0O0bUl5_A" target="_blank">How to Read Guitar TAB – Lauren Bateman (0:00–4:00)</a>.<span class="step-figure"><img src="img/m2-tab-orientation-es.svg" alt="Un TAB con sus seis líneas marcadas: la línea de arriba es la cuerda más delgada, la mi aguda, y la línea de abajo es la más gruesa, la Mi grave."></span>',
    ...
    skills: [
      ...
      { id: 'm2w2-s4', text: 'Sight-read a basic 2-bar TAB line (strings, fret numbers, left-to-right order)',
        ...
        practice: { type: 'mc',
          ...
          explain: 'The A string open is A, and counting up three frets runs A–A#–B–C, so fret 3 is C. B is the near-miss: it\'s only two frets up, at fret 2.',
          explain_es: 'La cuerda La al aire es A, y contando tres trastes hacia arriba va A–A#–B–C, así que el traste 3 es C. B es el casi-acierto: está solo dos trastes arriba, en el traste 2.' } },
