...

  {
            ...
            steps: [
              {
                ...
                text_es: 'Adelanto para tocar junto: mantén abierta tu tabla de nombres de notas y toca despacio hacia arriba en la cuerda Mi grave junto con el audio, trastes 0–12 — E · F · G · A · B · C · D · E — diciendo cada nombre en voz alta. Apóyate en la tabla aquí; lo harás de memoria en la estación de práctica.',
            ...
            steps: [
              {
                ...
                text_es: 'Reto 1 — Recorrido de la Mi grave: toca cada nota natural hacia arriba en la cuerda Mi grave y de regreso — E · F · G · A · B · C · D · E — diciendo cada nombre en voz alta. Lo tienes cuando: una vuelta limpia (una vuelta = una pasada completa) sin mirar la tabla, sin errores.',
    ...
    skills: [
      ...
      { id: 'm2w1-s2', text: 'Name all natural notes on the E string (frets 0–12)',
        ...
        practice: { type: 'playSeq', label: 'Play E string 0–12', label_es: 'Toca la cuerda Mi 0–12', bpm: 60,
      ...
      { id: 'm2w1-s3', text: 'Name all natural notes on the A string (frets 0–12)',
        ...
        practice: { type: 'playSeq', label: 'Play A string 0–12', label_es: 'Toca la cuerda La 0–12', bpm: 60,
        ...
        sections: [
          {
            ...
            steps: [
              ...
              },
              {
                ...
                text_es: 'Mira: <a href="https://youtu.be/IscDj_-Nr0s" target="_blank">Finger Placement to Avoid Fret Buzz (BC-106) – JustinGuitar</a> (0:00–4:00).',
              ...
              },
              {
                ...
                text_es: 'Mira: <a href="https://www.youtube.com/watch?v=qR0O0bUl5_A" target="_blank">How to Read Guitar TAB – Lauren Bateman (0:00–4:00)</a>.',
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
          {
            ...
            text_es: 'Reto 1 — Ejercicio de dedos: toca los trastes 1–5 en la cuerda Mi grave, un dedo por traste, y luego lo mismo en la cuerda La. Mantén el pulgar detrás del mástil. Lo tienes cuando: cada nota suena limpia sin zumbido.',
          ...
          },
          {
            ...
            text_es: 'Revisión de un dedo por traste: índice=1, medio=2, anular=3, meñique=4 subiendo la cuerda Mi grave. Cada nota suena — nada zumba ni se apaga. Haz clic para escuchar el tono objetivo limpio.',
          ...
          },
          {
            ...
            response: { type: 'mc', prompt: 'In TAB the bottom line is the low E string and the line above it is the A string. A "3" on the A-string line is which note?',
              prompt_es: 'En el TAB la línea de abajo es la cuerda Mi grave y la línea de arriba es la cuerda La. Si ves un "3" en la línea de la cuerda La, ¿qué nota es?',
              answer: 1,
    ...
    skills: [
      ...
      { id: 'm2w2-s4', text: 'Sight-read a basic 2-bar TAB line (strings, fret numbers, left-to-right order)',
        ...
        practice: { type: 'mc',
          ...
          prompt_es: 'En el TAB, la línea de abajo es la cuerda Mi grave y la línea de arriba es la cuerda La. Si ves un "3" en la línea de la cuerda La, ¿qué nota tocas?',
...
MODULE_SONGS[2] = [
      ...
      { name: '"Sweet Child O\' Mine" — Guns N\' Roses', meta: 'Play verse bass roots on E & A strings · intro riff = optional harder challenge in Module 7', meta_es: 'Toca las notas graves del verso en las cuerdas Mi y La · el riff de la intro es un reto opcional más difícil en el Módulo 7', type: 'Core', core: true, journeyUrl: 'tabs/sweet-child-o-mine.html',
