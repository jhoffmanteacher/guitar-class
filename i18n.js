...
(function(){
  ...
  /* ── GLOSSARY — one fixed Spanish term per recurring pedagogy word.
     ...
     rather than picking a fresh synonym.
       ...
       performance song (the piece a student  → canción de interpretación
         prepares and plays start to finish)    (site-wide, Jonathan 2026-08-07.
                                               "showcase song" / "canción de
                                               presentación" and "la muestra"
                                               are both RETIRED — Module 12 was
  ...
  */
  const I18N = {
    ...
    'auth.body':          { en: 'Sign in with your school Google account to use the class site.',
                             es: 'Inicia sesión con tu cuenta de Google de la escuela para usar el sitio de la clase.' },
    ...
    'progress.skillsMastered': { en: '{done} of {total} skills checked off in all {modules} modules.',
                                 es: '{done} de {total} destrezas marcadas en los {modules} módulos.' },
    ...
    'tools.ladderDown':    { en: 'Back to {bpm} BPM — get it clean here first', es: 'Bajamos a {bpm} BPM — hazlo limpio aquí primero' },
    ...
    'search.intro':          { en: 'Search every In-class activity, and every step, skill, and set across all {n} modules.',
                                es: 'Busca en cada actividad de clase y en cada paso, destreza y unidad de los {n} módulos.' },
    'search.whereActivity':  { en: 'In class', es: 'En clase' },
    ...
    'search.count':          { en: '{n} matches', es: '{n} resultados' },
    'search.countCapped':    { en: 'Top {shown} of {n} matches', es: 'Los {shown} mejores de {n} resultados' },
    'search.loose':          { en: 'Nothing matched every word in “{q}” — closest matches:',
    ...
    'review.tag':            { en: 'Module {n} review', es: 'Repaso del módulo {n}' },
    'review.rateReflect':    { en: "Rate yourself on each skill. Then answer the two questions.",
                                es: 'Califícate en cada destreza. Luego responde las dos preguntas.' },
    'review.whatClicked':    { en: "What can you play now that you couldn't before?", es: '¿Qué puedes tocar ahora que antes no podías?' },
    ...
    'review.playRecord':     { en: 'Play it and record it', es: 'Tócala y grábate' },
    'review.playPrompt':     { en: 'Play a song from this module — a core song, or one of your choice that uses these skills. Listen back. Write one thing to fix.',
                                es: 'Toca una canción de este módulo — una canción principal, o una de tu elección que use estas destrezas. Escucha tu grabación. Escribe una cosa para mejorar.' },
    'review.songIPlayed':    { en: 'Song I played', es: 'Canción que toqué' },
    'review.howDidItGo':     { en: 'What will you fix next time?', es: '¿Qué vas a mejorar la próxima vez?' },
    ...
    'review.assessPopIntro': { en: "Heads up — here's what you'll play for your teacher when you sign up for the Module {n} assessment:",
                                es: 'Atención: esto es lo que tocarás para tu maestro cuando te apuntes para la evaluación del módulo {n}:' },
    'review.assessPopIntroDflt':{ en: 'Heads up — the Module {n} assessment asks you to perform the skills on this page for your teacher, in person.',
    ...
    'review.whyMatters':     { en: 'Coming up', es: 'Lo que sigue' },
    'review.previewOnly':    { en: 'Preview only.', es: 'Solo vista previa.' },
    'review.previewBodyHtml':{ en: 'Mark every skill on every set as &ldquo;I&rsquo;ve got it!&rdquo; to open this review.',
                                es: 'Marca cada destreza de cada unidad como &ldquo;¡Ya lo tengo!&rdquo; para abrir este repaso.' },
    ...
    'routine.foot':          { en: "Built from this module's sets — short on time? Do steps 1–3.",
                                es: 'Armada con las unidades de este módulo — ¿poco tiempo? Haz los pasos 1–3.' },
    ...
    'fret.praiseLow':        { en: 'go again when you’re ready.', es: 'repite cuando estés listo.' },
    ...
    'drill.intro':           { en: 'Say the note out loud, then press the button.',
                               es: 'Di la nota en voz alta y luego presiona el botón.' },
    ...
    'deck.introOne':         { en: 'The deck deals you one card at a time, shuffled. Do what it says, then move on — miss one and it comes back later in the run.',
                               es: 'La baraja te reparte una carta a la vez, barajada. Haz lo que dice y sigue — si fallas una, vuelve más adelante en la vuelta.' },
    ...
    'deck.best':             { en: 'Best: {n}/{total}', es: 'Mejor: {n}/{total}' },
    'deck.scoreSub':         { en: 'right on the first deal', es: 'correctas al primer reparto' },
    'deck.verdictGood':      { en: 'Clean run — every card first try.', es: 'Vuelta limpia — cada carta al primer intento.' },
    'deck.verdictMid':       { en: 'Shuffle and run it again.', es: 'Baraja y hazlo de nuevo.' },
    ...
    'ear.start':             { en: 'Deal and play', es: 'Repartir y tocar' },
    'ear.named':             { en: '{n} / {total} named', es: '{n} / {total} nombradas' },
    'ear.playAgain':         { en: 'Play again', es: 'Tocar de nuevo' },
    'ear.hearAgain':         { en: 'Hear it again', es: 'Escuchar de nuevo' },
    'ear.undo':              { en: 'Undo', es: 'Deshacer' },
    'ear.check':             { en: 'Check my answers', es: 'Revisar mis respuestas' },
    'ear.revealed':          { en: 'Revealed', es: 'Revelado' },
    'ear.dealMore':          { en: 'Deal again', es: 'Repartir de nuevo' },
    ...
    'review.explainer':      { en: 'Play each skill once to keep it fresh.',
                               es: 'Toca cada destreza una vez para mantenerla fresca.' },
    ...
    'gate.reviewPreviewTitle': { en: 'Preview only — finish marking every skill on every set as "I\'ve got it!" to open this review.',
                               es: 'Solo vista previa — termina de marcar cada destreza de cada unidad con "¡Ya lo tengo!" para abrir este repaso.' },
    ...
    /* Song-list badges. All four agree with "canción" (feminine). "Complementaria"
       is Jonathan's call (2026-08-08) over the shorter "Extra" — it's the widest
    ...
    'sr.tagline':             { en: 'Play a skill you already learned, one more time.',
                               es: 'Toca una destreza que ya aprendiste, una vez más.' },
    ...
    'coach.chip.loose': { en: 'counted — but off the beat',
      es: 'contó — pero fuera del tiempo' },
    ...
    'app.title': { en: 'Guitar Class · Sequoia HS',
      es: 'Clase de guitarra · Sequoia HS' },
    'coach.close': { en: 'Close',
      es: 'Cerrar' },
    'coach.loadFailed': { en: "The Listening Coach didn't load — check your connection and try again.",
      es: 'El Entrenador de Escucha no se cargó — revisa tu conexión e inténtalo de nuevo.' },
    ...
    'coach.crit.completion.gaps': { en: 'Lots of gaps in that try — drop the BPM and play it again.',
      es: 'Hubo muchos huecos en ese intento — baja el BPM e inténtalo de nuevo.' },
    'coach.crit.completion.great': { en: 'Start to finish with no stops.',
      es: 'De principio a fin sin parar.' },
    ...
    'coach.crit.pitch.closeQuietChords': { en: 'Every strum I heard clearly sounded right — {good} of {total} — but the mic didn’t hear the rest. That’s usually volume, not your fingers: strum every beat at the same volume.',
      es: 'Cada rasgueo que escuché con claridad sonó correcto — {good} de {total} — pero el micrófono no captó el resto. Eso normalmente es volumen, no tus dedos: rasguea cada tiempo con el mismo volumen.' },
    'coach.crit.pitch.closeQuietMelody': { en: 'Every note I heard clearly was right — {good} of {total} — but the mic didn’t hear the rest. That’s usually volume, not your fingers: pluck every note at the same volume.',
      es: 'Cada nota que escuché con claridad fue correcta — {good} de {total} — pero el micrófono no captó el resto. Eso normalmente es volumen, no tus dedos: toca cada nota con el mismo volumen.' },
    ...
    'coach.crit.pitch.greatChords': { en: 'The chord tones sounded correct on {good} of {total} beats.',
      es: 'Las notas del acorde sonaron bien en {good} de {total} tiempos.' },
    'coach.crit.pitch.greatQuietMelody': { en: 'You played every note I heard correctly — {good} of {total}; the other {rest} didn’t reach the mic, so keep every pluck at the same volume.',
      es: 'Tocaste correctamente cada nota que escuché — {good} de {total}; las otras {rest} no llegaron al micrófono, así que mantén cada nota con el mismo volumen.' },
    ...
    'coach.crit.pitch.needsQuietChords': { en: 'What I heard clearly sounded right, but most strums didn’t reach the mic — that’s usually a volume problem. Strum every beat at the same volume, closer to the mic.',
      es: 'Lo que escuché con claridad sonó bien, pero la mayoría de los rasgueos no llegaron al micrófono — eso normalmente es un problema de volumen. Rasguea cada tiempo con el mismo volumen, más cerca del micrófono.' },
    'coach.crit.pitch.needsQuietMelody': { en: 'The notes I heard clearly were right, but most didn’t reach the mic — that’s usually a volume problem. Pluck every note at the same volume, closer to the mic.',
      es: 'Las notas que escuché con claridad fueron correctas, pero la mayoría no llegaron al micrófono — eso normalmente es un problema de volumen. Toca cada nota con el mismo volumen, más cerca del micrófono.' },
    'coach.crit.pitch.quietMostAll': { en: 'Most of your notes didn’t reach the mic — usually that’s uneven volume, not your fingers. Pluck every note at the same volume, closer to the mic.',
      es: 'La mayoría de tus notas no llegaron al micrófono — normalmente eso es volumen desigual, no tus dedos. Toca cada nota con el mismo volumen, más cerca del micrófono.' },
    'coach.crit.pitch.quietMostMany': { en: 'The {good} notes I heard clearly were right, but most of your notes didn’t reach the mic — usually that’s uneven volume, not your fingers. Pluck every note at the same volume, closer to the mic.',
      es: 'Las {good} notas que escuché con claridad fueron correctas, pero la mayoría de tus notas no llegaron al micrófono — normalmente eso es volumen desigual, no tus dedos. Toca cada nota con el mismo volumen, más cerca del micrófono.' },
    'coach.crit.pitch.quietMostOne': { en: 'The one note I heard clearly was right, but most of your notes didn’t reach the mic — usually that’s uneven volume, not your fingers. Pluck every note at the same volume, closer to the mic.',
      es: 'La única nota que escuché con claridad fue correcta, pero la mayoría de tus notas no llegaron al micrófono — normalmente eso es volumen desigual, no tus dedos. Toca cada nota con el mismo volumen, más cerca del micrófono.' },
    ...
    'coach.crit.tempo.name': { en: 'Steady tempo',
      es: 'Tempo estable' },
    'coach.crit.tempo.slowedDown': { en: 'You slowed down — from ~{b1} to ~{b2} BPM. Tap your foot and follow your foot.',
      es: 'Bajaste el ritmo — de ~{b1} a ~{b2} BPM. Marca el ritmo con el pie y sigue a tu pie.' },
    'coach.crit.tempo.slowedDownSlight': { en: 'You slowed down a little (~{b1} to ~{b2} BPM) — keep the count going in your head after the clicks stop.',
      es: 'Bajaste el ritmo un poco (~{b1} a ~{b2} BPM) — sigue contando en tu cabeza cuando los clics se detengan.' },
    'coach.crit.tempo.spedUp': { en: 'You sped up — from ~{b1} to ~{b2} BPM. Tap your foot and follow your foot.',
      es: 'Aceleraste — de ~{b1} a ~{b2} BPM. Marca el ritmo con el pie y sigue a tu pie.' },
    'coach.crit.tempo.spedUpSlight': { en: 'You sped up a little (~{b1} to ~{b2} BPM) — keep the count going in your head after the clicks stop.',
      es: 'Aceleraste un poco (~{b1} a ~{b2} BPM) — sigue contando en tu cabeza cuando los clics se detengan.' },
    ...
    'coach.crit.timing.countedEarly': { en: 'The {total} notes I heard all counted — they just kept landing ahead of the beat. Drop the BPM, tap your foot, and let the foot come down first.',
      es: 'Las {total} notas que escuché contaron todas — solo que caían adelante del tiempo. Baja el BPM, marca el ritmo con el pie, y deja que el pie baje primero.' },
    'coach.crit.timing.countedLate': { en: 'The {total} notes I heard all counted — they just kept landing behind the beat. Drop the BPM, tap your foot, and move your hand WITH the foot instead of after it.',
      es: 'Las {total} notas que escuché contaron todas — solo que caían detrás del tiempo. Baja el BPM, marca el ritmo con el pie, y mueve la mano CON el pie, no después.' },
    ...
    'coach.crit.timing.name': { en: 'On the beat',
      es: 'En el tiempo' },
    'coach.crit.timing.needsWork': { en: 'The {total} notes I heard all counted — they just weren’t lining up with the beat yet. Drop the BPM, tap your foot, and make the foot and the pick move together.',
      es: 'Las {total} notas que escuché contaron todas — solo que todavía no coincidían con el tiempo. Baja el BPM, marca el ritmo con el pie, y haz que el pie y la púa se muevan juntos.' },
    ...
    'coach.lane.playNow': { en: 'play now',
      es: 'toca ahora' },
    'coach.lane.strumNow': { en: 'strum now',
      es: 'rasguea ahora' },
    ...
    'coach.level.great': { en: 'Great',
      es: 'Excelente' },
    'coach.level.needsWork': { en: 'Not yet',
      es: 'Todavía no' },
    ...
    'coach.overall.good': { en: 'The green parts are right. Fix the rest.',
      es: 'Las partes en verde están correctas. Arregla el resto.' },
    'coach.overall.great': { en: 'Everything was right.',
      es: 'Todo estuvo correcto.' },
    'coach.overall.practice': { en: 'Fix one thing, then check again.',
      es: 'Arregla una cosa y vuelve a chequear.' },
    ...
    'coach.pulse.on': { en: 'The beat column keeps time — it fades out once you’re steady.',
      es: 'La columna verde lleva el tiempo — se apaga cuando vas firme.' },
    ...
    'coach.streak': { en: 'That’s {n} clean tries in a row.',
      es: 'Van {n} intentos limpios seguidos.' },
    ...
    'coach.target.label': { en: 'You’ll play:',
      es: 'Vas a tocar:' },
    'coach.tip.countedLoose': { en: 'Those all counted as right notes — {n} just landed off the beat (the dashed ones below). Nothing to re-learn: play it again with your foot tapping and aim to land each one right with the pulse.',
      es: 'Todas contaron como notas correctas — {n} solo cayeron fuera del tiempo (las de borde punteado abajo). No hay nada que volver a aprender: tócalo otra vez marcando el ritmo con el pie e intenta que cada una caiga justo con el pulso.' },
    ...
    'games.bc.buildPrompt': { en: 'Build: {name}',
      es: 'Construye: {name}' },
    'games.bc.cellLabel': { en: 'String {string}, fret {fret}',
      es: 'Cuerda {string}, traste {fret}' },
    'games.bc.changeDeck': { en: 'Change deck',
      es: 'Cambiar mazo' },
    'games.bc.checkButton': { en: 'Check my chord',
      es: 'Revisar mi acorde' },
    'games.bc.deck.all': { en: 'All open chords',
      es: 'Todos los acordes abiertos' },
    'games.bc.deck.starter': { en: 'First six chords',
      es: 'Los primeros seis acordes' },
    'games.bc.desc': { en: '90 seconds: a chord name comes up and you place its fingers on a blank grid. Diagrams in reverse.',
      es: '90 segundos: aparece el nombre de un acorde y tú colocas sus dedos en una cuadrícula vacía. Diagramas al revés.' },
    ...
    'games.bc.headLabel': { en: 'String {string}: open or muted',
      es: 'Cuerda {string}: al aire o silenciada' },
    'games.bc.nextButton': { en: 'Next chord',
      es: 'Siguiente acorde' },
    'games.bc.offByMany': { en: '{n} strings are off.',
      es: '{n} cuerdas están mal.' },
    'games.bc.offByOne': { en: 'One string is off.',
      es: 'Una cuerda está mal.' },
    'games.bc.revealLine': { en: 'This is {name} — study it, then keep going.',
      es: 'Así es {name} — estúdialo y sigue.' },
    'games.bc.showMe': { en: 'Show me',
      es: 'Muéstramelo' },
    'games.bc.startButton': { en: 'Start — 90 seconds',
      es: 'Empezar — 90 segundos' },
    'games.bc.tip': { en: 'Tap a square to put a finger on that string and fret — tap it again to clear it. Tap the circle above a string to flip it between open (O) and muted (×). Then press Check: a miss tells you how many strings are off, but not which. Two misses offer a Show-me; the third shows you and moves on. On a laptop, Enter checks.',
      es: 'Toca un cuadro para poner un dedo en esa cuerda y traste — tócalo de nuevo para quitarlo. Toca el círculo arriba de una cuerda para cambiarla entre al aire (O) y apagada (×). Luego presiona Revisar: un fallo te dice cuántas cuerdas están mal, pero no cuáles. Dos fallos ofrecen un Muéstramelo; el tercero te lo muestra y sigue. En una laptop, Enter revisa.' },
    'games.bc.title': { en: 'Build-a-Chord',
      es: 'Construye el acorde' },
    ...
    'games.cb.deck.power': { en: 'Power chords',
      es: 'Acordes de potencia' },
    'games.cb.desc': { en: 'Five seconds a card, ten cards a round. Answer right and harder chord shapes join the deck. No guitar needed — this one trains your eyes.',
      es: 'Cinco segundos por tarjeta, diez tarjetas por ronda. Si aciertas, entran formas de acorde más difíciles. No necesitas guitarra — este entrena tus ojos.' },
    ...
    'games.cb.spotIt': { en: 'Spot it',
      es: 'Encuéntralo' },
    'games.cb.startButton': { en: 'Start — 10 cards',
      es: 'Empezar — 10 tarjetas' },
    'games.cb.tip': { en: '<strong>Name it</strong>: you see a chord shape, you pick its name. <strong>Spot it</strong>: you see a name, you pick the shape. You get five seconds a card and ten cards a round. Every 2 right answers raises the level, which adds harder chord shapes and is worth more points; a streak of 5 in a row multiplies those points. Miss one — or let the five seconds run out — and the right answer lights up green, then that chord comes back later. On a laptop, keys 1–4 answer.',
      es: '<strong>Nómbralo</strong>: ves una forma de acorde y eliges su nombre. <strong>Encuéntralo</strong>: ves un nombre y eliges la forma. Tienes cinco segundos por tarjeta y diez tarjetas por ronda. Cada 2 respuestas correctas suben el nivel, lo que agrega formas de acorde más difíciles y vale más puntos; una racha de 5 seguidas multiplica esos puntos. Si fallas — o si se acaban los cinco segundos — la respuesta correcta se ilumina en verde, y ese acorde vuelve a aparecer más tarde. En una laptop, las teclas 1–4 responden.' },
    ...
    'games.cc.advice.low': { en: 'Drop 10 BPM and try again.',
      es: 'Baja 10 BPM e inténtalo de nuevo.' },
    ...
    'games.cd.changeDeck': { en: 'Change deck',
      es: 'Cambiar mazo' },
    'games.cd.deck.all': { en: 'Everything',
      es: 'Todo' },
    'games.cd.deck.barre': { en: 'Partial barres',
      es: 'Cejillas parciales' },
    'games.cd.deck.open': { en: 'Open chords',
      es: 'Acordes abiertos' },
    'games.cd.desc': { en: 'Ten chords, five seconds to name each one once it stops sounding. Answer right and harder chords join the deck. No diagram — this one trains your ears.',
      es: 'Diez acordes, cinco segundos para nombrar cada uno cuando deja de sonar. Si aciertas, entran acordes más difíciles. Sin diagrama — este entrena tus oídos.' },
    'games.cd.playButton': { en: 'Play the chord',
      es: 'Reproducir el acorde' },
    'games.cd.startButton': { en: 'Start — 10 cards',
      es: 'Empezar — 10 tarjetas' },
    'games.cd.tip': { en: 'Tap Play, then name the chord by ear — nothing is shown. You get five seconds a card and ten cards a round, and <strong>the clock waits while the chord is sounding</strong>, so replay it as often as you need. Every 2 right answers raises the level, which adds harder chords and is worth more points; a streak of 5 in a row multiplies those points. Miss one — or let the five seconds run out — and the right answer lights up green, then that chord comes back later. On a laptop, keys 1–4 answer.',
      es: 'Toca Reproducir y nombra el acorde de oído — no se muestra nada. Tienes cinco segundos por tarjeta y diez tarjetas por ronda, y <strong>el reloj espera mientras suena el acorde</strong>, así que puedes repetirlo las veces que necesites. Cada 2 respuestas correctas suben el nivel, lo que agrega acordes más difíciles y vale más puntos; una racha de 5 seguidas multiplica esos puntos. Si fallas — o si se acaban los cinco segundos — la respuesta correcta se ilumina en verde, y ese acorde vuelve a aparecer más tarde. En una laptop, las teclas 1–4 responden.' },
    'games.cd.title': { en: 'Chord Detective',
      es: 'Detective de acordes' },
    ...
    'games.common.bpmUp10': { en: '+10 BPM',
      es: '+10 BPM' },
    'games.common.cardOf': { en: 'Card {n}/{total}',
      es: 'Tarjeta {n}/{total}' },
    ...
    'games.common.playAgain': { en: 'Play again',
      es: 'Jugar de nuevo' },
    'games.common.reachedLevel': { en: 'You reached level {n} of {total}.',
      es: 'Llegaste al nivel {n} de {total}.' },
    ...
    'games.fret.done.keep': { en: 'Go again.',
    ...
    'games.meta.goalMet': { en: 'Daily goal reached! 🎉',
      es: '¡Meta diaria lograda! 🎉' },
    'games.meta.streak': { en: '{n}-day streak',
      es: 'racha de {n} días' },
    'games.meta.xpToday': { en: '{xp} of {goal} XP today',
      es: '{xp} de {goal} XP hoy' },
    ...
    'games.nr.bestPercent': { en: 'Best: {pct}%',
      es: 'Mejor: {pct}%' },
    'games.nr.biasEarly': { en: 'You’re rushing — about {ms} ms early on average. Let each note come to the line. If you were really on the beat, lower the mic timing offset on the level screen.',
      es: 'Te estás adelantando — unos {ms} ms antes en promedio. Deja que cada nota llegue a la línea. Si de verdad ibas con el pulso, baja el ajuste de tiempo del micrófono en la pantalla del nivel.' },
    ...
    'games.nr.offsetTip': { en: 'Your device’s mic hears you a moment after you play — this slider corrects for that. Play a round right on the beat, then check the results: told you’re “late”? Raise it. Told you’re “rushing”? Lower it. It’s set right when the results say your timing is on the beat.',
      es: 'El micrófono de tu dispositivo te oye un instante después de tocar — este ajuste lo corrige. Toca una ronda justo con el pulso y mira los resultados: ¿te dice «tarde»? Súbelo. ¿Te dice que te adelantas? Bájalo. Está bien puesto cuando los resultados digan que tu tiempo está en el pulso.' },
    ...
    'games.nr.race.aria': { en: 'Race lane: your guitar moves forward for every note you land, and the flag is a perfect round.',
      es: 'Carril de carrera: tu guitarra avanza con cada nota que aciertas, y la bandera es una ronda perfecta.' },
    'games.nr.race.unlock': { en: 'unlock',
      es: 'desbloqueo' },
    ...
    'games.nr.stageDown': { en: 'Going back to {name}.',
      es: 'Volviendo a {name}.' },
    'games.nr.stageStay': { en: 'Staying here one more round — you’re close.',
      es: 'Te quedas aquí una ronda más — estás cerca.' },
    'games.nr.stageTop': { en: 'Last stage. Keep playing rounds here.',
      es: 'Última etapa. Sigue jugando rondas aquí.' },
    ...
    'games.ntr.desc': { en: '60 seconds, name the song from its riff. No tab shown — just your ears, choosing from the four songs with real note-by-note riffs on this site.',
      es: '60 segundos, nombra la canción por su riff. No se muestra la tablatura — solo tus oídos, eligiendo entre las cuatro canciones que tienen riffs nota por nota en este sitio.' },
    'games.ntr.playButton': { en: 'Play the riff',
      es: 'Reproducir el riff' },
    'games.ntr.startButton': { en: 'Start — 60 seconds',
      es: 'Empezar — 60 segundos' },
    'games.ntr.tip': { en: 'Tap Play, then pick the song by ear — nothing is shown. Right answers build a streak — every 5 in a row is worth more points. Miss one and the right answer lights up green, then that riff comes back later. On a laptop, keys 1–4 answer.',
      es: 'Toca Reproducir y elige la canción de oído — no se muestra nada. Las respuestas correctas forman una racha — cada 5 seguidas valen más puntos. Si fallas, la respuesta correcta se ilumina en verde, y ese riff vuelve a aparecer más tarde. En una laptop, las teclas 1–4 responden.' },
    ...
    'games.pd.noMatch': { en: 'It doesn\'t match',
      es: 'No coincide' },
    'games.pd.playButton': { en: 'Play the bar',
      es: 'Reproducir el compás' },
    'games.pd.startButton': { en: 'Start — 60 seconds',
      es: 'Empezar — 60 segundos' },
    'games.pd.tip': { en: 'Read the written bar (D = downstrum, U = upstrum), then listen — a click marks the four beats while the bar strums, and the answer buttons unlock when it ends. Decide whether what you heard matches what you see. Right answers build a streak — every 5 in a row is worth more points. On a laptop, keys 1–2 answer.',
      es: 'Lee el compás escrito (D = rasgueo hacia abajo, U = rasgueo hacia arriba) y luego escucha — un clic marca los cuatro tiempos mientras suena el compás, y los botones de respuesta se desbloquean cuando termina. Decide si lo que escuchaste coincide con lo que ves. Las respuestas correctas forman una racha — cada 5 seguidas valen más puntos. En una laptop, las teclas 1–2 responden.' },
    'games.pd.title': { en: 'Pattern Detective',
      es: 'Detective de patrones' },
    'games.ps.desc': { en: 'A growing note sequence plays from the pentatonic pattern you know — tap it back in order. How long a sequence can you hold?',
      es: 'Suena una secuencia de notas que va creciendo, del patrón pentatónico que ya conoces — repítela tocando en orden. ¿Qué tan larga puedes sostenerla?' },
    'games.ps.nice': { en: 'Nice — one longer.',
      es: '¡Bien! — una nota más.' },
    'games.ps.round': { en: 'Round {n}',
      es: 'Ronda {n}' },
    'games.ps.roundsCleared': { en: '{n} rounds cleared.',
      es: '{n} rondas superadas.' },
    'games.ps.startButton': { en: 'Start',
      es: 'Empezar' },
    'games.ps.tip': { en: 'Six pads, one octave of pentatonic Pattern 1 (root, ♭3, 4, 5, ♭7, root). Watch and listen to the sequence, then tap the pads back in the same order. Each clean round adds one more note. On a laptop, keys 1–6 answer.',
      es: 'Seis casillas, una octava del Patrón pentatónico 1 (raíz, ♭3, 4, 5, ♭7, raíz). Observa y escucha la secuencia, y luego toca las casillas en el mismo orden. Cada ronda limpia agrega una nota más. En una laptop, las teclas 1–6 responden.' },
    'games.ps.title': { en: 'Pentatonic Simon',
      es: 'Simón pentatónico' },
    'games.ps.watch': { en: 'Watch and listen…',
    ...
    'games.psg.tuneTip': { en: 'The mic only hears the note you play — if it keeps mishearing you, tune up and play a little closer to the mic.',
      es: 'El micrófono solo escucha la nota que tocas — si sigue oyéndote mal, afina y toca un poco más cerca del micrófono.' },
    ...
    'games.psg.yourTurn': { en: 'Your turn — play it back.',
      es: 'Tu turno — tócala.' },
    'games.radar.advice.one': { en: 'Say the pattern out loud while you strum.',
      es: 'Di el patrón en voz alta mientras rasgueas.' },
    ...
    'games.radar.advice.two': { en: 'Play one more round at this speed.',
      es: 'Toca una ronda más a esta velocidad.' },
    ...
    'games.radar.verdict.two': { en: '{acc}% on the beat — you have almost got this pattern.',
      es: '{acc}% a tiempo — ya casi dominas este patrón.' },
    ...
    'games.riff.advice.threeMax': { en: 'You can play this riff at full speed.',
      es: 'Ya puedes tocar este riff a toda velocidad.' },
    ...
    'games.riff.advice.two': { en: 'Play one more round at this speed.',
      es: 'Toca una ronda más a esta velocidad.' },
    'games.riff.advice.zeroHearIt': { en: 'Press "Hear it" a few times so your ears learn the riff, then try again.',
      es: 'Presiona «Escuchar» varias veces para que tus oídos aprendan el riff, y luego inténtalo de nuevo.' },
    'games.riff.advice.zeroSlower': { en: 'Drop to a slower speed level.',
      es: 'Baja a un nivel de velocidad más lento.' },
    ...
    'games.riff.song.sna.hint': { en: 'One note per beat, then one beat of rest at the end of each lap. Count 1-2-3-4 with the click. (This is the straight-quarter-note teaching version, to make it easy to count — on the record the notes are not all the same length.)',
      es: 'Una nota por tiempo, y luego un tiempo de silencio al final de cada vuelta. Cuenta 1-2-3-4 con el clic. (Esta es la versión de enseñanza en negras rectas, para que sea fácil de contar — en la grabación original las notas no duran todas lo mismo.)' },
    'games.riff.song.sna.sub': { en: 'The main riff — seven notes, all on the A string.',
      es: 'El riff principal — siete notas, todas en la cuerda La.' },
    ...
    'games.riff.song.watchtower.hint': { en: 'Each number is the root note of a power chord. A5 and G5 get two beats, F5 gets three, the last G5 gets one — press on counts 1 and 3, then 1 and 4.',
      es: 'Cada número es la nota raíz de un power chord. A5 y G5 duran dos tiempos, F5 tres y el último G5 uno — presiona en los conteos 1 y 3, y luego 1 y 4.' },
    ...
    'games.rr.card30': { en: 'Build a major scale up the low E string starting at fret 3 (that’s G) with the recipe W-W-H-W-W-W-H — a whole step (W) is 2 frets, a half step (H) is 1. One note per click.',
      es: 'Construye una escala mayor subiendo por la cuerda Mi grave desde el traste 3 (eso es G) con la receta T-T-S-T-T-T-S — un tono (T) son 2 trastes, un semitono (S) es 1. Una nota por clic.' },
    'games.rr.card31': { en: 'Play minor pentatonic box 1 at fret 5, up and back, one note per click. Then say the key (A minor) and its relative major — the major key that shares its notes, 3 frets up (C).',
      es: 'Toca la caja 1 de la pentatónica menor en el traste 5, subiendo y bajando, una nota por clic. Luego di la tonalidad (A menor) y su relativa mayor — la tonalidad mayor que comparte sus notas, 3 trastes más arriba (C).' },
    'games.rr.card32': { en: 'Say the chord family of C major out loud — C, Dm, Em, F, G, Am — then strum the I, IV, and V (C, F, G) once each. A chord family = the main chords built from a key’s own notes.',
      es: 'Di en voz alta la familia de acordes de C mayor — C, Dm, Em, F, G, Am — y luego rasguea el I, el IV y el V (C, F, G) una vez cada uno. Una familia de acordes = los acordes principales construidos con las notas propias de una tonalidad.' },
    'games.rr.card33': { en: 'Fret a C chord and let your thumb walk: alternate between the A string and the D string, one bass note per click, without stopping.',
      es: 'Pisa un acorde de C y deja que tu pulgar camine: alterna entre la cuerda La y la cuerda Re, una nota de bajo por clic, sin parar.' },
    'games.rr.card34': { en: 'Play anything you have learned, without stopping, until the timer ends. Made a mistake? Keep going anyway.',
      es: 'Toca cualquier cosa que hayas aprendido, sin parar, hasta que termine el tiempo. ¿Te equivocaste? Sigue adelante de todas formas.' },
    ...
    'games.rr.card37': { en: 'Play anything you know as SOFTLY as you can.',
      es: 'Toca lo que sepas lo MÁS SUAVE posible.' },
    ...
    'games.rr.scoreNotYetLabel': { en: 'Not yet',
      es: 'Todavía no' },
    'games.rr.scoreNotYetSub': { en: '+0 — try this card another day',
      es: '+0 — prueba esta carta otro día' },
    'games.rr.scorePointsSuffix': { en: '+{n} points',
      es: '+{n} puntos' },
    'games.rr.scorePrompt': { en: 'Did you play the card? Tap the score that is true.',
      es: '¿Tocaste la carta? Toca el puntaje que sea cierto.' },
    ...
    'games.rr.tagline': { en: 'Spin. Play the card on your actual guitar. Score yourself honestly.',
      es: 'Gira. Toca la carta en tu propia guitarra. Califícate con honestidad.' },
    'games.rr.timeUp': { en: 'Time!',
      es: '¡Se acabó el tiempo!' },
    'games.rr.title': { en: 'Riff Roulette',
      es: 'Ruleta de riffs' },
    'games.sh.advice.one': { en: 'Say the pattern out loud while you tap.',
      es: 'Di el patrón en voz alta mientras tocas.' },
    'games.sh.advice.three': { en: 'Level up: try it 10 BPM faster.',
      es: 'Sube de nivel: pruébalo 10 BPM más rápido.' },
    'games.sh.advice.two': { en: 'Play one more round at this speed.',
      es: 'Toca una ronda más a esta velocidad.' },
    'games.sh.advice.zero': { en: 'Drop 10 BPM and try again.',
      es: 'Baja 10 BPM e inténtalo de nuevo.' },
    ...
    'games.sh.verdict.two': { en: '{acc}% on time — you have almost got this pattern.',
      es: '{acc}% a tiempo — ya casi dominas este patrón.' },
    ...
    'lq.inviteTitle':        { en: 'Live quiz!', es: '¡Concurso en vivo!' },
    'lq.inviteBody':         { en: 'Your class is playing right now.', es: 'Tu clase está jugando ahora mismo.' },
    'lq.inviteJoin':         { en: 'Join the game', es: 'Entrar al juego' },
    'lq.inviteLater':        { en: 'Not now', es: 'Ahora no' },
