...
(function(){
  ...
  */
  const I18N = {
    ...
    'games.cb.cardOf': { en: 'Card {n}/{total}',
      es: 'Tarjeta {n}/{total}' },
    ...
    'games.cb.direction': { en: 'Direction',
      es: 'Dirección' },
    'games.cb.level': { en: 'Level {n}',
      es: 'Nivel {n}' },
    'games.cb.nameIt': { en: 'Name it',
      es: 'Nómbralo' },
    'games.cb.reachedLevel': { en: 'You reached level {n} of {total}.',
    ...
    'games.cd.deck.open': { en: 'Open chords',
      es: 'Acordes abiertos' },
    'games.cd.desc': { en: '60 seconds, how many chords can you name just by listening? No diagram — this one trains your ears.',
      es: '60 segundos, ¿cuántos acordes puedes nombrar solo escuchando? Sin diagrama — este entrena tus oídos.' },
    'games.cd.playButton': { en: 'Play the chord',
      es: 'Reproducir el acorde' },
    'games.cd.startButton': { en: 'Start — 60 seconds',
      es: 'Empezar — 60 segundos' },
    'games.cd.tip': { en: 'Tap Play, then name the chord by ear — nothing is shown. Right answers build a streak — every 5 in a row is worth more points. Miss one and the right answer lights up green, then that chord comes back later. On a laptop, keys 1–4 answer.',
      es: 'Toca Reproducir y nombra el acorde de oído — no se muestra nada. Las respuestas correctas forman una racha — cada 5 seguidas valen más puntos. Si fallas, la respuesta correcta se ilumina en verde, y ese acorde vuelve a aparecer más tarde. En una laptop, las teclas 1–4 responden.' },
