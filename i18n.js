...
(function(){
  ...
  */
  const I18N = {
    ...
    'fret.praiseLow':        { en: 'repetition is what makes it stay — go again when you’re ready.', es: 'la repetición es lo que lo fija — repite cuando estés listo.' },
    ...
    'deck.introTwo':         { en: 'The answer is on the back. Say it out loud BEFORE you tap the card — that is the whole drill.',
                               es: 'La respuesta está al reverso. Dila en voz alta ANTES de tocar la carta — en eso consiste todo el ejercicio.' },
    ...
    'coach.crit.pitch.greatChords': { en: 'The chord tones sounded correct on {good} of {total} beats — that’s the sound we want.',
    ...
    'games.bc.desc': { en: '90 seconds: a chord name comes up and you place its fingers on a blank grid. Diagrams in reverse — this builds real chord memory.',
    ...
    'games.ntr.title': { en: 'Name That Riff',
      es: 'Adivina el riff' },
    'games.pd.desc': { en: '60 seconds: one strum pattern is written, one bar is played out loud — does what you hear match what you see? Ears meet notation.',
      es: '60 segundos: un patrón de rasgueo está escrito y suena un compás en voz alta — ¿lo que escuchas coincide con lo que ves? Los oídos se encuentran con la notación.' },
    ...
    'games.rr.card33': { en: 'Fret a C chord and let your thumb walk: alternate between the A string and the D string, one bass note per click, without stopping. That steady thumb is what drives Travis picking.',
      es: 'Pisa un acorde de C y deja que tu pulgar camine: alterna entre la cuerda La y la cuerda Re, una nota de bajo por clic, sin parar. Ese pulgar constante es lo que impulsa el Travis picking.' },
    ...
    'games.rr.card37': { en: 'Play anything you know as SOFTLY as you can. Quiet takes more control than loud.',
      es: 'Toca lo que sepas lo MÁS SUAVE posible. Tocar bajito requiere más control que tocar fuerte.' },
