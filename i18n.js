...
(function(){
  ...
  */
  const I18N = {
    ...
    'games.bc.tip': { en: 'Tap a square to put a finger on that string and fret — tap it again to clear it. Tap the circle above a string to flip it between open (O) and muted (×). Then hit Check: a miss tells you how many strings are off, but not which. Two misses offer a Show-me; the third shows you and moves on. On a laptop, Enter checks.',
