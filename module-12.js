...
SETS.push(

  {
    ...
    title: 'Set 1',
    subtitle: 'The thumb keeps the steady beat · Pinch on the downbeat · Fills between',
    subtitle_es: 'El pulgar mantiene el pulso constante · Pellizco en el tiempo fuerte · Rellenos entre medio',
    ...
    stations: {
      ...
      c: {
        ...
        sections: [
            ...
            steps: [
              {
                ...
                stuck_es: 'Repite solo los dos primeros acordes de la estrofa hasta que el patrón sea completamente estable antes de agregar el resto.',
          ...
          {
            title: 'Review p-i-m-a — the claw (from Module 8)',
            title_es: 'Repasa p-i-m-a — la garra (del Módulo 8)',
            steps: [
              {
...

  {
            ...
            steps: [
              {
                ...
                text: '<ul><li>Fingerpick Am–C–Dm–F, one bar each, pattern of your choice.</li></ul>You\'ve got it when: the ◐ is gone — this is the style the song was written in.',
                text_es: '<ul><li>Toca con fingerpicking Am–C–Dm–F, un compás cada uno, con el patrón que elijas.</li></ul>Lo tienes cuando: el ◐ desaparece — este es el estilo en el que se escribió la canción.',
    ...
    skills: [
      ...
      { id: 'm12w2-s3', text: 'Fingerpick "the cure"\'s shapes — its native style',
        ...
        gotItWhen: 'the ◐ is gone — this is the style "the cure" was written in.',
        gotItWhen_es: 'el ◐ desaparece — este es el estilo en el que se escribió "the cure".',
...

  {
    ...
    unit_es: 'Módulo 12 · Fingerstyle: Travis, vals y requinto',
    title: 'Set 3',
    subtitle: 'Melody on top, thumb below · "Luna"\'s intro at full tempo · Choose your performance voice',
    subtitle_es: 'Melodía arriba, pulgar abajo · La intro de "Luna" a tempo completo · Elige tu voz de interpretación',
      ...
      c: {
        ...
        sections: [
          ...
          },
          {
            ...
            steps: [
              {
                label: 'Challenge — Full-Verse Rehearsal (assessment preparation)', label_es: 'Reto — Ensayo de la estrofa completa (preparación para la evaluación)',
    ...
    skills: [
      ...
      { id: 'm12w3-s4', text: 'Blend melody notes into a picking pattern — tune on top, thumb bass below',
        ...
        practice: { type: 'mc', prompt: 'You\'re blending a tune into your picking pattern, requinto-style. Where do the melody notes go?',
          ...
          explain: 'Two jobs, one hand: the thumb never stops the bass, and i-m-a sing the tune on top. Don\'t stop the bass when you play the melody.',
          explain_es: 'Dos trabajos, una mano: el pulgar nunca detiene el bajo, e i-m-a cantan la melodía encima. No detengas el bajo cuando toques la melodía.' } },
...
MODULE_SONGS[12] = [
      ...
      { name: '"Blackbird" — The Beatles', meta: 'The hardest song on this list — pinches and moving shapes', meta_es: 'La canción más difícil de la lista — pellizcos y formas en movimiento', type: 'Choice', core: false, level: 3,
