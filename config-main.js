...
// for Module 1 and `m{N}w{n}-s{m}` for Modules 2–13. Both fields duplicate data
...
const MODULE_MANIFEST = [
  ...
  { num: 5, name: 'Open Chords',                              name_es: 'Acordes al aire', i18nComplete: true, skillCount: 25, skillIdRe: '^m5w\\d+-s\\d+$' },
